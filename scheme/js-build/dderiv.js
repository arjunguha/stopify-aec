...
var main;
var dderiv;
var BgL_zf2dderivzf2;
var BgL_za2dderivza2;
var BgL_myzd2dderivzd2;
var BgL_myzb2dderivzb2;
var put;
var get;
var properties;
var lookup;
...
var time;
var BgL_dderivzd2iterszd2;
var BgL_fatalzd2errorzd2;
const_main = "No derivation method available";
BgL_sc_const_1z00_main = "*** wrong result ***";
BgL_sc_const_2z00_main = new sc_Pair("\uEBAC+", new sc_Pair(new sc_Pair("\uEBAC*", new sc_Pair(3, new sc_Pair("\uEBACx", new sc_Pair("\uEBACx", null)))), new sc_Pair(new sc_Pair("\uEBAC*", new sc_Pair("\uEBACa", new sc_Pair("\uEBACx", new sc_Pair("\uEBACx", null)))), new sc_Pair(new sc_Pair("\uEBAC*", new sc_Pair("\uEBACb", new sc_Pair("\uEBACx", null))), new sc_Pair(5, null)))));
BgL_sc_const_3z00_main = new sc_Pair("\uEBAC+", new sc_Pair(new sc_Pair("\uEBAC*", new sc_Pair(new sc_Pair("\uEBAC*", new sc_Pair(3, new sc_Pair("\uEBACx", new sc_Pair("\uEBACx", null)))), new sc_Pair(new sc_Pair("\uEBAC+", new sc_Pair(new sc_Pair("\uEBAC\u002f", new sc_Pair(0, new sc_Pair(3, null))), new sc_Pair(new sc_Pair("\uEBAC\u002f", new sc_Pair(1, new sc_Pair("\uEBACx", null))), new sc_Pair(new sc_Pair("\uEBAC\u002f", new sc_Pair(1, new sc_Pair("\uEBACx", null))), null)))), null))), new sc_Pair(new sc_Pair("\uEBAC*", new sc_Pair(new sc_Pair("\uEBAC*", new sc_Pair("\uEBACa", new sc_Pair("\uEBACx", new sc_Pair("\uEBACx", null)))), new sc_Pair(new sc_Pair("\uEBAC+", new sc_Pair(new sc_Pair("\uEBAC\u002f", new sc_Pair(0, new sc_Pair("\uEBACa", null))), new sc_Pair(new sc_Pair("\uEBAC\u002f", new sc_Pair(1, new sc_Pair("\uEBACx", null))), new sc_Pair(new sc_Pair("\uEBAC\u002f", new sc_Pair(1, new sc_Pair("\uEBACx", null))), null)))), null))), new sc_Pair(new sc_Pair("\uEBAC*", new sc_Pair(new sc_Pair("\uEBAC*", new sc_Pair("\uEBACb", new sc_Pair("\uEBACx", null))), new sc_Pair(new sc_Pair("\uEBAC+", new sc_Pair(new sc_Pair("\uEBAC\u002f", new sc_Pair(0, new sc_Pair("\uEBACb", null))), new sc_Pair(new sc_Pair("\uEBAC\u002f", new sc_Pair(1, new sc_Pair("\uEBACx", null))), null))), null))), new sc_Pair(0, null)))));
BgL_fatalzd2errorzd2 = function() {
    return null.car;
  };
BgL_dderivzd2iterszd2 = 1000000;
time = function(x) {
    return x;
  };
...
BgL_myzb2dderivzb2 = function(a) {
    ...
    var tmpF1265;
    tmpF1265 = dderiv;
    falseHead1267 = new sc_Pair(null, null);
    L1264_1 = a.cdr;
    tail1268 = falseHead1267;
    L1264 = L1264_1;
    while (!(L1264 === null)) {
      tail1268.cdr = new sc_Pair(tmpF1265(L1264.car), null);
      tail1268 = tail1268.cdr;
      L1264 = L1264.cdr;
    }
    stmp = falseHead1267.cdr;
    return new sc_Pair("\uEBAC+", stmp);
  };
BgL_myzd2dderivzd2 = function(a) {
    var stmp;
    var tail1273;
    var L1269;
    var L1269_2;
    ...
    var tmpF1270;
    tmpF1270 = dderiv;
    falseHead1272 = new sc_Pair(null, null);
    L1269_2 = a.cdr;
    tail1273 = falseHead1272;
    L1269 = L1269_2;
    while (!(L1269 === null)) {
      tail1273.cdr = new sc_Pair(tmpF1270(L1269.car), null);
      tail1273 = tail1273.cdr;
      L1269 = L1269.cdr;
    }
    stmp = falseHead1272.cdr;
    return new sc_Pair("\uEBAC-", stmp);
  };
BgL_za2dderivza2 = function(a) {
    var stmp;
    var stmp_3;
    var a_4;
    var tail1278;
    ...
    var L1274_5;
    var falseHead1277;
    falseHead1277 = new sc_Pair(null, null);
    L1274_5 = a.cdr;
    tail1278 = falseHead1277;
    L1274 = L1274_5;
    while (!(L1274 === null)) {
      a_4 = L1274.car;
      stmp_3 = new sc_Pair(sc_list("\uEBAC\u002f", dderiv(a_4), a_4), null);
      tail1278.cdr = stmp_3;
      tail1278 = tail1278.cdr;
      L1274 = L1274.cdr;
    }
    stmp = falseHead1277.cdr;
    return sc_list("\uEBAC*", a, new sc_Pair("\uEBAC+", stmp));
  };
BgL_zf2dderivzf2 = function(a) {
    return sc_list("\uEBAC-", sc_list("\uEBAC\u002f", dderiv(a.cdr.car), a.cdr.cdr.car), sc_list("\uEBAC\u002f", a.cdr.car, sc_list("\uEBAC*", a.cdr.cdr.car, a.cdr.cdr.car, dderiv(a.cdr.cdr.car))));
  };
put("\uEBAC+", "\uEBACdderiv", BgL_myzb2dderivzb2);
put("\uEBAC-", "\uEBACdderiv", BgL_myzd2dderivzd2);
put("\uEBAC*", "\uEBACdderiv", BgL_za2dderivza2);
put("\uEBAC\u002f", "\uEBACdderiv", BgL_zf2dderivzf2);
dderiv = function(a) {
    var f;
    if (!(a instanceof sc_Pair)) {
      ...
      if (f !== false) {
        ...
        return BgL_fatalzd2errorzd2(const_main);
      }
    }
  };
main = function() {
    ...
    return BgL_runzd2benchmarkzd2("dderiv", BgL_dderivzd2iterszd2, function(result) {
              return sc_isEqual(result, BgL_sc_const_3z00_main);
            }, function(a) {
              return function() {
                      return dderiv(a);
                    };
