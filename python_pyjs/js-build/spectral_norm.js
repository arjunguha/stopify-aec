...
$pyjs['loaded_modules']['main'] = function (__mod_name__) {
	...
	$m['eval_A'] = function(i, j) {
		var $div3,$add9,$div4,$add2,$add3,$add1,$add6,$add7,$add4,$add5,$div2,$add10,$add8,$div1,$mul2,$mul1;
		return (typeof ($div3=1.0)==typeof ($div4=$p['__op_add']($add9=$p['__op_add']($add7=(typeof ($div1=(typeof ($mul1=$p['__op_add']($add1=i,$add2=j))==typeof ($mul2=$p['__op_add']($add5=$p['__op_add']($add3=i,$add4=j),$add6=1)) && typeof $mul1=='number'?
			$mul1*$mul2:
			$p['op_mul']($mul1,$mul2)))==typeof ($div2=2) && typeof $div1=='number' && $div2 !== 0?
			$div1/$div2:
			$p['op_div']($div1,$div2)),$add8=i),$add10=1)) && typeof $div3=='number' && $div4 !== 0?
			$div3/$div4:
			$p['op_div']($div3,$div4));
	};
	$m['eval_A']['__name__'] = 'eval_A';

	$m['eval_A']['__bind_type__'] = 0;
	$m['eval_A']['__args__'] = [null,null,['i'],['j']];
	$m['eval_A_times_u'] = function(u) {
		var $iter1_nextval,$iter1_type,i,args,$iter1_iter,$iter1_array,$iter1_idx;
		args = function(){
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
			var $generator = function () {};
			$generator['next'] = function (noStop) {
...
;
		return $p['list']($p['map']((typeof part_A_times_u == "undefined"?$m['part_A_times_u']:part_A_times_u), args));
	};
	$m['eval_A_times_u']['__name__'] = 'eval_A_times_u';

	$m['eval_A_times_u']['__bind_type__'] = 0;
	$m['eval_A_times_u']['__args__'] = [null,null,['u']];
	$m['eval_At_times_u'] = function(u) {
		var $iter2_nextval,$iter2_type,$iter2_iter,i,args,$iter2_idx,$iter2_array;
		args = function(){
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
			var $generator = function () {};
			$generator['next'] = function (noStop) {
...
;
		return $p['list']($p['map']((typeof part_At_times_u == "undefined"?$m['part_At_times_u']:part_At_times_u), args));
	};
	$m['eval_At_times_u']['__name__'] = 'eval_At_times_u';

	$m['eval_At_times_u']['__bind_type__'] = 0;
	$m['eval_At_times_u']['__args__'] = [null,null,['u']];
	$m['eval_AtA_times_u'] = function(u) {

		return $m['eval_At_times_u']($m['eval_A_times_u'](u));
	};
	$m['eval_AtA_times_u']['__name__'] = 'eval_AtA_times_u';

	$m['eval_AtA_times_u']['__bind_type__'] = 0;
	$m['eval_AtA_times_u']['__args__'] = [null,null,['u']];
	$m['part_A_times_u'] = function(xxx_todo_changeme) {
		var u_j,$iter3_idx,i,$iter3_nextval,$iter3_array,j,u,$iter3_iter,$add12,$iter3_type,partial_sum,$mul4,$mul3,$add11;
		var $tupleassign1 = $p['__ass_unpack'](xxx_todo_changeme, 2, null);
		i = $tupleassign1[0];
		u = $tupleassign1[1];
		partial_sum = 0;
		$iter3_iter = $p['enumerate'](u);
		$iter3_nextval=$p['__iter_prepare']($iter3_iter,false);
		while (typeof($p['__wrapped_next']($iter3_nextval)['$nextval']) != 'undefined') {
			var $tupleassign2 = $p['__ass_unpack']($iter3_nextval['$nextval'], 2, null);
			j = $tupleassign2[0];
			u_j = $tupleassign2[1];
			partial_sum = $p['__op_add']($add11=partial_sum,$add12=(typeof ($mul3=$m['eval_A'](i, j))==typeof ($mul4=u_j) && typeof $mul3=='number'?
				$mul3*$mul4:
				$p['op_mul']($mul3,$mul4)));
		}
		return partial_sum;
	};
	$m['part_A_times_u']['__name__'] = 'part_A_times_u';

	$m['part_A_times_u']['__bind_type__'] = 0;
	$m['part_A_times_u']['__args__'] = [null,null,['xxx_todo_changeme']];
	$m['part_At_times_u'] = function(xxx_todo_changeme1) {
		var $add14,j,i,$iter4_nextval,$iter4_idx,$add13,partial_sum,$iter4_type,u_j,$iter4_array,u,$mul5,$iter4_iter,$mul6;
		var $tupleassign3 = $p['__ass_unpack'](xxx_todo_changeme1, 2, null);
		i = $tupleassign3[0];
		u = $tupleassign3[1];
		partial_sum = 0;
		$iter4_iter = $p['enumerate'](u);
		$iter4_nextval=$p['__iter_prepare']($iter4_iter,false);
		while (typeof($p['__wrapped_next']($iter4_nextval)['$nextval']) != 'undefined') {
			var $tupleassign4 = $p['__ass_unpack']($iter4_nextval['$nextval'], 2, null);
			j = $tupleassign4[0];
			u_j = $tupleassign4[1];
			partial_sum = $p['__op_add']($add13=partial_sum,$add14=(typeof ($mul5=$m['eval_A'](j, i))==typeof ($mul6=u_j) && typeof $mul5=='number'?
				$mul5*$mul6:
				$p['op_mul']($mul5,$mul6)));
		}
		return partial_sum;
	};
	$m['part_At_times_u']['__name__'] = 'part_At_times_u';

	$m['part_At_times_u']['__bind_type__'] = 0;
	$m['part_At_times_u']['__args__'] = [null,null,['xxx_todo_changeme1']];
	$m['DEFAULT_N'] = 130;
	$m['main'] = function(n) {
		var $iter5_nextval,ve,$iter6_type,$iter5_array,$iter7_idx,$iter5_iter,vBv,vv,$iter5_type,$iter6_iter,$iter6_nextval,tk,$iter5_idx,u,$sub1,$iter7_type,$iter6_idx,$iter7_iter,$sub2,$add15,$iter6_array,$add17,$mul9,$mul8,$mul7,$add18,$mul12,dummy,$mul11,$iter7_nextval,$mul10,i,$iter7_array,$add16,t0,times,$assign1,v,ue;
		times = $p['list']([]);
		...
		while (typeof($p['__wrapped_next']($iter5_nextval)['$nextval']) != 'undefined') {
			...
			t0 = $m['time']['time']();
			u = (typeof ($mul7=$p['list']([1]))==typeof ($mul8=$m['DEFAULT_N']) && typeof $mul7=='number'?
				$mul7*$mul8:
				$p['op_mul']($mul7,$mul8));
			$iter6_iter = $p['range'](10);
			$iter6_nextval=$p['__iter_prepare']($iter6_iter,false);
			while (typeof($p['__wrapped_next']($iter6_nextval)['$nextval']) != 'undefined') {
				dummy = $iter6_nextval['$nextval'];
			...
			vBv = $assign1;
			vv = $assign1;
			$iter7_iter = $p['zip'](u, v);
			$iter7_nextval=$p['__iter_prepare']($iter7_iter,false);
			while (typeof($p['__wrapped_next']($iter7_nextval)['$nextval']) != 'undefined') {
				var $tupleassign5 = $p['__ass_unpack']($iter7_nextval['$nextval'], 2, null);
				ue = $tupleassign5[0];
				ve = $tupleassign5[1];
				vBv = $p['__op_add']($add15=vBv,$add16=(typeof ($mul9=ue)==typeof ($mul10=ve) && typeof $mul9=='number'?
					$mul9*$mul10:
					$p['op_mul']($mul9,$mul10)));
				vv = $p['__op_add']($add17=vv,$add18=(typeof ($mul11=ve)==typeof ($mul12=ve) && typeof $mul11=='number'?
					$mul11*$mul12:
					$p['op_mul']($mul11,$mul12)));
			}
			tk = $m['time']['time']();
			times['append']($p['__op_sub']($sub1=tk,$sub2=t0));
		}
		return times;
	};
