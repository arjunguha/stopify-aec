...
$pyjs['loaded_modules']['main'] = function (__mod_name__) {
	...
	$m['__name__'] = __mod_name__;
	var $sub22,$sub23,$sub20,$sub21,$sub26,$sub27,$sub24,$sub25,$mul40,$sub28,$iter1_iter,$add27,$augsub2,$mul43,$mul3,$sub40,$mul28,$mul29,$mul26,$mul27,$mul24,$mul25,$mul22,$mul23,$mul20,$mul21,$sub31,$sub30,$sub33,$sub29,$iter2_type,$sub34,$sub37,$sub36,$sub39,$sub38,$mul47,$augsub1,$iter2_nextval,$add51,$mul39,$mul38,$mul35,$mul37,$mul36,$mul31,$mul30,$mul33,$mul32,$add31,$add36,$mul41,$sub35,$iter2_iter,$mul42,$add54,$iter1_idx,$sub19,$sub18,$iter1_nextval,$sub13,$sub12,$sub11,$sub10,$sub17,$sub16,$sub15,$augexpr2,$mul34,$sub14,$add46,$mul17,$mul16,$mul15,$mul14,$mul13,$mul12,$mul11,$mul10,$add16,$mul19,$mul18,$add47,$div9,$div15,$add45,$iter2_array,$add11,$div17,$add43,$add42,$add41,$div13,$div18,$div19,$add49,$add48,$div14,$div6,$div16,$add44,$div10,$div11,$div12,$add19,$iter1_array,$add50,$div20,$add52,$iter2_idx,$add53,$mul9,$mul8,$mul7,$mul6,$mul5,$mul4,$mul2,$mul1,$add55,$add38,$add39,$add56,$add32,$add33,$add30,$add37,$add34,$add35,$add2,$add3,$add1,$add6,$add7,$add4,$add5,$add8,$add9,$augexpr1,$add40,$sub32,$sub41,$sub42,$add29,$add28,$mul48,$mul49,$add21,$add20,$add23,$add22,$add25,$add24,$add26,$sub9,$sub8,$sub3,$sub2,$sub1,$sub7,$sub6,$sub5,$sub4,$add14,$add15,$div8,$add17,$add10,$add12,$add13,$div2,$div3,$div1,$add18,$div7,$div4,$div5,$iter1_type,$mul52,$mul51,$mul50,$mul44,$mul45,$mul46;

	$m['math'] = $p['___import___']('math', null);
	$m['random'] = $p['___import___']('random', null);
	$m['WIDTH'] = 1000;
	$m['HEIGHT'] = 1000;
	$m['CENTREX'] = (typeof ($div1=$m['WIDTH'])==typeof ($div2=2) && typeof $div1=='number' && $div2 !== 0?
		$div1/$div2:
		$p['op_div']($div1,$div2));
	$m['CENTREY'] = (typeof ($div3=$m['HEIGHT'])==typeof ($div4=2) && typeof $div3=='number' && $div4 !== 0?
		$div3/$div4:
		$p['op_div']($div3,$div4));
	$m['NUMBEROFBIRDS'] = 200;
	$m['POSITIONSPREAD'] = 10000;
	$m['SPEEDSPREAD'] = 5;
	$m['MAXSPEED'] = 10;
	$m['BORDER'] = 100;
	$m['LEADERBORDER'] = 200;
	$m['BORDERSPEEDCHANGE'] = 0.2;
	$m['MINDIST'] = 10.0;
	$m['MATCHSPEEDWINDOW'] = 40.0;
	$m['LEADERBIRDRANDOMSPEEDCHANGE'] = 0.2;
	$m['LEADERMAXSPEED'] = 5.0;
	$m['barriers'] = $p['list']([$p['list']([450, 500]), $p['list']([475, 500]), $p['list']([500, 500]), $p['list']([525, 500]), $p['list']([625, 500]), $p['list']([650, 500]), $p['list']([675, 500]), $p['list']([700, 500]), $p['list']([400, 500]), $p['list']([425, 500]), $p['list']([400, 525]), $p['list']([400, 550]), $p['list']([400, 650]), $p['list']([400, 675]), $p['list']([400, 700]), $p['list']([375, 700]), $p['list']([350, 700]), $p['list']([325, 700]), $p['list']([300, 700]), $p['list']([275, 700]), $p['list']([250, 700]), $p['list']([800, 200]), $p['list']([250, 700]), $p['list']([100, 100])]);
	$m['BARRIERRADIUS'] = 30;
	$m['size'] = $p['list']([$m['WIDTH'], $m['HEIGHT']]);
	$m['birdlist'] = $p['list']([]);
	$m['leaderbirdx'] = 300.0;
	$m['leaderbirdy'] = 300.0;
	$m['leaderbirdvx'] = 5.0;
	$m['leaderbirdvy'] = 0.0;
	$m['i'] = 0;
	while ($p['bool'](($p['cmp']($m['i'], $m['NUMBEROFBIRDS']) == -1))) {
		$m['x'] = $m['random']['uniform']($p['__op_sub']($sub1=$m['CENTREX'],$sub2=$m['POSITIONSPREAD']), $p['__op_add']($add1=$m['CENTREX'],$add2=$m['POSITIONSPREAD']));
		$m['y'] = $m['random']['uniform']($p['__op_sub']($sub3=$m['CENTREY'],$sub4=$m['POSITIONSPREAD']), $p['__op_add']($add3=$m['CENTREY'],$add4=$m['POSITIONSPREAD']));
		$m['vx'] = $m['random']['uniform']((typeof ($usub1=$m['SPEEDSPREAD'])=='number'?
			-$usub1:
			$p['op_usub']($usub1)), $m['SPEEDSPREAD']);
		$m['vy'] = $m['random']['uniform']((typeof ($usub2=$m['SPEEDSPREAD'])=='number'?
			-$usub2:
			$p['op_usub']($usub2)), $m['SPEEDSPREAD']);
		$m['newbird'] = $p['list']([$m['x'], $m['y'], $m['vx'], $m['vy']]);
		$m['birdlist']['append']($m['newbird']);
		$m['i'] = $p['__op_add']($add5=$m['i'],$add6=1);
	}
	$m['ITERATIONS'] = 100;
	$iter1_iter = $p['range'](0, 100);
	$iter1_nextval=$p['__iter_prepare']($iter1_iter,false);
	while (typeof($p['__wrapped_next']($iter1_nextval)['$nextval']) != 'undefined') {
		$m['i'] = $iter1_nextval['$nextval'];
		if ($p['bool'](($p['cmp']($m['leaderbirdx'], $m['LEADERBORDER']) == -1))) {
			$m['leaderbirdvx'] = $p['__op_add']($add7=$m['leaderbirdvx'],$add8=$m['BORDERSPEEDCHANGE']);
		}
		if ($p['bool'](($p['cmp']($m['leaderbirdy'], $m['LEADERBORDER']) == -1))) {
			$m['leaderbirdvy'] = $p['__op_add']($add9=$m['leaderbirdvy'],$add10=$m['BORDERSPEEDCHANGE']);
		}
		if ($p['bool'](($p['cmp']($m['leaderbirdx'], $p['__op_sub']($sub5=$m['WIDTH'],$sub6=$m['LEADERBORDER'])) == 1))) {
			$m['leaderbirdvx'] = $p['__op_sub']($sub7=$m['leaderbirdvx'],$sub8=$m['BORDERSPEEDCHANGE']);
		}
		if ($p['bool'](($p['cmp']($m['leaderbirdy'], $p['__op_sub']($sub9=$m['HEIGHT'],$sub10=$m['LEADERBORDER'])) == 1))) {
			$m['leaderbirdvy'] = $p['__op_sub']($sub11=$m['leaderbirdvy'],$sub12=$m['BORDERSPEEDCHANGE']);
		}
		$m['leaderbirdvx'] = $p['__op_add']($add11=$m['leaderbirdvx'],$add12=$m['random']['uniform']((typeof ($usub3=$m['LEADERBIRDRANDOMSPEEDCHANGE'])=='number'?
			-$usub3:
			$p['op_usub']($usub3)), $m['LEADERBIRDRANDOMSPEEDCHANGE']));
		$m['leaderbirdvy'] = $p['__op_add']($add13=$m['leaderbirdvy'],$add14=$m['random']['uniform']((typeof ($usub4=$m['LEADERBIRDRANDOMSPEEDCHANGE'])=='number'?
			-$usub4:
			$p['op_usub']($usub4)), $m['LEADERBIRDRANDOMSPEEDCHANGE']));
		$m['speed'] = $m['math']['sqrt']($p['__op_add']($add15=(typeof ($mul1=$m['leaderbirdvx'])==typeof ($mul2=$m['leaderbirdvx']) && typeof $mul1=='number'?
			$mul1*$mul2:
			$p['op_mul']($mul1,$mul2)),$add16=(typeof ($mul3=$m['leaderbirdvy'])==typeof ($mul4=$m['leaderbirdvy']) && typeof $mul3=='number'?
			$mul3*$mul4:
			$p['op_mul']($mul3,$mul4))));
		if ($p['bool'](($p['cmp']($m['speed'], $m['LEADERMAXSPEED']) == 1))) {
			$m['leaderbirdvx'] = (typeof ($div5=(typeof ($mul5=$m['leaderbirdvx'])==typeof ($mul6=$m['LEADERMAXSPEED']) && typeof $mul5=='number'?
				$mul5*$mul6:
				$p['op_mul']($mul5,$mul6)))==typeof ($div6=$m['speed']) && typeof $div5=='number' && $div6 !== 0?
				$div5/$div6:
				$p['op_div']($div5,$div6));
			$m['leaderbirdvy'] = (typeof ($div7=(typeof ($mul7=$m['leaderbirdvy'])==typeof ($mul8=$m['LEADERMAXSPEED']) && typeof $mul7=='number'?
				$mul7*$mul8:
				$p['op_mul']($mul7,$mul8)))==typeof ($div8=$m['speed']) && typeof $div7=='number' && $div8 !== 0?
				$div7/$div8:
				$p['op_div']($div7,$div8));
		}
		$m['leaderbirdx'] = $p['__op_add']($add17=$m['leaderbirdx'],$add18=$m['leaderbirdvx']);
		$m['leaderbirdy'] = $p['__op_add']($add19=$m['leaderbirdy'],$add20=$m['leaderbirdvy']);
		$m['i'] = 0;
		while ($p['bool'](($p['cmp']($m['i'], $m['NUMBEROFBIRDS']) == -1))) {
			$m['x'] = $m['birdlist']['__getitem__']($m['i'])['__getitem__'](0);
			$m['y'] = $m['birdlist']['__getitem__']($m['i'])['__getitem__'](1);
			$m['vx'] = $m['birdlist']['__getitem__']($m['i'])['__getitem__'](2);
			$m['vy'] = $m['birdlist']['__getitem__']($m['i'])['__getitem__'](3);
			$m['colr'] = $p['float_int']((typeof ($div9=(typeof ($mul9=$p['float']($m['i']))==typeof ($mul10=255.0) && typeof $mul9=='number'?
				$mul9*$mul10:
				$p['op_mul']($mul9,$mul10)))==typeof ($div10=$m['NUMBEROFBIRDS']) && typeof $div9=='number' && $div10 !== 0?
				$div9/$div10:
				$p['op_div']($div9,$div10)));
			$m['colg'] = $p['float_int']((typeof ($div11=(typeof ($mul11=$p['__op_sub']($sub13=$m['NUMBEROFBIRDS'],$sub14=$p['float']($m['i'])))==typeof ($mul12=255.0) && typeof $mul11=='number'?
				$mul11*$mul12:
				$p['op_mul']($mul11,$mul12)))==typeof ($div12=$m['NUMBEROFBIRDS']) && typeof $div11=='number' && $div12 !== 0?
				$div11/$div12:
				$p['op_div']($div11,$div12)));
			$m['colb'] = 255;
			if ($p['bool'](($p['cmp']($m['x'], $m['BORDER']) == -1))) {
				$m['vx'] = $p['__op_add']($add21=$m['vx'],$add22=$m['BORDERSPEEDCHANGE']);
			}
			if ($p['bool'](($p['cmp']($m['y'], $m['BORDER']) == -1))) {
				$m['vy'] = $p['__op_add']($add23=$m['vy'],$add24=$m['BORDERSPEEDCHANGE']);
			}
			if ($p['bool'](($p['cmp']($m['x'], $p['__op_sub']($sub15=$m['WIDTH'],$sub16=$m['BORDER'])) == 1))) {
				$m['vx'] = $p['__op_sub']($sub17=$m['vx'],$sub18=$m['BORDERSPEEDCHANGE']);
			}
			if ($p['bool'](($p['cmp']($m['y'], $p['__op_sub']($sub19=$m['HEIGHT'],$sub20=$m['BORDER'])) == 1))) {
				$m['vy'] = $p['__op_sub']($sub21=$m['vy'],$sub22=$m['BORDERSPEEDCHANGE']);
			}
			$m['leaderdiffx'] = $p['__op_sub']($sub23=$m['leaderbirdx'],$sub24=$m['x']);
			$m['leaderdiffy'] = $p['__op_sub']($sub25=$m['leaderbirdy'],$sub26=$m['y']);
			$m['vx'] = $p['__op_add']($add25=$m['vx'],$add26=(typeof ($mul13=0.007)==typeof ($mul14=$m['leaderdiffx']) && typeof $mul13=='number'?
				$mul13*$mul14:
				$p['op_mul']($mul13,$mul14)));
			$m['vy'] = $p['__op_add']($add27=$m['vy'],$add28=(typeof ($mul15=0.007)==typeof ($mul16=$m['leaderdiffy']) && typeof $mul15=='number'?
				$mul15*$mul16:
			...
			$m['avytotal'] = 0;
			$m['avcount'] = 0;
			while ($p['bool'](($p['cmp']($m['j'], $m['NUMBEROFBIRDS']) == -1))) {
				if ($p['bool'](!$p['op_eq']($m['j'], $m['i']))) {
					$m['dx'] = $p['__op_sub']($sub27=$m['birdlist']['__getitem__']($m['j'])['__getitem__'](0),$sub28=$m['x']);
					$m['dy'] = $p['__op_sub']($sub29=$m['birdlist']['__getitem__']($m['j'])['__getitem__'](1),$sub30=$m['y']);
					$m['dist'] = $m['math']['sqrt']($p['__op_add']($add29=(typeof ($mul17=$m['dx'])==typeof ($mul18=$m['dx']) && typeof $mul17=='number'?
						$mul17*$mul18:
						$p['op_mul']($mul17,$mul18)),$add30=(typeof ($mul19=$m['dy'])==typeof ($mul20=$m['dy']) && typeof $mul19=='number'?
						$mul19*$mul20:
						$p['op_mul']($mul19,$mul20))));
					if ($p['bool'](($p['cmp']($m['dist'], $m['MINDIST']) == -1))) {
						$m['vx'] = $p['__op_sub']($sub31=$m['vx'],$sub32=(typeof ($mul21=$m['dx'])==typeof ($mul22=0.2) && typeof $mul21=='number'?
							$mul21*$mul22:
							$p['op_mul']($mul21,$mul22)));
						$m['vy'] = $p['__op_sub']($sub33=$m['vy'],$sub34=(typeof ($mul23=$m['dy'])==typeof ($mul24=0.2) && typeof $mul23=='number'?
							$mul23*$mul24:
							$p['op_mul']($mul23,$mul24)));
					}
					if ($p['bool'](($p['cmp']($m['dist'], $m['MATCHSPEEDWINDOW']) == -1))) {
						$m['avxtotal'] = $p['__op_add']($add31=$m['avxtotal'],$add32=$m['birdlist']['__getitem__']($m['j'])['__getitem__'](2));
						$m['avytotal'] = $p['__op_add']($add33=$m['avytotal'],$add34=$m['birdlist']['__getitem__']($m['j'])['__getitem__'](3));
						$m['avcount'] = $p['__op_add']($add35=$m['avcount'],$add36=1);
					}
				}
				$m['j'] = $p['__op_add']($add37=$m['j'],$add38=1);
			}
			if ($p['bool'](!$p['op_eq']($m['avcount'], 0))) {
				$m['avx'] = (typeof ($div13=$m['avxtotal'])==typeof ($div14=$m['avcount']) && typeof $div13=='number' && $div14 !== 0?
					$div13/$div14:
					$p['op_div']($div13,$div14));
				$m['avy'] = (typeof ($div15=$m['avytotal'])==typeof ($div16=$m['avcount']) && typeof $div15=='number' && $div16 !== 0?
					$div15/$div16:
					$p['op_div']($div15,$div16));
				$m['vx'] = $p['__op_add']($add39=(typeof ($mul25=0.9)==typeof ($mul26=$m['vx']) && typeof $mul25=='number'?
					$mul25*$mul26:
					$p['op_mul']($mul25,$mul26)),$add40=(typeof ($mul27=0.1)==typeof ($mul28=$m['avx']) && typeof $mul27=='number'?
					$mul27*$mul28:
					$p['op_mul']($mul27,$mul28)));
				$m['vy'] = $p['__op_add']($add41=(typeof ($mul29=0.9)==typeof ($mul30=$m['vy']) && typeof $mul29=='number'?
					$mul29*$mul30:
					$p['op_mul']($mul29,$mul30)),$add42=(typeof ($mul31=0.1)==typeof ($mul32=$m['avy']) && typeof $mul31=='number'?
					$mul31*$mul32:
					$p['op_mul']($mul31,$mul32)));
			}
			$iter2_iter = $m['barriers'];
			$iter2_nextval=$p['__iter_prepare']($iter2_iter,false);
			while (typeof($p['__wrapped_next']($iter2_nextval)['$nextval']) != 'undefined') {
				$m['barrier'] = $iter2_nextval['$nextval'];
				$m['dx'] = $p['__op_sub']($sub35=$m['barrier']['__getitem__'](0),$sub36=$m['x']);
				$m['dy'] = $p['__op_sub']($sub37=$m['barrier']['__getitem__'](1),$sub38=$m['y']);
				$m['dist'] = $m['math']['sqrt']($p['__op_add']($add43=(typeof ($mul33=$m['dx'])==typeof ($mul34=$m['dx']) && typeof $mul33=='number'?
					$mul33*$mul34:
					$p['op_mul']($mul33,$mul34)),$add44=(typeof ($mul35=$m['dy'])==typeof ($mul36=$m['dy']) && typeof $mul35=='number'?
					$mul35*$mul36:
					$p['op_mul']($mul35,$mul36))));
				if ($p['bool'](($p['cmp']($m['dist'], $p['__op_add']($add45=$m['BARRIERRADIUS'],$add46=15)) == -1))) {
					$m['vx'] = $p['__op_sub']($sub39=$m['vx'],$sub40=(typeof ($mul37=$m['dx'])==typeof ($mul38=0.1) && typeof $mul37=='number'?
						$mul37*$mul38:
						$p['op_mul']($mul37,$mul38)));
					$m['vx'] = (typeof ($mul39=$m['vx'])==typeof ($mul40=0.6) && typeof $mul39=='number'?
						$mul39*$mul40:
						$p['op_mul']($mul39,$mul40));
					$m['vy'] = $p['__op_sub']($sub41=$m['vy'],$sub42=(typeof ($mul41=$m['dy'])==typeof ($mul42=0.1) && typeof $mul41=='number'?
						$mul41*$mul42:
						$p['op_mul']($mul41,$mul42)));
					$m['vy'] = (typeof ($mul43=$m['vy'])==typeof ($mul44=0.6) && typeof $mul43=='number'?
						$mul43*$mul44:
						$p['op_mul']($mul43,$mul44));
				}
			}
			$m['speed'] = $m['math']['sqrt']($p['__op_add']($add47=(typeof ($mul45=$m['vx'])==typeof ($mul46=$m['vx']) && typeof $mul45=='number'?
				$mul45*$mul46:
				$p['op_mul']($mul45,$mul46)),$add48=(typeof ($mul47=$m['vy'])==typeof ($mul48=$m['vy']) && typeof $mul47=='number'?
				$mul47*$mul48:
				$p['op_mul']($mul47,$mul48))));
			if ($p['bool'](($p['cmp']($m['speed'], $m['MAXSPEED']) == 1))) {
				$m['vx'] = (typeof ($div17=(typeof ($mul49=$m['vx'])==typeof ($mul50=$m['MAXSPEED']) && typeof $mul49=='number'?
					$mul49*$mul50:
					$p['op_mul']($mul49,$mul50)))==typeof ($div18=$m['speed']) && typeof $div17=='number' && $div18 !== 0?
					$div17/$div18:
					$p['op_div']($div17,$div18));
				$m['vy'] = (typeof ($div19=(typeof ($mul51=$m['vy'])==typeof ($mul52=$m['MAXSPEED']) && typeof $mul51=='number'?
					$mul51*$mul52:
					$p['op_mul']($mul51,$mul52)))==typeof ($div20=$m['speed']) && typeof $div19=='number' && $div20 !== 0?
					$div19/$div20:
					$p['op_div']($div19,$div20));
			}
			var $augsub1 = 0;
			var $augexpr1 = $m['birdlist']['__getitem__']($m['i']);
			$augexpr1['__setitem__']($augsub1, $p['__op_add']($add49=$augexpr1['__getitem__']($augsub1),$add50=$m['vx']));
			var $augsub2 = 1;
			var $augexpr2 = $m['birdlist']['__getitem__']($m['i']);
			$augexpr2['__setitem__']($augsub2, $p['__op_add']($add51=$augexpr2['__getitem__']($augsub2),$add52=$m['vy']));
			$m['birdlist']['__getitem__']($m['i'])['__setitem__'](2, $m['vx']);
			$m['birdlist']['__getitem__']($m['i'])['__setitem__'](3, $m['vy']);
			$m['i'] = $p['__op_add']($add53=$m['i'],$add54=1);
		}
		$m['i'] = $p['__op_add']($add55=$m['i'],$add56=1);
	}
	return this;
}; /* end main */
