...
$pyjs['loaded_modules']['main'] = function (__mod_name__) {
	...
	$m['OrderedCollection'] = (function(){
		...
		var $data = $p['dict']();
		for (var $item in $cls_definition) { $data['__setitem__']($item, $cls_definition[$item]); }
		return $p['_create_class']('OrderedCollection', $p['tuple']($bases), $data);
	})();
	$m['Strength'] = (function(){
		var $cls_definition = new Object();
		var $method;
		$cls_definition['__module__'] = 'main';
		$cls_definition['REQUIRED'] = null;
		$cls_definition['STRONG_PREFERRED'] = null;
		$cls_definition['PREFERRED'] = null;
		$cls_definition['STRONG_DEFAULT'] = null;
		$cls_definition['NORMAL'] = null;
		$cls_definition['WEAK_DEFAULT'] = null;
		$cls_definition['WEAKEST'] = null;
		$method = $pyjs__bind_method2('__init__', function(strength, name) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			$p['$$super']($m['Strength'], self)['__init__']();
			self['strength'] = strength;
			self['$$name'] = name;
			return null;
		}
	, 1, [null,null,['self'],['strength'],['name']]);
		$cls_definition['__init__'] = $method;
		$method = $pyjs__bind_method2('stronger', function(s1, s2) {
    var cls = this['prototype'];

			return ($p['cmp']($p['getattr'](s1, 'strength'), $p['getattr'](s2, 'strength')) == -1);
		}
	, 2, [null,null,['cls'],['s1'],['s2']]);
		$cls_definition['stronger'] = $method;
		$method = $pyjs__bind_method2('weaker', function(s1, s2) {
    var cls = this['prototype'];

			return ($p['cmp']($p['getattr'](s1, 'strength'), $p['getattr'](s2, 'strength')) == 1);
		}
	, 2, [null,null,['cls'],['s1'],['s2']]);
		$cls_definition['weaker'] = $method;
		$method = $pyjs__bind_method2('weakest_of', function(s1, s2) {
    var cls = this['prototype'];

			if ($p['bool'](cls['weaker'](s1, s2))) {
				return s1;
			}
			return s2;
		}
	, 2, [null,null,['cls'],['s1'],['s2']]);
		$cls_definition['weakest_of'] = $method;
		$method = $pyjs__bind_method2('strongest', function(s1, s2) {
    var cls = this['prototype'];

			if ($p['bool'](cls['stronger'](s1, s2))) {
				return s1;
			}
			return s2;
		}
	, 2, [null,null,['cls'],['s1'],['s2']]);
		$cls_definition['strongest'] = $method;
		$method = $pyjs__bind_method2('next_weaker', function() {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			var strengths;
			strengths = $p['dict']([[0, $p['getattr']($p['getattr'](self, '__class__'), 'WEAKEST')], [1, $p['getattr']($p['getattr'](self, '__class__'), 'WEAK_DEFAULT')], [2, $p['getattr']($p['getattr'](self, '__class__'), 'NORMAL')], [3, $p['getattr']($p['getattr'](self, '__class__'), 'STRONG_DEFAULT')], [4, $p['getattr']($p['getattr'](self, '__class__'), 'PREFERRED')], [5, $p['getattr']($p['getattr'](self, '__class__'), 'REQUIRED')]]);
			return strengths['__getitem__']($p['getattr'](self, 'strength'));
		}
	, 1, [null,null,['self']]);
		$cls_definition['next_weaker'] = $method;
		var $bases = new Array($p['object']);
		var $data = $p['dict']();
		for (var $item in $cls_definition) { $data['__setitem__']($item, $cls_definition[$item]); }
		return $p['_create_class']('Strength', $p['tuple']($bases), $data);
	})();
	$m['Strength']['REQUIRED'] = $m['Strength'](0, 'required');
	$m['Strength']['STONG_PREFERRED'] = $m['Strength'](1, 'strongPreferred');
	$m['Strength']['PREFERRED'] = $m['Strength'](2, 'preferred');
	$m['Strength']['STRONG_DEFAULT'] = $m['Strength'](3, 'strongDefault');
	$m['Strength']['NORMAL'] = $m['Strength'](4, 'normal');
	$m['Strength']['WEAK_DEFAULT'] = $m['Strength'](5, 'weakDefault');
	$m['Strength']['WEAKEST'] = $m['Strength'](6, 'weakest');
	$m['Constraint'] = (function(){
		var $cls_definition = new Object();
		var $method;
		$cls_definition['__module__'] = 'main';
		$method = $pyjs__bind_method2('__init__', function(strength) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			$p['$$super']($m['Constraint'], self)['__init__']();
			self['strength'] = strength;
			return null;
		}
	, 1, [null,null,['self'],['strength']]);
		$cls_definition['__init__'] = $method;
		$method = $pyjs__bind_method2('add_constraint', function() {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			self['add_to_graph']();
			$m['planner']['incremental_add'](self);
			return null;
		}
	, 1, [null,null,['self']]);
		$cls_definition['add_constraint'] = $method;
		$method = $pyjs__bind_method2('satisfy', function(mark) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			if ($p['bool'](!$p['bool'](self['is_satisfied']()))) {
				if ($p['bool']($p['op_eq']($p['getattr'](self, 'strength'), $p['getattr']($m['Strength'], 'REQUIRED')))) {
					$p['printFunc'](['Could not satisfy a required constraint!'], 1);
				}
				return null;
			}
			self['mark_inputs'](mark);
			out = self['output']();
			overridden = $p['getattr'](out, 'determined_by');
			if ($p['bool']((overridden !== null))) {
				overridden['mark_unsatisfied']();
			}
			out['determined_by'] = self;
			if ($p['bool'](!$p['bool']($m['planner']['add_propagate'](self, mark)))) {
				$p['printFunc'](['Cycle encountered'], 1);
			}
			out['mark'] = mark;
			return overridden;
		}
	, 1, [null,null,['self'],['mark']]);
		$cls_definition['satisfy'] = $method;
		$method = $pyjs__bind_method2('destroy_constraint', function() {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			if ($p['bool'](self['is_satisfied']())) {
				$m['planner']['incremental_remove'](self);
			}
			else {
	...
	, 1, [null,null,['self']]);
		$cls_definition['destroy_constraint'] = $method;
		$method = $pyjs__bind_method2('is_input', function() {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
	...
	, 1, [null,null,['self']]);
		$cls_definition['is_input'] = $method;
		var $bases = new Array($p['object']);
		var $data = $p['dict']();
		for (var $item in $cls_definition) { $data['__setitem__']($item, $cls_definition[$item]); }
		return $p['_create_class']('Constraint', $p['tuple']($bases), $data);
	})();
	$m['UrnaryConstraint'] = (function(){
		var $cls_definition = new Object();
		var $method;
		$cls_definition['__module__'] = 'main';
		$method = $pyjs__bind_method2('__init__', function(v, strength) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
				v = arguments[1];
				strength = arguments[2];
			}

			$p['$$super']($m['UrnaryConstraint'], self)['__init__'](strength);
			self['my_output'] = v;
			self['satisfied'] = false;
			self['add_constraint']();
			return null;
		}
	, 1, [null,null,['self'],['v'],['strength']]);
		$cls_definition['__init__'] = $method;
		$method = $pyjs__bind_method2('add_to_graph', function() {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
	...
	, 1, [null,null,['self']]);
		$cls_definition['add_to_graph'] = $method;
		$method = $pyjs__bind_method2('choose_method', function(mark) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			var $and1,$and2;
			if ($p['bool'](($p['bool']($and1=!$p['op_eq']($p['getattr']($p['getattr'](self, 'my_output'), 'mark'), mark))?$m['Strength']['stronger']($p['getattr'](self, 'strength'), $p['getattr']($p['getattr'](self, 'my_output'), 'walk_strength')):$and1))) {
				self['satisfied'] = true;
			}
			else {
				self['satisfied'] = false;
	...
	, 1, [null,null,['self'],['mark']]);
		$cls_definition['choose_method'] = $method;
		$method = $pyjs__bind_method2('is_satisfied', function() {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			return $p['getattr'](self, 'satisfied');
		}
	, 1, [null,null,['self']]);
		$cls_definition['is_satisfied'] = $method;
		$method = $pyjs__bind_method2('mark_inputs', function(mark) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
	...
	, 1, [null,null,['self'],['mark']]);
		$cls_definition['mark_inputs'] = $method;
		$method = $pyjs__bind_method2('output', function() {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			return $p['getattr'](self, 'my_output');
		}
	, 1, [null,null,['self']]);
		$cls_definition['output'] = $method;
		$method = $pyjs__bind_method2('recalculate', function() {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			$p['getattr'](self, 'my_output')['walk_strength'] = $p['getattr'](self, 'strength');
			$p['getattr'](self, 'my_output')['stay'] = !$p['bool'](self['is_input']());
			if ($p['bool']($p['getattr']($p['getattr'](self, 'my_output'), 'stay'))) {
				self['execute']();
			}
			return null;
		}
	, 1, [null,null,['self']]);
		$cls_definition['recalculate'] = $method;
		$method = $pyjs__bind_method2('mark_unsatisfied', function() {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
	...
	, 1, [null,null,['self']]);
		$cls_definition['mark_unsatisfied'] = $method;
		$method = $pyjs__bind_method2('inputs_known', function(mark) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
	...
	, 1, [null,null,['self'],['mark']]);
		$cls_definition['inputs_known'] = $method;
		$method = $pyjs__bind_method2('remove_from_graph', function() {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			if ($p['bool'](($p['getattr'](self, 'my_output') !== null))) {
	...
	, 1, [null,null,['self']]);
		$cls_definition['remove_from_graph'] = $method;
		var $bases = new Array($m['Constraint']);
		var $data = $p['dict']();
		for (var $item in $cls_definition) { $data['__setitem__']($item, $cls_definition[$item]); }
		return $p['_create_class']('UrnaryConstraint', $p['tuple']($bases), $data);
	})();
	$m['StayConstraint'] = (function(){
		var $cls_definition = new Object();
		var $method;
		$cls_definition['__module__'] = 'main';
		$method = $pyjs__bind_method2('__init__', function(v, string) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			$p['$$super']($m['StayConstraint'], self)['__init__'](v, string);
			return null;
		}
	, 1, [null,null,['self'],['v'],['string']]);
		$cls_definition['__init__'] = $method;
	...
	, 1, [null,null,['self']]);
		...
		var $bases = new Array($m['UrnaryConstraint']);
		var $data = $p['dict']();
		for (var $item in $cls_definition) { $data['__setitem__']($item, $cls_definition[$item]); }
		return $p['_create_class']('StayConstraint', $p['tuple']($bases), $data);
	})();
	$m['EditConstraint'] = (function(){
		var $cls_definition = new Object();
		var $method;
		$cls_definition['__module__'] = 'main';
		$method = $pyjs__bind_method2('__init__', function(v, string) {
			...
			$p['$$super']($m['EditConstraint'], self)['__init__'](v, string);
			return null;
		}
	, 1, [null,null,['self'],['v'],['string']]);
		$cls_definition['__init__'] = $method;
	...
	, 1, [null,null,['self']]);
		...
		var $data = $p['dict']();
		for (var $item in $cls_definition) { $data['__setitem__']($item, $cls_definition[$item]); }
		return $p['_create_class']('EditConstraint', $p['tuple']($bases), $data);
	})();
	$m['Direction'] = (function(){
		var $cls_definition = new Object();
		var $method;
		$cls_definition['__module__'] = 'main';
		$cls_definition['NONE'] = 0;
		$cls_definition['FORWARD'] = 1;
		$cls_definition['BACKWARD'] = (typeof ($usub1=1)=='number'?
			-$usub1:
			$p['op_usub']($usub1));
		var $bases = new Array($p['object']);
		var $data = $p['dict']();
		for (var $item in $cls_definition) { $data['__setitem__']($item, $cls_definition[$item]); }
		return $p['_create_class']('Direction', $p['tuple']($bases), $data);
	})();
	$m['BinaryConstraint'] = (function(){
		var $cls_definition = new Object();
		var $method;
		$cls_definition['__module__'] = 'main';
		$method = $pyjs__bind_method2('__init__', function(v1, v2, strength) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
				v1 = arguments[1];
				v2 = arguments[2];
				strength = arguments[3];
			}

			$p['$$super']($m['BinaryConstraint'], self)['__init__'](strength);
			self['v1'] = v1;
			self['v2'] = v2;
			self['direction'] = $p['getattr']($m['Direction'], 'NONE');
			self['add_constraint']();
			return null;
		}
	, 1, [null,null,['self'],['v1'],['v2'],['strength']]);
		$cls_definition['__init__'] = $method;
		$method = $pyjs__bind_method2('choose_method', function(mark) {
			if (this['__is_instance__'] === true) {
				var self = this;
			...
			if ($p['bool']($p['op_eq']($p['getattr']($p['getattr'](self, 'v1'), 'mark'), mark))) {
				if ($p['bool'](($p['bool']($and3=!$p['op_eq']($p['getattr']($p['getattr'](self, 'v2'), 'mark'), mark))?$m['Strength']['stronger']($p['getattr'](self, 'strength'), $p['getattr']($p['getattr'](self, 'v2'), 'walk_strength')):$and3))) {
					self['direction'] = $p['getattr']($m['Direction'], 'FORWARD');
				}
				else {
					self['direction'] = $p['getattr']($m['Direction'], 'BACKWARD');
				}
			}
			if ($p['bool']($p['op_eq']($p['getattr']($p['getattr'](self, 'v2'), 'mark'), mark))) {
				if ($p['bool'](($p['bool']($and5=!$p['op_eq']($p['getattr']($p['getattr'](self, 'v1'), 'mark'), mark))?$m['Strength']['stronger']($p['getattr'](self, 'strength'), $p['getattr']($p['getattr'](self, 'v1'), 'walk_strength')):$and5))) {
					self['direction'] = $p['getattr']($m['Direction'], 'BACKWARD');
				}
				else {
					self['direction'] = $p['getattr']($m['Direction'], 'NONE');
			...
			if ($p['bool']($m['Strength']['weaker']($p['getattr']($p['getattr'](self, 'v1'), 'walk_strength'), $p['getattr']($p['getattr'](self, 'v2'), 'walk_strength')))) {
				if ($p['bool']($m['Strength']['stronger']($p['getattr'](self, 'strength'), $p['getattr']($p['getattr'](self, 'v1'), 'walk_strength')))) {
					self['direction'] = $p['getattr']($m['Direction'], 'BACKWARD');
				}
				else {
					self['direction'] = $p['getattr']($m['Direction'], 'NONE');
				...
				if ($p['bool']($m['Strength']['stronger']($p['getattr'](self, 'strength'), $p['getattr']($p['getattr'](self, 'v2'), 'walk_strength')))) {
					self['direction'] = $p['getattr']($m['Direction'], 'FORWARD');
				}
				else {
					self['direction'] = $p['getattr']($m['Direction'], 'BACKWARD');
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('is_satisfied', function() {
			...
			return !$p['op_eq']($p['getattr'](self, 'direction'), $p['getattr']($m['Direction'], 'NONE'));
		}
	, 1, [null,null,['self']]);
		$cls_definition['is_satisfied'] = $method;
		$method = $pyjs__bind_method2('mark_inputs', function(mark) {
	...
	, 1, [null,null,['self'],['mark']]);
		$cls_definition['mark_inputs'] = $method;
		$method = $pyjs__bind_method2('input', function() {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			if ($p['bool']($p['op_eq']($p['getattr'](self, 'direction'), $p['getattr']($m['Direction'], 'FORWARD')))) {
				return $p['getattr'](self, 'v1');
			}
			return $p['getattr'](self, 'v2');
		}
	, 1, [null,null,['self']]);
		$cls_definition['input'] = $method;
		$method = $pyjs__bind_method2('output', function() {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('recalculate', function() {
			...
			ihn = self['input']();
			out = self['output']();
			out['walk_strength'] = $m['Strength']['weakest_of']($p['getattr'](self, 'strength'), $p['getattr'](ihn, 'walk_strength'));
			out['stay'] = $p['getattr'](ihn, 'stay');
			if ($p['bool']($p['getattr'](out, 'stay'))) {
				self['execute']();
			}
			return null;
		}
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('inputs_known', function(mark) {
			...
			var $or1,$or3,$or2,i;
			i = self['input']();
			return ($p['bool']($or1=$p['op_eq']($p['getattr'](i, 'mark'), mark))?$or1:($p['bool']($or2=$p['getattr'](i, 'stay'))?$or2:($p['getattr'](i, 'determined_by') === null)));
		}
	, 1, [null,null,['self'],['mark']]);
		$cls_definition['inputs_known'] = $method;
		$method = $pyjs__bind_method2('remove_from_graph', function() {
			...
			if ($p['bool'](($p['getattr'](self, 'v1') !== null))) {
				self['v1']['remove_constraint'](self);
			}
			if ($p['bool'](($p['getattr'](self, 'v2') !== null))) {
	...
	, 1, [null,null,['self']]);
		...
		var $data = $p['dict']();
		for (var $item in $cls_definition) { $data['__setitem__']($item, $cls_definition[$item]); }
		return $p['_create_class']('BinaryConstraint', $p['tuple']($bases), $data);
	})();
	$m['ScaleConstraint'] = (function(){
		var $cls_definition = new Object();
		var $method;
		$cls_definition['__module__'] = 'main';
		$method = $pyjs__bind_method2('__init__', function(src, scale, offset, dest, strength) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			self['scale'] = scale;
			self['offset'] = offset;
			$p['$$super']($m['ScaleConstraint'], self)['__init__'](src, dest, strength);
			return null;
		}
	, 1, [null,null,['self'],['src'],['scale'],['offset'],['dest'],['strength']]);
		$cls_definition['__init__'] = $method;
		$method = $pyjs__bind_method2('add_to_graph', function() {
			if (this['__is_instance__'] === true) {
				var self = this;
			...
			$p['$$super']($m['ScaleConstraint'], self)['add_to_graph']();
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('remove_from_graph', function() {
			...
			$p['$$super']($m['ScaleConstraint'], self)['remove_from_graph']();
			if ($p['bool'](($p['getattr'](self, 'scale') !== null))) {
				self['scale']['remove_constraint'](self);
			}
			if ($p['bool'](($p['getattr'](self, 'offset') !== null))) {
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('mark_inputs', function(mark) {
			...
			$p['$$super']($m['ScaleConstraint'], self)['mark_inputs'](mark);
			$p['getattr'](self, 'scale')['mark'] = mark;
			$p['getattr'](self, 'offset')['mark'] = mark;
			return null;
		}
	, 1, [null,null,['self'],['mark']]);
		$cls_definition['mark_inputs'] = $method;
		$method = $pyjs__bind_method2('execute', function() {
			...
			var $add2,$add1,$div2,$sub2,$sub1,$div1,$mul2,$mul1;
			if ($p['bool']($p['op_eq']($p['getattr'](self, 'direction'), $p['getattr']($m['Direction'], 'FORWARD')))) {
				$p['getattr'](self, 'v2')['value'] = $p['__op_add']($add1=(typeof ($mul1=$p['getattr']($p['getattr'](self, 'v1'), 'value'))==typeof ($mul2=$p['getattr']($p['getattr'](self, 'scale'), 'value')) && typeof $mul1=='number'?
					$mul1*$mul2:
					$p['op_mul']($mul1,$mul2)),$add2=$p['getattr']($p['getattr'](self, 'offset'), 'value'));
			}
			else {
				$p['getattr'](self, 'v1')['value'] = (typeof ($div1=$p['__op_sub']($sub1=$p['getattr']($p['getattr'](self, 'v2'), 'value'),$sub2=$p['getattr']($p['getattr'](self, 'offset'), 'value')))==typeof ($div2=$p['getattr']($p['getattr'](self, 'scale'), 'value')) && typeof $div1=='number' && $div2 !== 0?
					$div1/$div2:
					$p['op_div']($div1,$div2));
			}
			return null;
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('recalculate', function() {
			...
			var $and8,$and9,$and7,ihn,out;
			ihn = self['input']();
			out = self['output']();
			out['walk_strength'] = $m['Strength']['weakest_of']($p['getattr'](self, 'strength'), $p['getattr'](ihn, 'walk_strength'));
			out['stay'] = ($p['bool']($and7=$p['getattr'](ihn, 'stay'))?($p['bool']($and8=$p['getattr']($p['getattr'](self, 'scale'), 'stay'))?$p['getattr']($p['getattr'](self, 'offset'), 'stay'):$and8):$and7);
			if ($p['bool']($p['getattr'](out, 'stay'))) {
				self['execute']();
			}
			return null;
	...
	, 1, [null,null,['self']]);
		$cls_definition['recalculate'] = $method;
		var $bases = new Array($m['BinaryConstraint']);
		var $data = $p['dict']();
		for (var $item in $cls_definition) { $data['__setitem__']($item, $cls_definition[$item]); }
		return $p['_create_class']('ScaleConstraint', $p['tuple']($bases), $data);
	})();
	$m['EqualityConstraint'] = (function(){
		var $cls_definition = new Object();
		var $method;
		$cls_definition['__module__'] = 'main';
		$method = $pyjs__bind_method2('execute', function() {
			...
			self['output']()['value'] = $p['getattr'](self['input'](), 'value');
			return null;
		}
	, 1, [null,null,['self']]);
		$cls_definition['execute'] = $method;
		...
		var $data = $p['dict']();
		for (var $item in $cls_definition) { $data['__setitem__']($item, $cls_definition[$item]); }
		return $p['_create_class']('EqualityConstraint', $p['tuple']($bases), $data);
	})();
	$m['Variable'] = (function(){
		var $cls_definition = new Object();
		var $method;
		$cls_definition['__module__'] = 'main';
		$method = $pyjs__bind_method2('__init__', function(name, initial_value) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
				name = arguments[1];
				initial_value = arguments[2];
			}
			if (typeof initial_value == 'undefined') initial_value=arguments['callee']['__args__'][4][1];

			$p['$$super']($m['Variable'], self)['__init__']();
			self['$$name'] = name;
			self['value'] = initial_value;
			self['constraints'] = $m['OrderedCollection']();
			self['determined_by'] = null;
			self['mark'] = 0;
			self['walk_strength'] = $p['getattr']($m['Strength'], 'WEAKEST');
			self['stay'] = true;
			return null;
		}
	, 1, [null,null,['self'],['name'],['initial_value', 0]]);
		$cls_definition['__init__'] = $method;
		$method = $pyjs__bind_method2('__repr__', function() {
			if (this['__is_instance__'] === true) {
				var self = this;
			...
			return $p['sprintf']('<Variable: %s - %s>', $p['tuple']([$p['getattr'](self, '$$name'), $p['getattr'](self, 'value')]));
		}
	, 1, [null,null,['self']]);
		$cls_definition['__repr__'] = $method;
		$method = $pyjs__bind_method2('add_constraint', function(constraint) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
	...
	, 1, [null,null,['self'],['constraint']]);
		$cls_definition['add_constraint'] = $method;
		$method = $pyjs__bind_method2('remove_constraint', function(constraint) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			if ($p['bool']($p['op_eq']($p['getattr'](self, 'determined_by'), constraint))) {
				self['determined_by'] = null;
			}
			return null;
		}
	, 1, [null,null,['self'],['constraint']]);
		$cls_definition['remove_constraint'] = $method;
		var $bases = new Array($p['object']);
		var $data = $p['dict']();
		for (var $item in $cls_definition) { $data['__setitem__']($item, $cls_definition[$item]); }
		return $p['_create_class']('Variable', $p['tuple']($bases), $data);
	})();
	$m['Planner'] = (function(){
		var $cls_definition = new Object();
		var $method;
		...
		$method = $pyjs__bind_method2('__init__', function() {
			...
			$p['$$super']($m['Planner'], self)['__init__']();
			self['current_mark'] = 0;
			return null;
		}
	, 1, [null,null,['self']]);
		$cls_definition['__init__'] = $method;
		$method = $pyjs__bind_method2('incremental_add', function(constraint) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			while ($p['bool']((overridden !== null))) {
				overridden = overridden['satisfy'](mark);
			}
			return null;
		}
	, 1, [null,null,['self'],['constraint']]);
		$cls_definition['incremental_add'] = $method;
		$method = $pyjs__bind_method2('incremental_remove', function(constraint) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			var unsatisfied,$iter1_idx,strength,$iter1_nextval,$iter1_type,$iter1_iter,repeat,u,$iter1_array,out;
			out = constraint['output']();
			constraint['mark_unsatisfied']();
			constraint['remove_from_graph']();
			unsatisfied = self['remove_propagate_from'](out);
			strength = $p['getattr']($m['Strength'], 'REQUIRED');
			repeat = true;
			while ($p['bool'](repeat)) {
				$iter1_iter = unsatisfied;
				$iter1_nextval=$p['__iter_prepare']($iter1_iter,false);
				while (typeof($p['__wrapped_next']($iter1_nextval)['$nextval']) != 'undefined') {
					u = $iter1_nextval['$nextval'];
					if ($p['bool']($p['op_eq']($p['getattr'](u, 'strength'), strength))) {
						self['incremental_add'](u);
					}
					strength = strength['next_weaker']();
				}
				repeat = !$p['op_eq'](strength, $p['getattr']($m['Strength'], 'WEAKEST'));
			}
			return null;
		}
	, 1, [null,null,['self'],['constraint']]);
		$cls_definition['incremental_remove'] = $method;
		$method = $pyjs__bind_method2('new_mark', function() {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			var $add3,$add4;
			self['current_mark'] = $p['__op_add']($add3=$p['getattr'](self, 'current_mark'),$add4=1);
			return $p['getattr'](self, 'current_mark');
		}
	, 1, [null,null,['self']]);
		$cls_definition['new_mark'] = $method;
		$method = $pyjs__bind_method2('make_plan', function(sources) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			var c,mark,$and10,$and11,plan,todo;
			mark = self['new_mark']();
			plan = (typeof Plan == "undefined"?$m['Plan']:Plan)();
			todo = sources;
			while ($p['bool']($p['len'](todo))) {
				c = todo['pop'](0);
				if ($p['bool'](($p['bool']($and10=!$p['op_eq']($p['getattr'](c['output'](), 'mark'), mark))?c['inputs_known'](mark):$and10))) {
	...
	, 1, [null,null,['self'],['sources']]);
		$cls_definition['make_plan'] = $method;
		$method = $pyjs__bind_method2('extract_plan_from_constraints', function(constraints) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			var c,$iter2_nextval,$iter2_type,$iter2_iter,$and13,$and12,sources,$iter2_idx,$iter2_array;
			sources = $m['OrderedCollection']();
			$iter2_iter = constraints;
			$iter2_nextval=$p['__iter_prepare']($iter2_iter,false);
			while (typeof($p['__wrapped_next']($iter2_nextval)['$nextval']) != 'undefined') {
				c = $iter2_nextval['$nextval'];
				if ($p['bool'](($p['bool']($and12=c['is_input']())?c['is_satisfied']():$and12))) {
					sources['append'](c);
				}
			}
			return self['make_plan'](sources);
		}
	, 1, [null,null,['self'],['constraints']]);
		$cls_definition['extract_plan_from_constraints'] = $method;
		$method = $pyjs__bind_method2('add_propagate', function(c, mark) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			var d,todo;
			todo = $m['OrderedCollection']();
			todo['append'](c);
			while ($p['bool']($p['len'](todo))) {
				d = todo['pop'](0);
				if ($p['bool']($p['op_eq']($p['getattr'](d['output'](), 'mark'), mark))) {
	...
	, 1, [null,null,['self'],['c'],['mark']]);
		$cls_definition['add_propagate'] = $method;
		$method = $pyjs__bind_method2('remove_propagate_from', function(out) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			var unsatisfied,c,$iter3_idx,$and14,$iter4_type,$iter3_array,determining,$iter3_type,$and15,$iter4_idx,$iter3_iter,$iter4_iter,v,$iter4_array,$iter4_nextval,todo,$iter3_nextval;
			out['determined_by'] = null;
			out['walk_strength'] = $p['getattr']($m['Strength'], 'WEAKEST');
			out['stay'] = true;
			unsatisfied = $m['OrderedCollection']();
			todo = $m['OrderedCollection']();
			todo['append'](out);
			while ($p['bool']($p['len'](todo))) {
				v = todo['pop'](0);
				$iter3_iter = $p['getattr'](v, 'constraints');
				$iter3_nextval=$p['__iter_prepare']($iter3_iter,false);
				while (typeof($p['__wrapped_next']($iter3_nextval)['$nextval']) != 'undefined') {
					c = $iter3_nextval['$nextval'];
					if ($p['bool'](!$p['bool'](c['is_satisfied']()))) {
						unsatisfied['append'](c);
					}
				}
				determining = $p['getattr'](v, 'determined_by');
				$iter4_iter = $p['getattr'](v, 'constraints');
				$iter4_nextval=$p['__iter_prepare']($iter4_iter,false);
				while (typeof($p['__wrapped_next']($iter4_nextval)['$nextval']) != 'undefined') {
					c = $iter4_nextval['$nextval'];
					if ($p['bool'](($p['bool']($and14=!$p['op_eq'](c, determining))?c['is_satisfied']():$and14))) {
						c['recalculate']();
	...
	, 1, [null,null,['self'],['out']]);
		$cls_definition['remove_propagate_from'] = $method;
		$method = $pyjs__bind_method2('add_constraints_consuming_to', function(v, coll) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			var $iter5_nextval,c,$iter5_idx,cc,determining,$iter5_array,$iter5_iter,$and16,$and17,$iter5_type;
			determining = $p['getattr'](v, 'determined_by');
			cc = $p['getattr'](v, 'constraints');
			$iter5_iter = cc;
			$iter5_nextval=$p['__iter_prepare']($iter5_iter,false);
			while (typeof($p['__wrapped_next']($iter5_nextval)['$nextval']) != 'undefined') {
				c = $iter5_nextval['$nextval'];
				if ($p['bool'](($p['bool']($and16=!$p['op_eq'](c, determining))?c['is_satisfied']():$and16))) {
					coll['append'](c);
				}
			}
			return null;
		}
	, 1, [null,null,['self'],['v'],['coll']]);
		$cls_definition['add_constraints_consuming_to'] = $method;
		var $bases = new Array($p['object']);
		var $data = $p['dict']();
		for (var $item in $cls_definition) { $data['__setitem__']($item, $cls_definition[$item]); }
		return $p['_create_class']('Planner', $p['tuple']($bases), $data);
	})();
	$m['Plan'] = (function(){
		var $cls_definition = new Object();
		var $method;
		...
		$method = $pyjs__bind_method2('__init__', function() {
			...
			$p['$$super']($m['Plan'], self)['__init__']();
			self['v'] = $m['OrderedCollection']();
			return null;
		}
	, 1, [null,null,['self']]);
		$cls_definition['__init__'] = $method;
		$method = $pyjs__bind_method2('add_constraint', function(c) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('__getitem__', function(index) {
			...
			return $p['getattr'](self, 'v')['__getitem__'](index);
		}
	, 1, [null,null,['self'],['index']]);
		$cls_definition['__getitem__'] = $method;
		$method = $pyjs__bind_method2('execute', function() {
			...
			var c,$iter6_idx,$iter6_type,$iter6_array,$iter6_iter,$iter6_nextval;
			$iter6_iter = $p['getattr'](self, 'v');
			$iter6_nextval=$p['__iter_prepare']($iter6_iter,false);
			while (typeof($p['__wrapped_next']($iter6_nextval)['$nextval']) != 'undefined') {
	...
	, 1, [null,null,['self']]);
		...
		var $data = $p['dict']();
		for (var $item in $cls_definition) { $data['__setitem__']($item, $cls_definition[$item]); }
		return $p['_create_class']('Plan', $p['tuple']($bases), $data);
	})();
	$m['chain_test'] = function(n) {
		var $iter8_iter,edits,prev,$iter7_type,$iter8_idx,$iter7_iter,$iter8_type,$add5,$iter8_nextval,$iter7_idx,last,name,$iter7_nextval,i,$iter7_array,$iter8_array,edit,$add6,v,first,plan;
		$m['planner'] = $m['Planner']();
		var $tupleassign1 = $p['__ass_unpack']($p['tuple']([null, null, null]), 3, null);
		prev = $tupleassign1[0];
		first = $tupleassign1[1];
		last = $tupleassign1[2];
		$iter7_iter = $p['range']($p['__op_add']($add5=n,$add6=1));
		$iter7_nextval=$p['__iter_prepare']($iter7_iter,false);
		while (typeof($p['__wrapped_next']($iter7_nextval)['$nextval']) != 'undefined') {
			i = $iter7_nextval['$nextval'];
			name = $p['sprintf']('v%s', i);
			v = $m['Variable'](name);
			if ($p['bool']((prev !== null))) {
				$m['EqualityConstraint'](prev, v, $p['getattr']($m['Strength'], 'REQUIRED'));
			}
			if ($p['bool']($p['op_eq'](i, 0))) {
				first = v;
			}
			if ($p['bool']($p['op_eq'](i, n))) {
				last = v;
			}
			prev = v;
		}
		$m['StayConstraint'](last, $p['getattr']($m['Strength'], 'STRONG_DEFAULT'));
		edit = $m['EditConstraint'](first, $p['getattr']($m['Strength'], 'PREFERRED'));
		edits = $m['OrderedCollection']();
		edits['append'](edit);
		plan = $m['planner']['extract_plan_from_constraints'](edits);
		...
		while (typeof($p['__wrapped_next']($iter8_nextval)['$nextval']) != 'undefined') {
			...
			first['value'] = i;
			plan['execute']();
			if ($p['bool'](!$p['op_eq']($p['getattr'](last, 'value'), i))) {
				$p['printFunc'](['Chain test failed.'], 1);
			}
		}
		return null;
	};
	$m['chain_test']['__name__'] = 'chain_test';

	$m['chain_test']['__bind_type__'] = 0;
	$m['chain_test']['__args__'] = [null,null,['n']];
	$m['projection_test'] = function(n) {
		var $iter10_nextval,$iter11_array,dests,$iter10_iter,$iter9_array,$mul5,scale,$sub6,$iter9_iter,dst,$iter9_nextval,$iter9_idx,$sub3,$iter11_idx,$iter9_type,$sub5,$sub4,$iter11_iter,$add10,offset,$mul6,$iter11_nextval,$mul4,$mul3,src,i,$iter11_type,$iter10_array,$add7,$iter10_type,$add8,$add9,$iter10_idx;
		$m['planner'] = $m['Planner']();
		scale = $m['Variable']('scale', 10);
		offset = $m['Variable']('offset', 1000);
		src = null;
		dests = $m['OrderedCollection']();
		$iter9_iter = $p['range'](n);
		$iter9_nextval=$p['__iter_prepare']($iter9_iter,false);
		while (typeof($p['__wrapped_next']($iter9_nextval)['$nextval']) != 'undefined') {
			i = $iter9_nextval['$nextval'];
			src = $m['Variable']($p['sprintf']('src%s', i), i);
			dst = $m['Variable']($p['sprintf']('dst%s', i), i);
			dests['append'](dst);
			$m['StayConstraint'](src, $p['getattr']($m['Strength'], 'NORMAL'));
			$m['ScaleConstraint'](src, scale, offset, dst, $p['getattr']($m['Strength'], 'REQUIRED'));
		}
		(typeof change == "undefined"?$m['change']:change)(src, 17);
		if ($p['bool'](!$p['op_eq']($p['getattr'](dst, 'value'), 1170))) {
			$p['printFunc'](['Projection 1 failed'], 1);
		}
		(typeof change == "undefined"?$m['change']:change)(dst, 1050);
		if ($p['bool'](!$p['op_eq']($p['getattr'](src, 'value'), 5))) {
			$p['printFunc'](['Projection 2 failed'], 1);
		}
		(typeof change == "undefined"?$m['change']:change)(scale, 5);
		$iter10_iter = $p['range']($p['__op_sub']($sub3=n,$sub4=1));
		$iter10_nextval=$p['__iter_prepare']($iter10_iter,false);
		while (typeof($p['__wrapped_next']($iter10_nextval)['$nextval']) != 'undefined') {
			i = $iter10_nextval['$nextval'];
			if ($p['bool'](!$p['op_eq']($p['getattr'](dests['__getitem__'](i), 'value'), $p['__op_add']($add7=(typeof ($mul3=i)==typeof ($mul4=5) && typeof $mul3=='number'?
				$mul3*$mul4:
				$p['op_mul']($mul3,$mul4)),$add8=1000)))) {
				$p['printFunc'](['Projection 3 failed'], 1);
			}
		}
		(typeof change == "undefined"?$m['change']:change)(offset, 2000);
		$iter11_iter = $p['range']($p['__op_sub']($sub5=n,$sub6=1));
		$iter11_nextval=$p['__iter_prepare']($iter11_iter,false);
		while (typeof($p['__wrapped_next']($iter11_nextval)['$nextval']) != 'undefined') {
			i = $iter11_nextval['$nextval'];
			if ($p['bool'](!$p['op_eq']($p['getattr'](dests['__getitem__'](i), 'value'), $p['__op_add']($add9=(typeof ($mul5=i)==typeof ($mul6=5) && typeof $mul5=='number'?
				$mul5*$mul6:
				$p['op_mul']($mul5,$mul6)),$add10=2000)))) {
				$p['printFunc'](['Projection 4 failed'], 1);
			}
		}
		return null;
	};
	$m['projection_test']['__name__'] = 'projection_test';

	$m['projection_test']['__bind_type__'] = 0;
	$m['projection_test']['__args__'] = [null,null,['n']];
	$m['change'] = function(v, new_value) {
		var edit,$iter12_type,$iter12_array,$iter12_iter,i,edits,plan,$iter12_idx,$iter12_nextval;
		edit = $m['EditConstraint'](v, $p['getattr']($m['Strength'], 'PREFERRED'));
		edits = $m['OrderedCollection']();
		edits['append'](edit);
		plan = $m['planner']['extract_plan_from_constraints'](edits);
		$iter12_iter = $p['range'](10);
		$iter12_nextval=$p['__iter_prepare']($iter12_iter,false);
		while (typeof($p['__wrapped_next']($iter12_nextval)['$nextval']) != 'undefined') {
	...
	$m['change']['__name__'] = 'change';

	$m['change']['__bind_type__'] = 0;
	$m['change']['__args__'] = [null,null,['v'],['new_value']];
	$m['planner'] = null;
	$m['delta_blue'] = function(n) {

		$m['chain_test'](n);
		$m['projection_test'](n);
		return null;
	};
	$m['delta_blue']['__name__'] = 'delta_blue';

	$m['delta_blue']['__bind_type__'] = 0;
	$m['delta_blue']['__args__'] = [null,null,['n']];
	$m['delta_blue'](5000);
	return this;
}; /* end main */
