"use strict";
// Transcrypt'ed from Python, 2017-07-27 19:23:59
    ...
    */
	...
	(function () {
		...
		var combinations = function (l) {
			var result = list ([]);
			for (var x = 0; x < __sub__ (__call__ (len, null, l), 1); x++) {
				var ls = __getslice__ (l, __add__ (x, 1), null, 1);
				var __iterable0__ = ls;
				for (var __index0__ = 0; __index0__ < __iterable0__.length; __index0__++) {
					var y = __getitem__ (__iterable0__, __index0__);
					__call__ (result.append, result, tuple ([__getitem__ (l, x), y]));
				}
			}
			return result;
		};
		var PI = 3.141592653589793;
		var SOLAR_MASS = __mul__ (__mul__ (4, PI), PI);
		var DAYS_PER_YEAR = 365.24;
		var BODIES = dict ({'sun': tuple ([list ([0.0, 0.0, 0.0]), list ([0.0, 0.0, 0.0]), SOLAR_MASS]), 'jupiter': tuple ([list ([4.841431442464721, __neg__ (1.1603200440274284), __neg__ (0.10362204447112311)]), list ([__mul__ (0.001660076642744037, DAYS_PER_YEAR), __mul__ (0.007699011184197404, DAYS_PER_YEAR), __mul__ (__neg__ (6.90460016972063e-05), DAYS_PER_YEAR)]), __mul__ (0.0009547919384243266, SOLAR_MASS)]), 'saturn': tuple ([list ([8.34336671824458, 4.124798564124305, __neg__ (0.4035234171143214)]), list ([__mul__ (__neg__ (0.002767425107268624), DAYS_PER_YEAR), __mul__ (0.004998528012349172, DAYS_PER_YEAR), __mul__ (2.3041729757376393e-05, DAYS_PER_YEAR)]), __mul__ (0.0002858859806661308, SOLAR_MASS)]), 'uranus': tuple ([list ([12.894369562139131, __neg__ (15.111151401698631), __neg__ (0.22330757889265573)]), list ([__mul__ (0.002964601375647616, DAYS_PER_YEAR), __mul__ (0.0023784717395948095, DAYS_PER_YEAR), __mul__ (__neg__ (2.9658956854023756e-05), DAYS_PER_YEAR)]), __mul__ (4.366244043351563e-05, SOLAR_MASS)]), 'neptune': tuple ([list ([15.379697114850917, __neg__ (25.919314609987964), 0.17925877295037118]), list ([__mul__ (0.0026806777249038932, DAYS_PER_YEAR), __mul__ (0.001628241700382423, DAYS_PER_YEAR), __mul__ (__neg__ (9.515922545197159e-05), DAYS_PER_YEAR)]), __mul__ (5.1513890204661145e-05, SOLAR_MASS)])});
		var SYSTEM = __call__ (list, null, __call__ (BODIES.py_values, BODIES));
		var PAIRS = __call__ (combinations, null, SYSTEM);
		var advance = function (dt, n, bodies, pairs) {
			...
			for (var i = 0; i < n; i++) {
				...
				for (var __index0__ = 0; __index0__ < __iterable0__.length; __index0__++) {
					...
					var dx = __sub__ (x1, x2);
					var dy = __sub__ (y1, y2);
					var dz = __sub__ (z1, z2);
					var mag = __mul__ (dt, __pow__ (__add__ (__add__ (__mul__ (dx, dx), __mul__ (dy, dy)), __mul__ (dz, dz)), __neg__ (1.5)));
					var b1m = __mul__ (m1, mag);
					var b2m = __mul__ (m2, mag);
					__setitem__ (v1, 0, __call__ (__isub__, null, __getitem__ (v1, 0), __mul__ (dx, b2m)));
					__setitem__ (v1, 1, __call__ (__isub__, null, __getitem__ (v1, 1), __mul__ (dy, b2m)));
					__setitem__ (v1, 2, __call__ (__isub__, null, __getitem__ (v1, 2), __mul__ (dz, b2m)));
					__setitem__ (v2, 0, __call__ (__iadd__, null, __getitem__ (v2, 0), __mul__ (dx, b1m)));
					__setitem__ (v2, 1, __call__ (__iadd__, null, __getitem__ (v2, 1), __mul__ (dy, b1m)));
					__setitem__ (v2, 2, __call__ (__iadd__, null, __getitem__ (v2, 2), __mul__ (dz, b1m)));
				}
				...
				for (var __index0__ = 0; __index0__ < __iterable0__.length; __index0__++) {
					...
					var m = __left0__ [2];
					__setitem__ (r, 0, __call__ (__iadd__, null, __getitem__ (r, 0), __mul__ (dt, vx)));
					__setitem__ (r, 1, __call__ (__iadd__, null, __getitem__ (r, 1), __mul__ (dt, vy)));
					__setitem__ (r, 2, __call__ (__iadd__, null, __getitem__ (r, 2), __mul__ (dt, vz)));
				}
			}
		};
		var report_energy = function (bodies, pairs, e) {
			...
			for (var __index0__ = 0; __index0__ < __iterable0__.length; __index0__++) {
				...
				var dy = __sub__ (y1, y2);
				var dz = __sub__ (z1, z2);
				var e = __call__ (__isub__, null, e, __div__ (__mul__ (m1, m2), __pow__ (__add__ (__add__ (__mul__ (dx, dx), __mul__ (dy, dy)), __mul__ (dz, dz)), 0.5)));
			}
			var __iterable0__ = bodies;
			for (var __index0__ = 0; __index0__ < __iterable0__.length; __index0__++) {
				var __left0__ = __getitem__ (__iterable0__, __index0__);
				...
				var vz = __left0__ [1][2];
				var m = __left0__ [2];
				var e = __call__ (__iadd__, null, e, __div__ (__mul__ (m, __add__ (__add__ (__mul__ (vx, vx), __mul__ (vy, vy)), __mul__ (vz, vz))), 2.0));
			}
		};
		var offset_momentum = function (ref, bodies, px, py, pz) {
			...
			for (var __index0__ = 0; __index0__ < __iterable0__.length; __index0__++) {
				...
				var vz = __left0__ [1][2];
				var m = __left0__ [2];
				var px = __call__ (__isub__, null, px, __mul__ (vx, m));
				var py = __call__ (__isub__, null, py, __mul__ (vy, m));
				var pz = __call__ (__isub__, null, pz, __mul__ (vz, m));
			}
			var __left0__ = ref;
			var r = __left0__ [0];
			var v = __left0__ [1];
			var m = __left0__ [2];
			__setitem__ (v, 0, __div__ (px, m));
			__setitem__ (v, 1, __div__ (py, m));
			__setitem__ (v, 2, __div__ (pz, m));
		};
		...
		var main = function (n, ref) {
			...
			for (var i = 0; i < n; i++) {
				...
				__call__ (offset_momentum, null, __getitem__ (BODIES, ref));
				__call__ (report_energy, null);
				__call__ (advance, null, 0.01, NUMBER_OF_ITERATIONS);
				__call__ (report_energy, null);
