...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    Primitives_dateNow: [function() {
      return Date.now();
    }, "call$0", "_js_helper_Primitives_dateNow$closure", 0, 0, 9],
  ...
  }], ["benchmark_base", "../benchmark-files/BenchmarkBase.dart",, V, {
    "^": "",
  ...
  }], ["", "../benchmark-files/nbody.dart",, K, {
    "^": "",
    main: [function(args) {
      P.print("NBody(RunTime): " + H.S(new K.Nbody("NBody").measure$0()) + " us.");
    }, "call$1", "nbody__main$closure", 2, 0, 10],
    Nbody: {
      "^": "BenchmarkBase;name",
      run$0: function() {
        var system, i;
        system = K.NBodySystem$();
        for (i = 0; i < 5000000; ++i)
          system.advance$1(0.01);
      }
    },
    Body: {
      "^": "Object;_data",
      ...
      Body$7$mass$vx$vy$vz$x$y$z: function(mass, vx, vy, vz, x, y, z) {
        var t1 = this._data;
        t1[0] = x;
        t1[1] = y;
        t1[2] = z;
      ...
      static: {
        Body$: function(mass, vx, vy, vz, x, y, z) {
          var t1 = new K.Body(new Float64Array(H._checkLength(7)));
          t1.Body$7$mass$vx$vy$vz$x$y$z(mass, vx, vy, vz, x, y, z);
          return t1;
        }
      }
    },
    NBodySystem: {
      "^": "Object;bodies",
      advance$1: function(dt) {
        var na, t1, t2, a, nb, nb0, b, dx, t3, dy, dz, d2, mag, _i;
        for (na = 0; t1 = this.bodies, t2 = t1.length, na < t2; na = nb) {
          a = t1[na];
          for (nb = na + 1, nb0 = nb; t1 = this.bodies, nb0 < t1.length; ++nb0) {
            b = t1[nb0];
            dx = a.get$x() - b.get$x();
            t1 = a._data;
            t2 = t1[1];
            ...
            t1[3] = t1[3] - dx * t3[6] * mag;
            t3[3] = t3[3] + dx * t1[6] * mag;
            t1[4] = t1[4] - dy * t3[6] * mag;
            t3[4] = t3[4] + dy * t1[6] * mag;
            t1[5] = t1[5] - dz * t3[6] * mag;
            t3[5] = t3[5] + dz * t1[6] * mag;
          }
        }
        for (_i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i) {
          b = t1[_i];
          b.set$x(b.get$x() + dt * b.get$vx());
          t3 = b._data;
          t3[1] = t3[1] + dt * t3[4];
          t3[2] = t3[2] + dt * t3[5];
        }
      },
      NBodySystem$0: function() {
        var t1, t2, px, py, pz, _i, b, t3, t4, t5, sol;
        t1 = H.setRuntimeTypeInfo([], [K.Body]);
        this.bodies = t1;
        C.JSArray_methods.addAll$1(t1, [K.Body$(39.47841760435743, 0, 0, 0, 0, 0, 0), K.Body$(0.03769367487038949, 0.606326392995832, 2.81198684491626, -0.02521836165988763, 4.841431442464721, -1.1603200440274284, -0.10362204447112311), K.Body$(0.011286326131968767, -1.0107743461787924, 1.8256623712304119, 0.008415761376584154, 8.34336671824458, 4.124798564124305, -0.4035234171143214), K.Body$(0.0017237240570597112, 1.0827910064415354, 0.8687130181696082, -0.010832637401363636, 12.894369562139131, -15.111151401698631, -0.22330757889265573), K.Body$(0.0020336868699246304, 0.979090732243898, 0.5946989986476762, -0.034755955504078104, 15.379697114850917, -25.919314609987964, 0.17925877295037118)]);
        for (t1 = this.bodies, t2 = t1.length, px = 0, py = 0, pz = 0, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i) {
          b = t1[_i];
          t3 = b.get$vx();
          t4 = b._data;
          t5 = t4[6];
        ...
        if (0 >= t1.length)
          return H.ioore(t1, 0);
        sol = t1[0];
        sol.set$vx(-px / 39.47841760435743);
        t1 = sol._data;
        t1[4] = -py / 39.47841760435743;
        t1[5] = -pz / 39.47841760435743;
      },
      static: {
        NBodySystem$: function() {
          var t1 = new K.NBodySystem(null);
          t1.NBodySystem$0();
          return t1;
        }
      }
...
;
  ...
  $ = new Isolate();
  init.metadata = [];
  init.types = [{func: 1}, {func: 1, v: true}, {func: 1, args: [,]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, ret: P.String, args: [P.int]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, args: [,,]}, {func: 1, ret: P.num}, {func: 1, v: true, args: [,]}];
  ...
  (function(callback) {
    ...
    if (typeof dartMainRunner === "function")
      dartMainRunner(function(a) {
        H.startRootIsolate(K.nbody__main$closure(), a);
      }, []);
    else
      (function(a) {
        H.startRootIsolate(K.nbody__main$closure(), a);
