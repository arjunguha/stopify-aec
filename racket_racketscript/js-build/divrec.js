...
"use strict";
function _interopRequireWildcard(r){if(r&&r.__esModule)return r;var e={};if(null!=r)for(var a in r)Object.prototype.hasOwnProperty.call(r,a)&&(e[a]=r[a]);return e.default=r,e}Object.defineProperty(exports,"__esModule",{value:!0}),exports.map=exports.for_each=exports.andmap=exports.ormap=exports.__rjs_quoted__=void 0;var _core=__webpack_require__(8),$rjs_core=_interopRequireWildcard(_core),_kernelRkt=__webpack_require__(25),M0=_interopRequireWildcard(_kernelRkt),cl290=function(r,e){if(M0.procedure_p(r)){if(M0.procedure_arity_includes_p(r,1))a=M0.list_p(e);else var a=!1;l=a}else var l=!1;if(l)c=function e(a){if(M0.null_p(a))c=M0.rnull;else var l=M0.cdr(a),c=M0.cons(r(M0.car(a)),e(l));return c}(e);else var c=M0.map(r,e);return c},cl291=function(r,e,a){if(M0.procedure_p(r)){if(M0.procedure_arity_includes_p(r,2)){if(M0.list_p(e)){if(M0.list_p(a))l=M0._eq_(M0.length(e),M0.length(a));else var l=!1;c=l}else var c=!1;t=c}else var t=!1;i=t}else var i=!1;if(i)n=function e(a,l){if(M0.null_p(a))i=M0.rnull;else var c=M0.cdr(a),t=M0.cdr(l),i=M0.cons(r(M0.car(a),M0.car(l)),e(c,t));return i}(e,a);else var n=M0.map(r,e,a);return n},cl292=$rjs_core.attachProcedureArity(function(r,e){var a=$rjs_core.Pair.listFromArray($rjs_core.argumentsSlice($rjs_core.argumentsToArray(arguments),2));return M0.apply(M0.map,r,e,a)}),map625=$rjs_core.attachProcedureArity(function(){var r={2:cl290,3:cl291}[arguments.length];if(void 0!==r)return r.apply(null,arguments);if(M0._gt__eq_(cl292.length,1))e=cl292.apply(null,arguments);else var e=M0.error("case-lambda: invalid case");return e},[M0.make_arity_at_least(2)]),map2=map625,cl305=function(r,e){if(M0.procedure_p(r)){if(M0.procedure_arity_includes_p(r,1))a=M0.list_p(e);else var a=!1;l=a}else var l=!1;if(l)c=function e(a){if(M0.null_p(a))c=M0.rvoid();else{var l=M0.cdr(a);r(M0.car(a));var c=e(l)}return c}(e);else var c=M0.for_each(r,e);return c},cl306=function(r,e,a){if(M0.procedure_p(r)){if(M0.procedure_arity_includes_p(r,2)){if(M0.list_p(e)){if(M0.list_p(a))l=M0._eq_(M0.length(e),M0.length(a));else var l=!1;c=l}else var c=!1;t=c}else var t=!1;i=t}else var i=!1;if(i)n=function e(a,l){if(M0.null_p(a))i=M0.rvoid();else{var c=M0.cdr(a),t=M0.cdr(l);r(M0.car(a),M0.car(l));var i=e(c,t)}return i}(e,a);else var n=M0.for_each(r,e,a);return n},cl307=$rjs_core.attachProcedureArity(function(r,e){var a=$rjs_core.Pair.listFromArray($rjs_core.argumentsSlice($rjs_core.argumentsToArray(arguments),2));return M0.apply(M0.for_each,r,e,a)}),for_each642=$rjs_core.attachProcedureArity(function(){var r={2:cl305,3:cl306}[arguments.length];if(void 0!==r)return r.apply(null,arguments);if(M0._gt__eq_(cl307.length,1))e=cl307.apply(null,arguments);else var e=M0.error("case-lambda: invalid case");return e},[M0.make_arity_at_least(2)]),for_each2=for_each642,cl320=function(r,e){if(M0.procedure_p(r)){if(M0.procedure_arity_includes_p(r,1))a=M0.list_p(e);else var a=!1;l=a}else var l=!1;if(l){if(M0.null_p(e))c=!0;else var c=function e(a){if(M0.null_p(M0.cdr(a)))t=r(M0.car(a));else{var l=M0.cdr(a);if(r(M0.car(a)))c=e(l);else var c=!1;var t=c}return t}(e);t=c}else var t=M0.andmap(r,e);return t},cl321=function(r,e,a){if(M0.procedure_p(r)){if(M0.procedure_arity_includes_p(r,2)){if(M0.list_p(e)){if(M0.list_p(a))l=M0._eq_(M0.length(e),M0.length(a));else var l=!1;c=l}else var c=!1;t=c}else var t=!1;i=t}else var i=!1;if(i){if(M0.null_p(e))n=!0;else var n=function e(a,l){if(M0.null_p(M0.cdr(a)))n=r(M0.car(a),M0.car(l));else{var c=M0.cdr(a),t=M0.cdr(l);if(r(M0.car(a),M0.car(l)))i=e(c,t);else var i=!1;var n=i}return n}(e,a);_=n}else var _=M0.andmap(r,e,a);return _},cl322=$rjs_core.attachProcedureArity(function(r,e){var a=$rjs_core.Pair.listFromArray($rjs_core.argumentsSlice($rjs_core.argumentsToArray(arguments),2));return M0.apply(M0.andmap,r,e,a)}),andmap659=$rjs_core.attachProcedureArity(function(){var r={2:cl320,3:cl321}[arguments.length];if(void 0!==r)return r.apply(null,arguments);if(M0._gt__eq_(cl322.length,1))e=cl322.apply(null,arguments);else var e=M0.error("case-lambda: invalid case");return e},[M0.make_arity_at_least(2)]),andmap2=andmap659,cl339=function(r,e){if(M0.procedure_p(r)){if(M0.procedure_arity_includes_p(r,1))a=M0.list_p(e);else var a=!1;l=a}else var l=!1;if(l){if(M0.null_p(e))c=!1;else var c=function e(a){if(M0.null_p(M0.cdr(a)))i=r(M0.car(a));else{var l=M0.cdr(a),c=r(M0.car(a));if(c)t=c;else var t=e(l);var i=t}return i}(e);t=c}else var t=M0.ormap(r,e);return t},cl340=function(r,e,a){if(M0.procedure_p(r)){if(M0.procedure_arity_includes_p(r,2)){if(M0.list_p(e)){if(M0.list_p(a))l=M0._eq_(M0.length(e),M0.length(a));else var l=!1;c=l}else var c=!1;t=c}else var t=!1;i=t}else var i=!1;if(i){if(M0.null_p(e))n=!1;else var n=function e(a,l){if(M0.null_p(M0.cdr(a)))_=r(M0.car(a),M0.car(l));else{var c=M0.cdr(a),t=M0.cdr(l),i=r(M0.car(a),M0.car(l));if(i)n=i;else var n=e(c,t);var _=n}return _}(e,a);_=n}else var _=M0.ormap(r,e,a);return _},cl341=$rjs_core.attachProcedureArity(function(r,e){var a=$rjs_core.Pair.listFromArray($rjs_core.argumentsSlice($rjs_core.argumentsToArray(arguments),2));return M0.apply(M0.ormap,r,e,a)}),ormap676=$rjs_core.attachProcedureArity(function(){var r={2:cl339,3:cl340}[arguments.length];if(void 0!==r)return r.apply(null,arguments);if(M0._gt__eq_(cl341.length,1))e=cl341.apply(null,arguments);else var e=M0.error("case-lambda: invalid case");return e},[M0.make_arity_at_least(2)]),ormap2=ormap676,__rjs_quoted__={};exports.__rjs_quoted__=__rjs_quoted__,exports.ormap=ormap2,exports.andmap=andmap2,exports.for_each=for_each2,exports.map=map2;
...
"use strict";
function _interopRequireWildcard(r){if(r&&r.__esModule)return r;var e={};if(null!=r)for(var t in r)Object.prototype.hasOwnProperty.call(r,t)&&(e[t]=r[t]);return e.default=r,e}Object.defineProperty(exports,"__esModule",{value:!0}),exports.__rjs_quoted__=void 0;var _core=__webpack_require__(8),$rjs_core=_interopRequireWildcard(_core),_mlistRkt=__webpack_require__(66),M0=_interopRequireWildcard(_mlistRkt),_kernelRkt=__webpack_require__(25),M1=_interopRequireWildcard(_kernelRkt),_mainRkt=__webpack_require__(87),M2=_interopRequireWildcard(_mainRkt),divrec_iters=10,time=function(r){M1.values();return r},run_bench=function(r,e,t,i){M1.values();return function r(t,_){M1.values();if(M1._lt_(t,e))s=r(t+1,i());else var s=_;return s}(0,M1.mcons($rjs_core.Symbol.make("undefined"),M1.rnull))},run_benchmark=$rjs_core.attachProcedureArity(function(r,e,t,i){var _=$rjs_core.Pair.listFromArray($rjs_core.argumentsSlice($rjs_core.argumentsToArray(arguments),4)),s=M0.list__gt_mlist(_);M1.values();M1.newline();var a=M2.apply(i,s),o=time(run_bench(r,e,t,a));M1.values();if(M1.not(t(o))){M2.display("*** wrong result ***"),M1.newline(),M2.display("*** got: "),M2.write(o);c=M1.newline()}else{M2.display("OK");var c=M1.newline()}return c}),create_n=function(r){M1.values();return function r(e,t){if(M1._eq_(e,0))M1.rvoid(),i=t;else var i=r(e-1,M1.mcons($rjs_core.Pair.Empty,t));return i}(r,$rjs_core.Pair.Empty)},_times_ll_times_=create_n(200),recursive_div2=function r(e){M1.values();if(M1.null_p(e))t=$rjs_core.Pair.Empty;else var t=M1.mcons(M1.mcar(e),r(M1.mcdr(M1.mcdr(e))));return t},lifted_dot_0=M2.__rjs_quoted__.to_mutable($rjs_core.Pair.makeList($rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty,$rjs_core.Pair.Empty)),main=$rjs_core.attachProcedureArity(function(){var r=$rjs_core.Pair.listFromArray($rjs_core.argumentsToArray(arguments));M0.list__gt_mlist(r),M1.values();return run_benchmark("divrec",divrec_iters,function(r){M1.values();return M1.equal_p(r,lifted_dot_0)},function(r){M1.values();return function(){M1.values();return recursive_div2(r)}},_times_ll_times_)});main();var __rjs_quoted__={};exports.__rjs_quoted__=__rjs_quoted__;
