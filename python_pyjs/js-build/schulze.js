...
$pyjs['loaded_modules']['main'] = function (__mod_name__) {
	...
	$m['results'] = function(){
		var $iter21_idx,$collcomp5,$iter21_nextval,$iter21_type,$iter21_iter,$iter21_array;
	$collcomp5 = $p['list']();
	$iter21_iter = $m['order'];
	$iter21_nextval=$p['__iter_prepare']($iter21_iter,false);
	while (typeof($p['__wrapped_next']($iter21_nextval)['$nextval']) != 'undefined') {
		$m['i'] = $iter21_nextval['$nextval'];
		$collcomp5['append']($p['float_int']($m['reverseCandidates']['__getitem__']($m['i'])));
	}

	return $collcomp5;}();
	$p['printFunc']([$p['sum']($m['results'])], 1);
	if (!( $p['op_eq']($p['sum']($m['results']), 2282760) )) {
