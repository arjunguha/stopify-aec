...
four1 = function(data) {
    ...
    while (mmax < n) {
      ...
      while (m < mmax) {
        ...
        while (i < n) {
          j = i + mmax;
          tempr = wr_1 * data[j] - wi * data[j + 1];
          tempi = wr_1 * data[j + 1] + wi * data[j];
          data[j] = data[i] - tempr;
        ...
        wr = wr_1 * wpr - wi * wpi + wr_1;
        wi = wi * wpr + wr_1 * wpi + wi;
        wr_1 = wr;
        m += 2;
      }
      mmax *= 2;
...
main = function() {
    ...
    return BgL_runzd2benchmarkzd2("fft", 10000, function(result) {
              return sc_isEqual(result, 0.0);
            }, function(data) {
              return function() {
                      return run(data);
                    };
