...
var time;
const_main = sc_list("\uEBACa", "\uEBACa", "\uEBACa", "\uEBACa", "\uEBACa", "\uEBACa", "\uEBACa", "\uEBACa", "\uEBACa");
BgL_sc_const_1z00_main = "*** wrong result ***";
BgL_sc_const_2z00_main = new sc_Pair(new sc_Pair("\uEBACs", new sc_Pair(new sc_Pair("\uEBACa", null), new sc_Pair(new sc_Pair("\uEBACs", new sc_Pair("\uEBACs", null)), null))), null);
time = function(x) {
    return x;
  };
...
BgL_makezd2parserzd2 = function(grammar, lexer) {
    ...
    def_loop_3 = function(defs, nts) {
        ...
        if (defs instanceof sc_Pair) {
          ...
          head = def.car;
          g1265 = def.cdr;
          if (sc_member(head, nts) !== false) {
            g1266 = nts;
          } else {
            g1266 = new sc_Pair(head, nts);
          }
          rules = g1265;
          nts_5 = g1266;
          while (rules instanceof sc_Pair) {
            rule = rules.car;
            l = rule;
            nts_4 = nts_5;
            while (l instanceof sc_Pair) {
              nt = l.car;
              l = l.cdr;
              if (sc_member(nt, nts_4) !== false) {
                undefined;
              } else {
                nts_4 = new sc_Pair(nt, nts_4);
              }
            }
            rules = rules.cdr;
            nts_5 = nts_4;
          }
          return def_loop_3(defs.cdr, nts_5);
        } else {
          return sc_list2vector(sc_reverse(nts));
        }
      };
    nts = def_loop_3(grammar, g1264);
    nb_nts_2 = nts.length;
    def_loop_1 = function(defs, nb_confs) {
        var l;
        var nb_confs_6;
        var rule;
        var rules;
        ...
        if (defs instanceof sc_Pair) {
          ...
          while (rules instanceof sc_Pair) {
            rule = rules.car;
            l = rule;
            nb_confs_6 = nb_confs_7;
            while (l instanceof sc_Pair) {
              l = l.cdr;
              ++nb_confs_6;
            }
            rules = rules.cdr;
            nb_confs_7 = nb_confs_6 + 1;
          }
          return def_loop_1(defs.cdr, nb_confs_7);
        } else {
          return nb_confs;
        }
      };
    nb_confs = def_loop_1(grammar, 0) + nb_nts_2;
    starters = sc_makeVector(nb_nts_2, null);
    enders = sc_makeVector(nb_nts_2, null);
    predictors = sc_makeVector(nb_nts_2, null);
    steps = sc_makeVector(nb_confs, false);
    names = sc_makeVector(nb_confs, false);
    nb_nts = nts.length;
    g1269 = nb_nts - 1;
    i = g1269;
    while (i >= 0) {
      steps[i] = i - nb_nts;
      names[i] = sc_list(nts[i], 0);
      enders[i] = sc_list(i);
      --i;
    }
    g1270 = nts.length;
    def_loop = function(defs, conf) {
        ...
        if (defs instanceof sc_Pair) {
          ...
          while (rules instanceof sc_Pair) {
            rule = rules.car;
            names[conf_11] = sc_list(head, rule_num);
            i_10 = ind(head, nts);
            starters[i_10] = new sc_Pair(conf_11, starters[i_10]);
            l = rule;
            conf_9 = conf_11;
            while (l instanceof sc_Pair) {
              nt = l.car;
              steps[conf_9] = ind(nt, nts);
              i_8 = ind(nt, nts);
              predictors[i_8] = new sc_Pair(conf_9, predictors[i_8]);
              l = l.cdr;
              ++conf_9;
            }
            steps[conf_9] = ind(head, nts) - nb_nts;
            i = ind(head, nts);
            enders[i] = new sc_Pair(conf_9, enders[i]);
            rules = rules.cdr;
            conf_11 = conf_9 + 1;
            ++rule_num;
          }
          return def_loop(defs.cdr, conf_11);
        } else {
          return false;
        }
      };
    def_loop(grammar, g1270);
    parser_descr = [lexer, nts, starters, enders, predictors, steps, names];
    return function(input) {
            ...
            var ind;
            var make_states;
            var BgL_sc_confzd2setzd2getza2_5za2;
            var conf_set_merge_new_bang;
            var conf_set_adjoin;
            var BgL_sc_confzd2setzd2adjoinza2_6za2;
            var BgL_sc_confzd2setzd2adjoinza2za2_7z00;
            var conf_set_union;
            var forw;
            var is_parsed;
            var deriv_trees;
            var BgL_sc_derivzd2treesza2_8z70;
            var nb_deriv_trees;
            var BgL_sc_nbzd2derivzd2treesza2_9za2;
            ind = function(nt, nts) {
                var i;
                var g1272;
                g1272 = nts.length - 1;
            ...
            make_states = function(nb_toks, nb_confs) {
                var v;
                var i;
                var states;
                states = sc_makeVector(nb_toks + 1, false);
                i = nb_toks;
                while (i >= 0) {
                  v = sc_makeVector(nb_confs + 1, false);
                  v[0] = -1;
                  states[i] = v;
                  --i;
                }
            ...
            BgL_sc_confzd2setzd2getza2_5za2 = function(state, state_num, conf) {
                var conf_set;
                var conf_set_31;
                conf_set_31 = state[conf + 1];
                if (conf_set_31 !== false) {
                  return conf_set_31;
                } else {
                  conf_set = sc_makeVector(state_num + 6, false);
                  conf_set[1] = -3;
                  conf_set[2] = -1;
                  conf_set[3] = -1;
                  conf_set[4] = -1;
                  state[conf + 1] = conf_set;
                  return conf_set;
                }
              };
            ...
            conf_set_adjoin = function(state, conf_set, conf, i) {
                var tail;
                tail = conf_set[3];
                conf_set[i + 5] = -1;
                conf_set[tail + 5] = i;
            ...
            BgL_sc_confzd2setzd2adjoinza2_6za2 = function(states, state_num, l, i) {
                var conf_set;
                var conf;
                var l1;
                var state;
                ...
                while (l1 instanceof sc_Pair) {
                  conf = l1.car;
                  conf_set = BgL_sc_confzd2setzd2getza2_5za2(state, state_num, conf);
                  if (conf_set[i + 5] === false) {
                    conf_set_adjoin(state, conf_set, conf, i);
                    l1 = l1.cdr;
                  } else {
                    l1 = l1.cdr;
                  }
            ...
            BgL_sc_confzd2setzd2adjoinza2za2_7z00 = function(states, BgL_sc_statesza2_10za2, state_num, conf, i) {
                var BgL_sc_confzd2setza2_11z70;
                var BgL_sc_stateza2_12za2;
                var conf_set;
                var state;
                state = states[state_num];
                conf_set = state[conf + 1];
                if (conf_set && conf_set[i + 5] !== false) {
                  BgL_sc_stateza2_12za2 = BgL_sc_statesza2_10za2[state_num];
                  BgL_sc_confzd2setza2_11z70 = BgL_sc_confzd2setzd2getza2_5za2(BgL_sc_stateza2_12za2, state_num, conf);
                  if (BgL_sc_confzd2setza2_11z70[i + 5] === false) {
                    conf_set_adjoin(BgL_sc_stateza2_12za2, BgL_sc_confzd2setza2_11z70, conf, i);
                  }
                  return true;
                } else {
                  return false;
            ...
            conf_set_union = function(state, conf_set, conf, other_set) {
                var i;
                var g1275;
                g1275 = other_set[2];
                i = g1275;
            ...
            forw = function(states, state_num, starters, enders, predictors, steps, nts) {
                var state;
                var next_set;
                var next;
                var pred_set;
                ...
                var nb_nts;
                var state_40;
                state_40 = states[state_num];
                nb_nts = nts.length;
                do {
                  conf = state_40[0];
                  if (conf >= 0) {
                    step = steps[conf];
                    conf_set_39 = state_40[conf + 1];
                    head = conf_set_39[4];
                    state_40[0] = conf_set_39[0];
                    conf_set_merge_new_bang(conf_set_39);
                    if (step >= 0) {
                      g1276 = starters[step];
                      l_38 = g1276;
                      while (l_38 instanceof sc_Pair) {
                        starter = l_38.car;
                        starter_set = BgL_sc_confzd2setzd2getza2_5za2(state_40, state_num, starter);
                        if (starter_set[state_num + 5] === false) {
                          conf_set_adjoin(state_40, starter_set, starter, state_num);
                          l_38 = l_38.cdr;
                        } else {
                          l_38 = l_38.cdr;
                        }
                      ...
                      g1277 = enders[step];
                      l_37 = g1277;
                      while (l_37 instanceof sc_Pair) {
                        ender = l_37.car;
                        conf_set = state_40[ender + 1];
                        if (conf_set && conf_set[state_num + 5] !== false) {
                          next_36 = conf + 1;
                          next_set_35 = BgL_sc_confzd2setzd2getza2_5za2(state_40, state_num, next_36);
                          conf_set_union(state_40, next_set_35, next_36, conf_set_39);
                          l_37 = l_37.cdr;
                        } else {
                          l_37 = l_37.cdr;
                        }
                      ...
                      while (l instanceof sc_Pair) {
                        ...
                        while (i >= 0) {
                          state = states[i];
                          pred_set = state[pred + 1];
                          if (pred_set !== false) {
                            next = pred + 1;
                            next_set = BgL_sc_confzd2setzd2getza2_5za2(state_40, state_num, next);
                            conf_set_union(state_40, next_set, next, pred_set);
                          }
                          i = conf_set_39[i + 5];
                        }
                        l = l.cdr;
            ...
            is_parsed = function(nt, i, j, nts, enders, states) {
                var stmp;
                var conf_set;
                var state;
                var conf;
                var l;
                var g1280;
                var BgL_sc_ntza2_13za2;
                BgL_sc_ntza2_13za2 = ind(nt, nts);
                if (BgL_sc_ntza2_13za2 !== false) {
                  nts.length;
                  g1280 = enders[BgL_sc_ntza2_13za2];
                  l = g1280;
                  while (l instanceof sc_Pair) {
                    conf = l.car;
                    state = states[j];
            ...
            deriv_trees = function(conf, i, j, enders, steps, names, toks, states, nb_nts) {
                var loop1;
                var g1282;
                var g1281;
                var prev;
                ...
                if (name !== false) {
                  if (conf < nb_nts) {
                    return sc_list(sc_list(name, toks[i].car));
                  } else {
                    return sc_list(sc_list(name));
                  }
                } else {
                  prev = conf - 1;
                  g1281 = enders[steps[prev]];
                  g1282 = null;
                  loop1 = function(l1, l2) {
                      var loop2;
                      var g1283;
                      var ender_set;
                      var state;
                      ...
                      l1_42 = l1;
                      l2_43 = l2;
                      while (l1_42 instanceof sc_Pair) {
                        ender = l1_42.car;
                        state = states[j];
                        ender_set = state[ender + 1];
                        if (ender_set !== false) {
                          g1283 = ender_set[2];
                          loop2 = function(k, l2) {
                              var stmp;
                              ...
                              while (k_46 >= 0) {
                                ...
                                if (stmp !== false) {
                                  prev_trees = deriv_trees(prev, i, k_46, enders, steps, names, toks, states, nb_nts);
                                  ender_trees = deriv_trees(ender, k_46, j, enders, steps, names, toks, states, nb_nts);
                                  l3 = ender_trees;
                                  l2_45 = l2_47;
                                  while (l3 instanceof sc_Pair) {
                                    ...
                                    while (l4 instanceof sc_Pair) {
                                      l2_44 = new sc_Pair(sc_append(l4.car, ender_tree), l2_44);
                                      l4 = l4.cdr;
                                    }
                                    l3 = l3.cdr;
                                    l2_45 = l2_44;
                                  }
                                  return loop2(ender_set[k_46 + 5], l2_45);
                                } else {
                                  k_46 = ender_set[k_46 + 5];
                                }
                              }
                              return loop1(l1_42.cdr, l2_47);
                            };
                          return loop2(g1283, l2_43);
                        } else {
                          l1_42 = l1_42.cdr;
                        }
                      }
                  ...
                  return loop1(g1281, g1282);
                }
              };
            BgL_sc_derivzd2treesza2_8z70 = function(nt, i, j, nts, enders, steps, names, toks, states) {
                var stmp;
                var conf_set;
                var state;
                var conf;
                ...
                var g1284;
                var nb_nts;
                var BgL_sc_ntza2_14za2;
                BgL_sc_ntza2_14za2 = ind(nt, nts);
                if (BgL_sc_ntza2_14za2 !== false) {
                  nb_nts = nts.length;
                  g1284 = enders[BgL_sc_ntza2_14za2];
                  g1285 = null;
                  l = g1284;
                  trees = g1285;
                  while (l instanceof sc_Pair) {
                    ...
                    if (stmp !== false) {
                      l = l.cdr;
                      trees = sc_append(deriv_trees(conf, i, j, enders, steps, names, toks, states, nb_nts), trees);
                    } else {
                      l = l.cdr;
                    }
                  }
            ...
            nb_deriv_trees = function(conf, i, j, enders, steps, toks, states, nb_nts) {
                var stmp;
                var nb_ender_trees;
                var nb_prev_trees;
                var conf_set;
                ...
                prev = conf - 1;
                tmp1286 = conf < nb_nts;
                if ((tmp1286 !== false? tmp1286: steps[prev] < 0) !== false) {
                  return 1;
                } else {
                  g1287 = enders[steps[prev]];
                  l_51 = g1287;
                  n_52 = 0;
                  continue1419:
                    do {
                      ...
                      while (l instanceof sc_Pair) {
                        ...
                        if (ender_set !== false) {
                          ...
                          while (k >= 0) {
                            ...
                            if (stmp !== false) {
                              nb_prev_trees = nb_deriv_trees(prev, i, k, enders, steps, toks, states, nb_nts);
                              nb_ender_trees = nb_deriv_trees(ender, k, j, enders, steps, toks, states, nb_nts);
                              k = ender_set[k + 5];
            ...
            BgL_sc_nbzd2derivzd2treesza2_9za2 = function(nt, i, j, nts, enders, steps, toks, states) {
                var stmp;
                var conf_set;
                var state;
                var conf;
                ...
                var g1289;
                var nb_nts;
                var BgL_sc_ntza2_15za2;
                BgL_sc_ntza2_15za2 = ind(nt, nts);
                if (BgL_sc_ntza2_15za2 !== false) {
                  nb_nts = nts.length;
                  g1289 = enders[BgL_sc_ntza2_15za2];
                  l = g1289;
                  nb_trees = 0;
                  while (l instanceof sc_Pair) {
                    conf = l.car;
                    ...
                    if (stmp !== false) {
                      l = l.cdr;
                      nb_trees = nb_deriv_trees(conf, i, j, enders, steps, toks, states, nb_nts) + nb_trees;
                    } else {
                      l = l.cdr;
                    }
                  }
            ...
            nts = parser_descr[1];
            starters = parser_descr[2];
            enders = parser_descr[3];
            predictors = parser_descr[4];
            steps = parser_descr[5];
            names = parser_descr[6];
            falseHead1293 = new sc_Pair(null, null);
            L1290_25 = lexer(input);
            tail1294 = falseHead1293;
            L1290 = L1290_25;
            while (!(L1290 === null)) {
              tok = L1290.car;
              g1273 = tok.cdr;
              ...
              while (l1 instanceof sc_Pair) {
                ...
                if (i_21 !== false) {
                  l1 = l1.cdr;
                  l2 = new sc_Pair(i_21, l2);
                } else {
                  l1 = l1.cdr;
                }
              }
              stmp_14 = new sc_Pair(tok.car, sc_reverse(l2));
              stmp_13 = new sc_Pair(stmp_14, null);
              tail1294.cdr = stmp_13;
              tail1294 = tail1294.cdr;
              L1290 = L1290.cdr;
            }
            stmp_12 = falseHead1293.cdr;
            toks = sc_list2vector(stmp_12);
            nb_toks_24 = toks.length;
            nb_confs_23 = steps.length;
            states = make_states(nb_toks_24, nb_confs_23);
            goal_starters = starters[0];
            BgL_sc_confzd2setzd2adjoinza2_6za2(states, 0, goal_starters, 0);
            forw(states, 0, starters, enders, predictors, steps, nts);
            i_20 = 0;
            while (i_20 < nb_toks_24) {
              tok_nts = toks[i_20].cdr;
              BgL_sc_confzd2setzd2adjoinza2_6za2(states, i_20 + 1, tok_nts, i_20);
              forw(states, i_20 + 1, starters, enders, predictors, steps, nts);
              ++i_20;
            }
            nb_toks = toks.length;
            nb_confs = steps.length;
            nb_nts = nts.length;
            BgL_sc_statesza2_4za2 = make_states(nb_toks, nb_confs);
            goal_enders = enders[0];
            l_19 = goal_enders;
            while (l_19 instanceof sc_Pair) {
              conf_18 = l_19.car;
              BgL_sc_confzd2setzd2adjoinza2za2_7z00(states, BgL_sc_statesza2_4za2, nb_toks, conf_18, 0);
              l_19 = l_19.cdr;
            }
            i_17 = nb_toks;
            while (i_17 >= 0) {
              BgL_sc_stateza2_3za2 = BgL_sc_statesza2_4za2[i_17];
              BgL_whilezd2break1467zd2: {
                do {
                  conf = BgL_sc_stateza2_3za2[0];
                  if (conf >= 0) {
                    conf_set = BgL_sc_stateza2_3za2[conf + 1];
                    head = conf_set[4];
                    BgL_sc_stateza2_3za2[0] = conf_set[0];
                    conf_set_merge_new_bang(conf_set);
                    i = head;
                    while (i >= 0) {
                      prev = conf - 1;
                      if (conf >= nb_nts && steps[prev] >= 0) {
                        g1278 = enders[steps[prev]];
                            ...
                            do {
                              ...
                              while (l instanceof sc_Pair) {
                                ...
                                if (ender_set !== false) {
                                  ...
                                  while (k >= 0) {
                                    if (k >= i) {
                                      if (BgL_sc_confzd2setzd2adjoinza2za2_7z00(states, BgL_sc_statesza2_4za2, k, prev, i) !== false) {
                                        BgL_sc_confzd2setzd2adjoinza2za2_7z00(states, BgL_sc_statesza2_4za2, i_17, ender, k);
                                      }
                                    }
                                    k = ender_set[k + 5];
                                  }
                                  l_15 = l.cdr;
                                  continue continue1420;
                                } else {
                                  l = l.cdr;
                                }
                              }
            ...
            stmp = BgL_sc_statesza2_4za2;
            return [nts, starters, enders, predictors, steps, names, toks, stmp, is_parsed, BgL_sc_derivzd2treesza2_8z70, BgL_sc_nbzd2derivzd2treesza2_9za2];
          };
  };
BgL_parsezd2ze3parsedzf3zc2 = function(parse, nt, i, j) {
    ...
    states = parse[7];
    is_parsed = parse[8];
    return is_parsed(nt, i, j, nts, enders, states);
  };
BgL_parsezd2ze3treesz31 = function(parse, nt, i, j) {
    var BgL_sc_derivzd2treesza2_16z70;
    var states;
    var toks;
    var names;
    var steps;
    ...
    toks = parse[6];
    states = parse[7];
    BgL_sc_derivzd2treesza2_16z70 = parse[9];
    return BgL_sc_derivzd2treesza2_16z70(nt, i, j, nts, enders, steps, names, toks, states);
  };
BgL_parsezd2ze3nbzd2treesze3 = function(parse, nt, i, j) {
    var BgL_sc_nbzd2derivzd2treesza2_17za2;
    var states;
    var toks;
    var steps;
    var enders;
    ...
    toks = parse[6];
    states = parse[7];
    BgL_sc_nbzd2derivzd2treesza2_17za2 = parse[10];
    return BgL_sc_nbzd2derivzd2treesza2_17za2(nt, i, j, nts, enders, steps, toks, states);
  };
test = function() {
    var x;
    var p;
    p = BgL_makezd2parserzd2(BgL_sc_const_2z00_main, function(l) {
          var stmp;
          var x;
          var tail1299;
          var L1295;
          ...
          while (!(L1295 === null)) {
            x = L1295.car;
            stmp = new sc_Pair(sc_list(x, x), null);
            tail1299.cdr = stmp;
    ...
    x = p(const_main);
    return sc_length(BgL_parsezd2ze3treesz31(x, "\uEBACs", 0, 9));
  };
main = function() {
    var args = null;
    ...
    return BgL_runzd2benchmarkzd2("earley", 100, function(result) {
              return sc_isEqual(result, 1430);
            }, function() {
              return function() {
                      return test();
                    };
