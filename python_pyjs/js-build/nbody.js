...
$pyjs['loaded_modules']['main'] = function (__mod_name__) {
	...
	$m['__name__'] = __mod_name__;
	var $mul28,$mul29,$mul26,$mul27,$mul24,$mul22,$mul23,$mul20,$mul21,$mul25,$mul9,$mul8,$mul7,$mul6,$mul5,$mul4,$mul3,$mul2,$mul1,$mul17,$mul16,$mul15,$mul14,$mul13,$mul12,$mul11,$mul10,$mul19,$mul18,$mul35,$mul34,$mul36,$mul31,$mul30,$mul33,$mul32;

	$m['time'] = $p['___import___']('time', null);
	$m['combinations'] = function(l) {
		var $iter2_nextval,$iter1_nextval,$iter1_type,$iter2_iter,$iter1_idx,$iter2_type,$iter1_iter,$add2,y,$iter2_idx,$add1,$iter1_array,$sub2,ls,x,$sub1,$iter2_array,result;
		result = $p['list']([]);
		$iter1_iter = $p['range']($p['__op_sub']($sub1=$p['len'](l),$sub2=1));
		$iter1_nextval=$p['__iter_prepare']($iter1_iter,false);
		while (typeof($p['__wrapped_next']($iter1_nextval)['$nextval']) != 'undefined') {
			x = $iter1_nextval['$nextval'];
			ls = $p['__getslice'](l, $p['__op_add']($add1=x,$add2=1), null);
			$iter2_iter = ls;
			$iter2_nextval=$p['__iter_prepare']($iter2_iter,false);
			while (typeof($p['__wrapped_next']($iter2_nextval)['$nextval']) != 'undefined') {
				y = $iter2_nextval['$nextval'];
				result['append']($p['tuple']([l['__getitem__'](x), y]));
			}
		}
		return result;
	};
	$m['combinations']['__name__'] = 'combinations';

	$m['combinations']['__bind_type__'] = 0;
	$m['combinations']['__args__'] = [null,null,['l']];
	$m['PI'] = 3.14159265359;
	$m['SOLAR_MASS'] = (typeof ($mul3=(typeof ($mul1=4)==typeof ($mul2=$m['PI']) && typeof $mul1=='number'?
		$mul1*$mul2:
		$p['op_mul']($mul1,$mul2)))==typeof ($mul4=$m['PI']) && typeof $mul3=='number'?
		$mul3*$mul4:
		$p['op_mul']($mul3,$mul4));
	$m['DAYS_PER_YEAR'] = 365.24;
	$m['BODIES'] = $p['dict']([['sun', $p['tuple']([$p['list']([0.0, 0.0, 0.0]), $p['list']([0.0, 0.0, 0.0]), $m['SOLAR_MASS']])], ['jupiter', $p['tuple']([$p['list']([4.84143144246, (typeof ($usub1=1.16032004403)=='number'?
		-$usub1:
		$p['op_usub']($usub1)), (typeof ($usub2=0.103622044471)=='number'?
		-$usub2:
		$p['op_usub']($usub2))]), $p['list']([(typeof ($mul5=0.00166007664274)==typeof ($mul6=$m['DAYS_PER_YEAR']) && typeof $mul5=='number'?
		$mul5*$mul6:
		$p['op_mul']($mul5,$mul6)), (typeof ($mul7=0.0076990111842)==typeof ($mul8=$m['DAYS_PER_YEAR']) && typeof $mul7=='number'?
		$mul7*$mul8:
		$p['op_mul']($mul7,$mul8)), (typeof ($mul9=(typeof ($usub3=6.90460016972e-05)=='number'?
		-$usub3:
		$p['op_usub']($usub3)))==typeof ($mul10=$m['DAYS_PER_YEAR']) && typeof $mul9=='number'?
		$mul9*$mul10:
		$p['op_mul']($mul9,$mul10))]), (typeof ($mul11=0.000954791938424)==typeof ($mul12=$m['SOLAR_MASS']) && typeof $mul11=='number'?
		$mul11*$mul12:
		$p['op_mul']($mul11,$mul12))])], ['saturn', $p['tuple']([$p['list']([8.34336671824, 4.12479856412, (typeof ($usub4=0.403523417114)=='number'?
		-$usub4:
		$p['op_usub']($usub4))]), $p['list']([(typeof ($mul13=(typeof ($usub5=0.00276742510727)=='number'?
		-$usub5:
		$p['op_usub']($usub5)))==typeof ($mul14=$m['DAYS_PER_YEAR']) && typeof $mul13=='number'?
		$mul13*$mul14:
		$p['op_mul']($mul13,$mul14)), (typeof ($mul15=0.00499852801235)==typeof ($mul16=$m['DAYS_PER_YEAR']) && typeof $mul15=='number'?
		$mul15*$mul16:
		$p['op_mul']($mul15,$mul16)), (typeof ($mul17=2.30417297574e-05)==typeof ($mul18=$m['DAYS_PER_YEAR']) && typeof $mul17=='number'?
		$mul17*$mul18:
		$p['op_mul']($mul17,$mul18))]), (typeof ($mul19=0.000285885980666)==typeof ($mul20=$m['SOLAR_MASS']) && typeof $mul19=='number'?
		$mul19*$mul20:
		$p['op_mul']($mul19,$mul20))])], ['uranus', $p['tuple']([$p['list']([12.8943695621, (typeof ($usub6=15.1111514017)=='number'?
		-$usub6:
		$p['op_usub']($usub6)), (typeof ($usub7=0.223307578893)=='number'?
		-$usub7:
		$p['op_usub']($usub7))]), $p['list']([(typeof ($mul21=0.00296460137565)==typeof ($mul22=$m['DAYS_PER_YEAR']) && typeof $mul21=='number'?
		$mul21*$mul22:
		$p['op_mul']($mul21,$mul22)), (typeof ($mul23=0.00237847173959)==typeof ($mul24=$m['DAYS_PER_YEAR']) && typeof $mul23=='number'?
		$mul23*$mul24:
		$p['op_mul']($mul23,$mul24)), (typeof ($mul25=(typeof ($usub8=2.9658956854e-05)=='number'?
		-$usub8:
		$p['op_usub']($usub8)))==typeof ($mul26=$m['DAYS_PER_YEAR']) && typeof $mul25=='number'?
		$mul25*$mul26:
		$p['op_mul']($mul25,$mul26))]), (typeof ($mul27=4.36624404335e-05)==typeof ($mul28=$m['SOLAR_MASS']) && typeof $mul27=='number'?
		$mul27*$mul28:
		$p['op_mul']($mul27,$mul28))])], ['neptune', $p['tuple']([$p['list']([15.3796971149, (typeof ($usub9=25.91931461)=='number'?
		-$usub9:
		$p['op_usub']($usub9)), 0.17925877295]), $p['list']([(typeof ($mul29=0.0026806777249)==typeof ($mul30=$m['DAYS_PER_YEAR']) && typeof $mul29=='number'?
		$mul29*$mul30:
		$p['op_mul']($mul29,$mul30)), (typeof ($mul31=0.00162824170038)==typeof ($mul32=$m['DAYS_PER_YEAR']) && typeof $mul31=='number'?
		$mul31*$mul32:
		$p['op_mul']($mul31,$mul32)), (typeof ($mul33=(typeof ($usub10=9.5159225452e-05)=='number'?
		-$usub10:
		$p['op_usub']($usub10)))==typeof ($mul34=$m['DAYS_PER_YEAR']) && typeof $mul33=='number'?
		$mul33*$mul34:
		$p['op_mul']($mul33,$mul34))]), (typeof ($mul35=5.15138902047e-05)==typeof ($mul36=$m['SOLAR_MASS']) && typeof $mul35=='number'?
		$mul35*$mul36:
		$p['op_mul']($mul35,$mul36))])]]);
	$m['SYSTEM'] = $p['list']($m['BODIES']['values']());
	$m['PAIRS'] = $m['combinations']($m['SYSTEM']);
	$m['advance'] = function(dt, n, bodies, pairs) {
		if (typeof bodies == 'undefined') bodies=arguments['callee']['__args__'][4][1];
		if (typeof pairs == 'undefined') pairs=arguments['callee']['__args__'][5][1];
		var $iter5_idx,$iter4_type,y1,y2,$iter3_iter,dz,dx,dy,$iter4_nextval,$mul39,$mul38,$mul37,$iter5_nextval,$iter5_array,$pow2,$pow1,$add3,$sub13,$sub12,$sub11,$sub10,$sub14,b2m,z1,z2,$add15,$add16,$add12,$iter3_array,$iter5_type,$iter4_iter,$mul62,$mul63,$mul60,$mul61,$mul66,$mul64,$mul65,$iter3_nextval,m1,m2,$add13,x2,x1,i,r,$add6,$add7,$add4,$add5,$iter4_array,$add8,$add9,b1m,m,$iter5_iter,vx,vy,vz,$iter3_idx,$mul48,$mul49,$mul44,$mul45,$mul46,$mul47,$mul40,$mul41,$mul42,$mul43,$sub9,$sub8,$sub3,$sub7,$sub6,$sub5,$sub4,$add14,v1,v2,$add17,$add10,$add11,mag,$iter3_type,$add18,$mul59,$mul58,$mul53,$mul52,$mul51,$mul50,$mul57,$mul56,$mul55,$mul54,$iter4_idx;
		...
		while (typeof($p['__wrapped_next']($iter3_nextval)['$nextval']) != 'undefined') {
			...
			while (typeof($p['__wrapped_next']($iter4_nextval)['$nextval']) != 'undefined') {
				...
				var $tupleassign2 = $p['__ass_unpack']($tupleassign1[0], 3, null);
				var $tupleassign3 = $p['__ass_unpack']($tupleassign2[0], 3, null);
				x1 = $tupleassign3[0];
				y1 = $tupleassign3[1];
				z1 = $tupleassign3[2];
				v1 = $tupleassign2[1];
				m1 = $tupleassign2[2];
				var $tupleassign4 = $p['__ass_unpack']($tupleassign1[1], 3, null);
				var $tupleassign5 = $p['__ass_unpack']($tupleassign4[0], 3, null);
				x2 = $tupleassign5[0];
				y2 = $tupleassign5[1];
				z2 = $tupleassign5[2];
				v2 = $tupleassign4[1];
				m2 = $tupleassign4[2];
				dx = $p['__op_sub']($sub3=x1,$sub4=x2);
				dy = $p['__op_sub']($sub5=y1,$sub6=y2);
				dz = $p['__op_sub']($sub7=z1,$sub8=z2);
				mag = (typeof ($mul43=dt)==typeof ($mul44=(typeof ($pow1=$p['__op_add']($add5=$p['__op_add']($add3=(typeof ($mul37=dx)==typeof ($mul38=dx) && typeof $mul37=='number'?
					$mul37*$mul38:
					$p['op_mul']($mul37,$mul38)),$add4=(typeof ($mul39=dy)==typeof ($mul40=dy) && typeof $mul39=='number'?
					$mul39*$mul40:
					$p['op_mul']($mul39,$mul40))),$add6=(typeof ($mul41=dz)==typeof ($mul42=dz) && typeof $mul41=='number'?
					$mul41*$mul42:
					$p['op_mul']($mul41,$mul42))))==typeof ($pow2=(typeof ($usub11=1.5)=='number'?
					-$usub11:
					$p['op_usub']($usub11))) && typeof $pow1=='number'?
					Math['pow']($pow1,$pow2):
					$p['op_pow']($pow1,$pow2))) && typeof $mul43=='number'?
					$mul43*$mul44:
					$p['op_mul']($mul43,$mul44));
				b1m = (typeof ($mul45=m1)==typeof ($mul46=mag) && typeof $mul45=='number'?
					$mul45*$mul46:
					$p['op_mul']($mul45,$mul46));
				b2m = (typeof ($mul47=m2)==typeof ($mul48=mag) && typeof $mul47=='number'?
					$mul47*$mul48:
					$p['op_mul']($mul47,$mul48));
				v1['__setitem__'](0, $p['__op_sub']($sub9=v1['__getitem__'](0),$sub10=(typeof ($mul49=dx)==typeof ($mul50=b2m) && typeof $mul49=='number'?
					$mul49*$mul50:
					$p['op_mul']($mul49,$mul50))));
				v1['__setitem__'](1, $p['__op_sub']($sub11=v1['__getitem__'](1),$sub12=(typeof ($mul51=dy)==typeof ($mul52=b2m) && typeof $mul51=='number'?
					$mul51*$mul52:
					$p['op_mul']($mul51,$mul52))));
				v1['__setitem__'](2, $p['__op_sub']($sub13=v1['__getitem__'](2),$sub14=(typeof ($mul53=dz)==typeof ($mul54=b2m) && typeof $mul53=='number'?
					$mul53*$mul54:
					$p['op_mul']($mul53,$mul54))));
				v2['__setitem__'](0, $p['__op_add']($add7=v2['__getitem__'](0),$add8=(typeof ($mul55=dx)==typeof ($mul56=b1m) && typeof $mul55=='number'?
					$mul55*$mul56:
					$p['op_mul']($mul55,$mul56))));
				v2['__setitem__'](1, $p['__op_add']($add9=v2['__getitem__'](1),$add10=(typeof ($mul57=dy)==typeof ($mul58=b1m) && typeof $mul57=='number'?
					$mul57*$mul58:
					$p['op_mul']($mul57,$mul58))));
				v2['__setitem__'](2, $p['__op_add']($add11=v2['__getitem__'](2),$add12=(typeof ($mul59=dz)==typeof ($mul60=b1m) && typeof $mul59=='number'?
					$mul59*$mul60:
			...
			$iter5_nextval=$p['__iter_prepare']($iter5_iter,false);
			while (typeof($p['__wrapped_next']($iter5_nextval)['$nextval']) != 'undefined') {
				var $tupleassign6 = $p['__ass_unpack']($iter5_nextval['$nextval'], 3, null);
				r = $tupleassign6[0];
				...
				vz = $tupleassign7[2];
				m = $tupleassign6[2];
				r['__setitem__'](0, $p['__op_add']($add13=r['__getitem__'](0),$add14=(typeof ($mul61=dt)==typeof ($mul62=vx) && typeof $mul61=='number'?
					$mul61*$mul62:
					$p['op_mul']($mul61,$mul62))));
				r['__setitem__'](1, $p['__op_add']($add15=r['__getitem__'](1),$add16=(typeof ($mul63=dt)==typeof ($mul64=vy) && typeof $mul63=='number'?
					$mul63*$mul64:
					$p['op_mul']($mul63,$mul64))));
				r['__setitem__'](2, $p['__op_add']($add17=r['__getitem__'](2),$add18=(typeof ($mul65=dt)==typeof ($mul66=vz) && typeof $mul65=='number'?
					$mul65*$mul66:
	...
	$m['advance']['__name__'] = 'advance';

	$m['advance']['__bind_type__'] = 0;
	$m['advance']['__args__'] = [null,null,['dt'],['n'],['bodies', $m['SYSTEM']],['pairs', $m['PAIRS']]];
	$m['report_energy'] = function(bodies, pairs, e) {
		if (typeof bodies == 'undefined') bodies=arguments['callee']['__args__'][2][1];
		if (typeof pairs == 'undefined') pairs=arguments['callee']['__args__'][3][1];
		if (typeof e == 'undefined') e=arguments['callee']['__args__'][4][1];
		var $sub22,$sub20,$add22,$iter6_type,$add25,$iter7_idx,$mul82,$add24,$div2,vx,$sub21,$div3,y1,vy,$iter6_iter,y2,vz,$iter6_nextval,$add28,$pow4,$pow3,$mul67,$add21,$add20,$mul68,$mul69,$mul77,$mul73,$add27,$add19,m1,$add26,m2,$div4,$iter7_type,$mul80,$mul81,$sub19,$sub18,$iter6_idx,$iter7_iter,$sub17,$sub16,$sub15,v1,v2,dz,dx,dy,x2,$mul75,x1,z1,z2,$mul71,$mul70,$mul72,$mul74,$iter7_nextval,$mul76,$div1,$mul78,$iter7_array,m,$iter6_array,$mul79,r,$add23;
		$iter6_iter = pairs;
		$iter6_nextval=$p['__iter_prepare']($iter6_iter,false);
		while (typeof($p['__wrapped_next']($iter6_nextval)['$nextval']) != 'undefined') {
			var $tupleassign8 = $p['__ass_unpack']($iter6_nextval['$nextval'], 2, null);
			var $tupleassign9 = $p['__ass_unpack']($tupleassign8[0], 3, null);
			var $tupleassign10 = $p['__ass_unpack']($tupleassign9[0], 3, null);
			x1 = $tupleassign10[0];
			y1 = $tupleassign10[1];
			z1 = $tupleassign10[2];
			v1 = $tupleassign9[1];
			m1 = $tupleassign9[2];
			var $tupleassign11 = $p['__ass_unpack']($tupleassign8[1], 3, null);
			var $tupleassign12 = $p['__ass_unpack']($tupleassign11[0], 3, null);
			x2 = $tupleassign12[0];
			y2 = $tupleassign12[1];
			z2 = $tupleassign12[2];
			v2 = $tupleassign11[1];
			m2 = $tupleassign11[2];
			dx = $p['__op_sub']($sub15=x1,$sub16=x2);
			dy = $p['__op_sub']($sub17=y1,$sub18=y2);
			dz = $p['__op_sub']($sub19=z1,$sub20=z2);
			e = $p['__op_sub']($sub21=e,$sub22=(typeof ($div1=(typeof ($mul67=m1)==typeof ($mul68=m2) && typeof $mul67=='number'?
				$mul67*$mul68:
				$p['op_mul']($mul67,$mul68)))==typeof ($div2=(typeof ($pow3=$p['__op_add']($add21=$p['__op_add']($add19=(typeof ($mul69=dx)==typeof ($mul70=dx) && typeof $mul69=='number'?
				$mul69*$mul70:
				$p['op_mul']($mul69,$mul70)),$add20=(typeof ($mul71=dy)==typeof ($mul72=dy) && typeof $mul71=='number'?
				$mul71*$mul72:
				$p['op_mul']($mul71,$mul72))),$add22=(typeof ($mul73=dz)==typeof ($mul74=dz) && typeof $mul73=='number'?
				$mul73*$mul74:
				$p['op_mul']($mul73,$mul74))))==typeof ($pow4=0.5) && typeof $pow3=='number'?
				Math['pow']($pow3,$pow4):
				$p['op_pow']($pow3,$pow4))) && typeof $div1=='number' && $div2 !== 0?
				$div1/$div2:
				$p['op_div']($div1,$div2)));
		}
		$iter7_iter = bodies;
		$iter7_nextval=$p['__iter_prepare']($iter7_iter,false);
		while (typeof($p['__wrapped_next']($iter7_nextval)['$nextval']) != 'undefined') {
			var $tupleassign13 = $p['__ass_unpack']($iter7_nextval['$nextval'], 3, null);
			r = $tupleassign13[0];
			var $tupleassign14 = $p['__ass_unpack']($tupleassign13[1], 3, null);
			vx = $tupleassign14[0];
			vy = $tupleassign14[1];
			vz = $tupleassign14[2];
			m = $tupleassign13[2];
			e = $p['__op_add']($add27=e,$add28=(typeof ($div3=(typeof ($mul81=m)==typeof ($mul82=$p['__op_add']($add25=$p['__op_add']($add23=(typeof ($mul75=vx)==typeof ($mul76=vx) && typeof $mul75=='number'?
				$mul75*$mul76:
				$p['op_mul']($mul75,$mul76)),$add24=(typeof ($mul77=vy)==typeof ($mul78=vy) && typeof $mul77=='number'?
				$mul77*$mul78:
				$p['op_mul']($mul77,$mul78))),$add26=(typeof ($mul79=vz)==typeof ($mul80=vz) && typeof $mul79=='number'?
				$mul79*$mul80:
				$p['op_mul']($mul79,$mul80)))) && typeof $mul81=='number'?
				$mul81*$mul82:
				$p['op_mul']($mul81,$mul82)))==typeof ($div4=2.0) && typeof $div3=='number' && $div4 !== 0?
				$div3/$div4:
				$p['op_div']($div3,$div4)));
		}
		return null;
	};
	$m['report_energy']['__name__'] = 'report_energy';

	$m['report_energy']['__bind_type__'] = 0;
	$m['report_energy']['__args__'] = [null,null,['bodies', $m['SYSTEM']],['pairs', $m['PAIRS']],['e', 0.0]];
	$m['offset_momentum'] = function(ref, bodies, px, py, pz) {
		if (typeof bodies == 'undefined') bodies=arguments['callee']['__args__'][3][1];
		if (typeof px == 'undefined') px=arguments['callee']['__args__'][4][1];
		if (typeof py == 'undefined') py=arguments['callee']['__args__'][5][1];
		if (typeof pz == 'undefined') pz=arguments['callee']['__args__'][6][1];
		var $sub23,$sub26,$sub27,$sub24,$sub25,$iter8_array,$sub28,$iter8_iter,vy,vx,$iter8_idx,vz,$div10,$mul83,$mul84,$mul85,$mul86,$mul87,$mul88,$iter8_type,$div8,$div9,$iter8_nextval,$div6,$div7,$div5,m,r,v;
		$iter8_iter = bodies;
		$iter8_nextval=$p['__iter_prepare']($iter8_iter,false);
		while (typeof($p['__wrapped_next']($iter8_nextval)['$nextval']) != 'undefined') {
			var $tupleassign15 = $p['__ass_unpack']($iter8_nextval['$nextval'], 3, null);
			r = $tupleassign15[0];
			var $tupleassign16 = $p['__ass_unpack']($tupleassign15[1], 3, null);
			vx = $tupleassign16[0];
			vy = $tupleassign16[1];
			vz = $tupleassign16[2];
			m = $tupleassign15[2];
			px = $p['__op_sub']($sub23=px,$sub24=(typeof ($mul83=vx)==typeof ($mul84=m) && typeof $mul83=='number'?
				$mul83*$mul84:
				$p['op_mul']($mul83,$mul84)));
			py = $p['__op_sub']($sub25=py,$sub26=(typeof ($mul85=vy)==typeof ($mul86=m) && typeof $mul85=='number'?
				$mul85*$mul86:
				$p['op_mul']($mul85,$mul86)));
			pz = $p['__op_sub']($sub27=pz,$sub28=(typeof ($mul87=vz)==typeof ($mul88=m) && typeof $mul87=='number'?
				$mul87*$mul88:
				$p['op_mul']($mul87,$mul88)));
		}
		var $tupleassign17 = $p['__ass_unpack'](ref, 3, null);
		r = $tupleassign17[0];
		v = $tupleassign17[1];
		m = $tupleassign17[2];
		v['__setitem__'](0, (typeof ($div5=px)==typeof ($div6=m) && typeof $div5=='number' && $div6 !== 0?
			$div5/$div6:
			$p['op_div']($div5,$div6)));
		v['__setitem__'](1, (typeof ($div7=py)==typeof ($div8=m) && typeof $div7=='number' && $div8 !== 0?
			$div7/$div8:
			$p['op_div']($div7,$div8)));
		v['__setitem__'](2, (typeof ($div9=pz)==typeof ($div10=m) && typeof $div9=='number' && $div10 !== 0?
			$div9/$div10:
			$p['op_div']($div9,$div10)));
		return null;
	};
	$m['offset_momentum']['__name__'] = 'offset_momentum';

	$m['offset_momentum']['__bind_type__'] = 0;
	$m['offset_momentum']['__args__'] = [null,null,['ref'],['bodies', $m['SYSTEM']],['px', 0.0],['py', 0.0],['pz', 0.0]];
	$m['NUMBER_OF_ITERATIONS'] = 20000;
	$m['main'] = function(n, ref) {
		if (typeof ref == 'undefined') ref=arguments['callee']['__args__'][3][1];
		var $sub30,$iter9_array,$iter9_iter,i,$sub29,$iter9_nextval,$iter9_idx,t0,times,tk,$iter9_type;
		times = $p['list']([]);
		...
		while (typeof($p['__wrapped_next']($iter9_nextval)['$nextval']) != 'undefined') {
			...
			t0 = $m['time']['time']();
			$m['offset_momentum']($m['BODIES']['__getitem__'](ref));
			$m['report_energy']();
			$m['advance'](0.01, $m['NUMBER_OF_ITERATIONS']);
			$m['report_energy']();
			tk = $m['time']['time']();
			times['append']($p['__op_sub']($sub29=tk,$sub30=t0));
		}
		return times;
	};
	...
	$m['main']['__args__'] = [null,null,['n'],['ref', 'sun']];
	$m['main'](10);
	return this;
}; /* end main */
