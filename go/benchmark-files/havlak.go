/*
NOTE(rachit): Benchmark from: https://github.com/kostya/benchmarks/blob/master/havlak/havlak.go

Some of the numbers in the loops have to tweaked in order to avoid stack
overflow in gopherjs.
*/
package main
...
func main() {
  ...
  // NOTE(rachit): orginal
	...
	for parlooptrees := 0; parlooptrees < 1; parlooptrees++ {
