...
count = function(r, i, step, x, y) {
    var new_zi;
    var new_zr;
    var BgL_sc_za7ize52_1z42;
    var BgL_sc_za7rze52_2z42;
    var zr;
    var zi;
    var c;
    var ci;
    ...
    c = 0;
    while (!(c === 64)) {
      BgL_sc_za7rze52_2z42 = zr * zr;
      BgL_sc_za7ize52_1z42 = zi * zi;
      if (BgL_sc_za7rze52_2z42 + BgL_sc_za7ize52_1z42 > 16.0) {
        return c;
      } else {
        new_zr = BgL_sc_za7rze52_2z42 - BgL_sc_za7ize52_1z42 + cr;
        new_zi = 2.0 * (zr * zi) + ci;
        zr = new_zr;
        zi = new_zi;
        ++c;
...
mbrot = function(matrix, r, i, step, n) {
    var x;
    var g1265;
    var y;
    var g1264;
...
test = function(n) {
    ...
    var g1266;
    var matrix;
    matrix = sc_makeVector(n);
    g1266 = n - 1;
    i = g1266;
    while (i >= 0) {
      matrix[i] = sc_makeVector(n);
      --i;
    }
...
main = function() {
    ...
    return BgL_runzd2benchmarkzd2("mbrot", 1000, function(result) {
              return sc_isEqual(result, 5);
            }, function(n) {
              return function() {
                      return test(n);
                    };
