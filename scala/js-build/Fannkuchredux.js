...
/** @constructor */
function $c_Lfannkuchredux$() {
  $c_O.call(this)
}
$c_Lfannkuchredux$.prototype = new $h_O();
$c_Lfannkuchredux$.prototype.constructor = $c_Lfannkuchredux$;
/** @constructor */
function $h_Lfannkuchredux$() {
  /*<skip>*/
}
$h_Lfannkuchredux$.prototype = $c_Lfannkuchredux$.prototype;
$c_Lfannkuchredux$.prototype.init___ = (function() {
  return this
});
$c_Lfannkuchredux$.prototype.fannkuch__I__I = (function(n) {
  var this$1 = $m_s_Array$();
  var perm1 = this$1.range__I__I__I__AI(0, n, 1);
  var perm = $newArrayObject($d_I.getArrayOf(), [n]);
  var count = $newArrayObject($d_I.getArrayOf(), [n]);
  var f = 0;
  var i = 0;
  var k = 0;
  var r = 0;
  ...
  while ((r > 0)) {
    ...
    while (go) {
      ...
      perm1.set(r, p0);
      var ev$1 = r;
      count.set(ev$1, (((-1) + count.get(ev$1)) | 0));
      if ((count.get(r) > 0)) {
        go = false
      } else {
        r = ((1 + r) | 0)
...
$c_Lfannkuchredux$.prototype.main__AT__V = (function(args) {
  ...
  var x$1 = ((("Pfannkuchen(" + n) + ") = ") + this.fannkuch__I__I(n));
...
var $d_Lfannkuchredux$ = new $TypeData().initClass({
  Lfannkuchredux$: 0
}, false, "fannkuchredux$", {
  Lfannkuchredux$: 1,
  O: 1
});
$c_Lfannkuchredux$.prototype.$classData = $d_Lfannkuchredux$;
var $n_Lfannkuchredux$ = (void 0);
function $m_Lfannkuchredux$() {
  if ((!$n_Lfannkuchredux$)) {
    $n_Lfannkuchredux$ = new $c_Lfannkuchredux$().init___()
  };
  return $n_Lfannkuchredux$
}
/** @constructor */
function $c_jl_Class() {
  $c_O.call(this);
...
$c_sci_Range$.prototype.count__I__I__I__Z__I = (function(start, end, step, isInclusive) {
  if ((step === 0)) {
    throw new $c_jl_IllegalArgumentException().init___T("step cannot be 0.")
  };
  var isEmpty = ((start === end) ? (!isInclusive) : ((start < end) ? (step < 0) : (step > 0)));
  if (isEmpty) {
    return 0
  } else {
    var hi = (end >> 31);
    ...
    var lo$1 = this$2.divideImpl__I__I__I__I__I(lo, hi$2, step, hi$3);
    var hi$4 = this$2.scala$scalajs$runtime$RuntimeLong$$hiReturn$f;
    if (isInclusive) {
      var hasStub = true
    } else {
      var hi$5 = (step >> 31);
      var this$3 = $m_sjsr_RuntimeLong$();
      var lo$2 = this$3.remainderImpl__I__I__I__I__I(lo, hi$2, step, hi$5);
      var hi$6 = this$3.scala$scalajs$runtime$RuntimeLong$$hiReturn$f;
      var hasStub = (!((lo$2 === 0) && (hi$6 === 0)))
    };
    var value = (hasStub ? 1 : 0);
    var hi$7 = (value >> 31);
    var lo$3 = ((lo$1 + value) | 0);
    var hi$8 = ((((-2147483648) ^ lo$3) < ((-2147483648) ^ lo$1)) ? ((1 + ((hi$4 + hi$7) | 0)) | 0) : ((hi$4 + hi$7) | 0));
    return (((hi$8 === 0) ? (((-2147483648) ^ lo$3) > (-1)) : (hi$8 > 0)) ? (-1) : lo$3)
  }
});
...
$c_s_Array$.prototype.range__I__I__I__AI = (function(start, end, step) {
  if ((step === 0)) {
    throw new $c_jl_IllegalArgumentException().init___T("zero step")
  };
  var elems$2 = null;
  elems$2 = [];
  $m_sci_Range$().count__I__I__I__Z__I(start, end, step, false);
  var i = start;
...
$m_Lfannkuchredux$().main__AT__V($makeNativeArrayWrapper($d_T.getArrayOf(), []));
}).call(this);
