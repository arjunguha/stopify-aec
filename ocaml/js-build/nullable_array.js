...
var Marshal                 = __webpack_require__(44);
var Caml_array              = __webpack_require__(3);
var Caml_missing_polyfill   = __webpack_require__(15);
var Caml_builtin_exceptions = __webpack_require__(0);
...
var Block                  = __webpack_require__(7);
var Curry                  = __webpack_require__(1);
var Printf                 = __webpack_require__(16);
var Random                 = __webpack_require__(31);
var Fixture                = __webpack_require__(37);
var Caml_array             = __webpack_require__(3);
var Pervasives             = __webpack_require__(2);
var Option_array           = __webpack_require__(38);
var Micro_bench_run        = __webpack_require__(39);
var Micro_bench_types      = __webpack_require__(46);
var Nullable_array_marker  = __webpack_require__(47);
var Nullable_array_closure = __webpack_require__(48);
...
function prepare_random_option_array(density, size) {
  ...
  var a = Option_array.make(size);
  $$Array.iter((function (i) {
          return Option_array.set(a, i, i);
        }), selection);
  return a;
}
...
function prepare_random_path(density, size) {
  ...
  var a = Option_array.make(size$1);
  Option_array.set(a, 0, Caml_array.caml_array_get(selection, 0) + 1 | 0);
  for(var i = 0 ,i_finish = n$1 - 2 | 0; i <= i_finish; ++i){
    Option_array.set(a, Caml_array.caml_array_get(selection, i) + 1 | 0, Caml_array.caml_array_get(selection, i + 1 | 0) + 1 | 0);
  }
  return a;
}
...
function Bench(M) {
  return (function (Get) {
      ...
      var copy_option_array = function (oa) {
        var a = Curry._1(M[/* make */1], Option_array.length(oa));
        Option_array.iteri_sparse((function (i, v) {
...
var OA = (function (Get) {
      var name = Get[/* name */0];
      var copy_option_array = function (oa) {
        var a = Option_array.make(Option_array.length(oa));
        Option_array.iteri_sparse((function (i, v) {
                return Option_array.set(a, i, v);
              }), oa);
        return a;
      };
      var sum = function (a) {
        var r = [0];
        Option_array.iteri_sparse((function (_, i) {
                r[0] = i + r[0] | 0;
                return /* () */0;
              }), a);
        return r[0];
      ...
      var walk = function (a) {
        ...
        while(true) {
          var count = _count;
          var i = _i;
          var match = Option_array.get(a, i);
          if (match) {
            _count = count + 1 | 0;
            _i = match[0];
            continue ;
      ...
      var walk_k = function (a) {
        var loop = function (i, count) {
          return Option_array.get_k(a, i, (function () {
                        return count;
                      }), (function (next) {
                        return loop(next, count + 1 | 0);
                      }));
...
var NAC = (function (Get) {
      var name = Get[/* name */0];
      var copy_option_array = function (oa) {
        var a = Nullable_array_closure.make(Option_array.length(oa));
        Option_array.iteri_sparse((function (i, v) {
                return Nullable_array_closure.set(a, i, v);
              }), oa);
        return a;
      };
      var sum = function (a) {
        var r = [0];
        Nullable_array_closure.iteri_sparse((function (_, i) {
                r[0] = i + r[0] | 0;
                return /* () */0;
              }), a);
        return r[0];
      ...
      var walk = function (a) {
        ...
        while(true) {
          var count = _count;
          var i = _i;
          var match = Nullable_array_closure.get(a, i);
          if (match) {
            _count = count + 1 | 0;
            _i = match[0];
            continue ;
      ...
      var walk_k = function (a) {
        var loop = function (i, count) {
          return Nullable_array_closure.get_k(a, i, (function () {
                        return count;
                      }), (function (next) {
                        return loop(next, count + 1 | 0);
                      }));
...
var NAM = (function (Get) {
      var name = Get[/* name */0];
      var copy_option_array = function (oa) {
        var a = Nullable_array_marker.make(Option_array.length(oa));
        Option_array.iteri_sparse((function (i, v) {
                return Nullable_array_marker.set(a, i, v);
              }), oa);
        return a;
      };
      var sum = function (a) {
        var r = [0];
        Nullable_array_marker.iteri_sparse((function (_, i) {
                r[0] = i + r[0] | 0;
                return /* () */0;
              }), a);
        return r[0];
      ...
      var walk = function (a) {
        ...
        while(true) {
          var count = _count;
          var i = _i;
          var match = Nullable_array_marker.get(a, i);
          if (match) {
            _count = count + 1 | 0;
            _i = match[0];
            continue ;
      ...
      var walk_k = function (a) {
        var loop = function (i, count) {
          return Nullable_array_marker.get_k(a, i, (function () {
                        return count;
                      }), (function (next) {
                        return loop(next, count + 1 | 0);
                      }));
...
function copy_prepared_option_array(base_array) {
  return /* record */[
          /* option_array */Curry._1(OA[/* copy_option_array */1], base_array),
...
function check_walk(density, size, res) {
  ...
  var length = Curry._1(OA[/* walk */4], oa);
  if (length === res) {
    return /* Ok */0;
  } else {
    return /* Error */[Curry._2(Printf.sprintf(/* Format */[
...
var functions = Pervasives.$at(List.map(sum, densities), List.map(walk, densities));
...
var Int64                   = __webpack_require__(33);
var Digest                  = __webpack_require__(34);
var Caml_sys                = __webpack_require__(14);
var Nativeint               = __webpack_require__(36);
var Caml_array              = __webpack_require__(3);
var Caml_int64              = __webpack_require__(20);
var Pervasives              = __webpack_require__(2);
var Caml_string             = __webpack_require__(4);
...
exports.get          = get;
exports.get_k        = get_k;
exports.iteri_sparse = iteri_sparse;
/* No side effect */
...
var Arg        = __webpack_require__(40);
var $$Set      = __webpack_require__(41);
var Sys        = __webpack_require__(25);
var List       = __webpack_require__(8);
var $$Array    = __webpack_require__(11);
var Block      = __webpack_require__(7);
var Curry      = __webpack_require__(1);
...
var Printf     = __webpack_require__(16);
var $$String   = __webpack_require__(13);
var Caml_gc    = __webpack_require__(42);
var Caml_obj   = __webpack_require__(5);
var Caml_sys   = __webpack_require__(14);
var Printexc   = __webpack_require__(43);
var Caml_array = __webpack_require__(3);
var Caml_int32 = __webpack_require__(10);
var Pervasives = __webpack_require__(2);
...
var Obj                     = __webpack_require__(26);
var $$Array                 = __webpack_require__(11);
var Block                   = __webpack_require__(7);
var Curry                   = __webpack_require__(1);
var Buffer                  = __webpack_require__(17);
...
var Caml_array              = __webpack_require__(3);
var Pervasives              = __webpack_require__(2);
var Caml_backtrace          = __webpack_require__(45);
var Caml_builtin_exceptions = __webpack_require__(0);
...
var Null = Caml_exceptions.create("Nullable_array_marker.Null");
...
var Null = Caml_exceptions.create("Nullable_array_closure.Null");
