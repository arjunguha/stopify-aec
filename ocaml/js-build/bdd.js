...
var Caml_array              = __webpack_require__(1);
...
function run_eval$1() {
  var res = run_eval(prepare_eval(10));
  var match = check_eval(10, res);
  if (match) {
    throw [
...
function run_build$1() {
  var res = run_build(10);
  var match = check_build(10, res);
  if (match) {
    throw [
          Caml_builtin_exceptions.failure,
          match[0]
...
Fixture.run_n_times(3000, run_eval$1);

Fixture.run_n_times(3000, run_build$1);
...
exports.run_eval      = run_eval$1;
exports.run_build     = run_build$1;
/*  Not a pure module */
