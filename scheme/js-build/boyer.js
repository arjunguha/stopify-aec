...
BgL_runzd2benchmarkzd2 = function(name, count, is_ok, run_maker) {
    ...
    if (is_ok(result) === false) {
      sc_display(BgL_sc_const_3z00_main);
      sc_newline();
      sc_display("*** got: ");
      sc_write(result);
      return sc_newline();
...
put = function(key1, key2, val) {
    ...
    if (x !== false) {
      ...
      if (y !== false) {
        ...
        return x.cdr = new sc_Pair(new sc_Pair(key2, val), x.cdr);
      }
    } else {
      return properties = new sc_Pair(sc_list(key1, new sc_Pair(key2, val)), properties);
    }
  };
BgL_unifyzd2substzd2 = null;
BgL_addzd2lemmazd2 = function(term) {
    if (term instanceof sc_Pair && term.car === "\uEBACequal" && term.cdr.car instanceof sc_Pair) {
      return put(term.cdr.car.car, "\uEBAClemmas", new sc_Pair(term, get(term.cdr.car.car, "\uEBAClemmas")));
    } else {
      return error(BgL_sc_const_4z00_main, term);
    }
  };
BgL_addzd2lemmazd2lstz00 = function(lst) {
    if (lst === null) {
      return true;
    } else {
      BgL_addzd2lemmazd2(lst.car);
      return BgL_addzd2lemmazd2lstz00(lst.cdr);
    }
  };
BgL_applyzd2substzd2 = function(alist, term) {
    var g1266;
    if (!(term instanceof sc_Pair)) {
      g1266 = sc_assq(term, alist);
      if (g1266 !== false) {
        return g1266.cdr;
      } else {
        return term;
      ...
      return new sc_Pair(term.car, BgL_applyzd2substzd2lstz00(alist, term.cdr));
    }
  };
BgL_applyzd2substzd2lstz00 = function(alist, lst) {
    if (lst === null) {
      return null;
    } else {
      return new sc_Pair(BgL_applyzd2substzd2(alist, lst.car), BgL_applyzd2substzd2lstz00(alist, lst.cdr));
    }
  };
falsep = function(x, lst) {
    var tmp1267;
    tmp1267 = sc_isEqual(x, new sc_Pair("\uEBACf", null));
    if (tmp1267 !== false) {
      return tmp1267;
    } else {
      return sc_member(x, lst);
    }
  };
BgL_onezd2wayzd2unifyz00 = function(term1, term2) {
    BgL_unifyzd2substzd2 = null;
    return BgL_onezd2wayzd2unify1z00(term1, term2);
  };
BgL_onezd2wayzd2unify1z00 = function(term1, term2) {
    var g1269;
    if (!(term2 instanceof sc_Pair)) {
      g1269 = sc_assq(term2, BgL_unifyzd2substzd2);
      if (g1269 !== false) {
        return sc_isEqual(term1, g1269.cdr);
      } else {
        BgL_unifyzd2substzd2 = new sc_Pair(new sc_Pair(term2, term1), BgL_unifyzd2substzd2);
        return true;
      }
    } else {
      if (!(term1 instanceof sc_Pair)) {
        ...
        if (term1.car === term2.car) {
          return BgL_onezd2wayzd2unify1zd2lstzd2(term1.cdr, term2.cdr);
        } else {
          return false;
        }
      }
...
BgL_onezd2wayzd2unify1zd2lstzd2 = function(lst1, lst2) {
    if (lst1 === null) {
      return true;
    } else {
      if (BgL_onezd2wayzd2unify1z00(lst1.car, lst2.car) !== false) {
        return BgL_onezd2wayzd2unify1zd2lstzd2(lst1.cdr, lst2.cdr);
      } else {
        return false;
      }
    }
...
rewrite = function(term) {
    if (!(term instanceof sc_Pair)) {
      ...
      return BgL_rewritezd2withzd2lemmasz00(new sc_Pair(term.car, BgL_rewritezd2argszd2(term.cdr)), get(term.car, "\uEBAClemmas"));
    }
  };
BgL_rewritezd2argszd2 = function(lst) {
    if (lst === null) {
      return null;
    } else {
      return new sc_Pair(rewrite(lst.car), BgL_rewritezd2argszd2(lst.cdr));
    }
  };
BgL_rewritezd2withzd2lemmasz00 = function(term, lst) {
    var tmp1270;
    tmp1270 = lst === false;
    if ((tmp1270 !== false? tmp1270: lst === null) !== false) {
      return term;
    } else {
      if (BgL_onezd2wayzd2unifyz00(term, lst.car.cdr.car) !== false) {
        return rewrite(BgL_applyzd2substzd2(BgL_unifyzd2substzd2, lst.car.cdr.cdr.car));
      } else {
        return BgL_rewritezd2withzd2lemmasz00(term, lst.cdr);
      }
    }
  };
setup = function() {
    return BgL_addzd2lemmazd2lstz00(BgL_sc_const_1z00_main);
  };
tautologyp = function(x, true_lst, false_lst) {
    if (truep(x, true_lst) !== false) {
      return true;
    } else {
      if (falsep(x, false_lst) !== false) {
        return false;
      } else {
        if (!(x instanceof sc_Pair)) {
          ...
          if (x.car === "\uEBACif") {
            if (truep(x.cdr.car, true_lst) !== false) {
              return tautologyp(x.cdr.cdr.car, true_lst, false_lst);
            } else {
              if (falsep(x.cdr.car, false_lst) !== false) {
                return tautologyp(x.cdr.cdr.cdr.car, true_lst, false_lst);
              } else {
                if (tautologyp(x.cdr.cdr.car, new sc_Pair(x.cdr.car, true_lst), false_lst) !== false) {
                  return tautologyp(x.cdr.cdr.cdr.car, true_lst, new sc_Pair(x.cdr.car, false_lst));
                } else {
                  return false;
                }
              }
...
tautp = function(x) {
    return tautologyp(rewrite(x), null, null);
  };
test = function(alist, term) {
    return tautp(BgL_applyzd2substzd2(alist, term));
  };
BgL_transzd2ofzd2impliesz00 = function(n) {
    return sc_list("\uEBACimplies", BgL_transzd2ofzd2implies1z00(n), sc_list("\uEBACimplies", 0, n));
  };
BgL_transzd2ofzd2implies1z00 = function(n) {
    if (sc_isEqual(n, 1)) {
      return sc_list("\uEBACimplies", 0, 1);
    } else {
      return sc_list("\uEBACand", sc_list("\uEBACimplies", n - 1, n), BgL_transzd2ofzd2implies1z00(n - 1));
    }
  };
truep = function(x, lst) {
    var tmp1271;
    tmp1271 = sc_isEqual(x, new sc_Pair("\uEBACt", null));
    if (tmp1271 !== false) {
      return tmp1271;
    } else {
      return sc_member(x, lst);
...
main = function() {
    ...
    return BgL_runzd2benchmarkzd2("boyer", BgL_boyerzd2iterszd2, function(result) {
              return sc_isEqual(result, true);
            }, function(alist, term) {
              return function() {
                      return test(alist, term);
                    };
            }, const_main, BgL_sc_const_2z00_main);
  };
main();
