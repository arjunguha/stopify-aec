...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    ListMixin: {
      ...
      fillRange$3: function(receiver, start, end, fill) {
        var t1, i;
        t1 = receiver.length;
        P.RangeError_checkValidRange(start, end, t1, null, null, null);
        for (i = start; i < end; ++i) {
          if (i >= t1)
  ...
  }], ["", "../benchmark-files/spectral_norm.dart",, U, {
    "^": "",
    main: function() {
      H.printString("SpectralNorm(RunTime): " + H.S(new U.SpectralNorm("SpectralNorm").measure$0()) + " us.");
    },
    A: function(i, j) {
      var t1 = i + j;
      return 1 / ((t1 * (t1 + 1) >>> 1) + i + 1);
    },
    Au: function(u, w) {
      var len, t1, i, t, j;
      len = u.length;
      for (t1 = w.length, i = 0; i < len; ++i) {
        for (t = 0, j = 0; j < len; ++j)
          t += U.A(i, j) * u[j];
        if (i >= t1)
          return H.ioore(w, i);
    ...
    spectralNorm: function(n) {
      var t1, u, t2, v, w, i, vv, vBv, t3, t4;
      t1 = H._checkLength(n);
      u = new Float64Array(t1);
      C.NativeFloat64List_methods.fillRange$3(u, 0, n, 1);
      t2 = H._checkLength(n);
      v = new Float64Array(t2);
      w = new Float64Array(H._checkLength(n));
      for (i = 0; i < 10; ++i) {
        U.Au(u, w);
        U.Atu(w, v);
        U.Au(v, w);
    ...
    SpectralNorm: {
      "^": "BenchmarkBase;name",
      run$0: function() {
        C.JSNumber_methods.toStringAsFixed$1(U.spectralNorm(5500), 9);
      }
    }
  }, 1]];
  setupProgram(dart, 0);
...
//# sourceMappingURL=spectral_norm.js.map
