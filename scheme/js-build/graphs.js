...
var main;
var run;
var BgL_makezd2reachzf3z21;
var BgL_foldzd2overzd2rdgz00;
var BgL_cmpzd2nextzd2vertexz00;
var BgL_makezd2minimalzf3z21;
var BgL_foldzd2overzd2permzd2treezd2;
var BgL_therezd2existszf3z21;
var BgL_naturalzd2therezd2existszf3zf3;
var BgL_naturalzd2forzd2allzf3zf3;
var BgL_gnaturalzd2forzd2eachz00;
var BgL_gnaturalzd2foldzd2;
var giota;
var BgL_vectorzd2mapzd2;
var BgL_vectorzd2foldzd2;
...
var BgL_graphszd2iterszd2;
const_main = "*** wrong result ***";
BgL_graphszd2iterszd2 = 50;
...
fold = function(lst, folder, state) {
    ...
    state_2 = state;
    while (!(lst_1 === null)) {
      state_2 = folder(lst_1.car, state_2);
      lst_1 = lst_1.cdr;
    }
    return state_2;
  };
BgL_proczd2ze3vectorz31 = function(size, f) {
    var i;
    var x;
    if (size === 0) {
      return [];
    } else {
      x = sc_makeVector(size, f(0));
      i = 1;
      while (i < size) {
        x[i] = f(i);
        ++i;
...
BgL_vectorzd2foldzd2 = function(vec, folder, state) {
    var i;
    var state_3;
    var len;
    len = vec.length;
    ...
    state_3 = state;
    while (!(i === len)) {
      state_3 = folder(vec[i], state_3);
      ++i;
    }
    return state_3;
  };
BgL_vectorzd2mapzd2 = function(vec, proc) {
    return BgL_proczd2ze3vectorz31(vec.length, function(i) {
              return proc(vec[i]);
            });
  };
giota = function(limit) {
    var limit_4;
    var limit_5;
    var res;
    var g1266;
    ...
    while (!(limit_5 === 0)) {
      limit_4 = limit_5 - 1;
      limit_5 = limit_4;
      res = new sc_Pair(limit_4, res);
    }
    return res;
  };
BgL_gnaturalzd2foldzd2 = function(limit, folder, state) {
    var i;
    var state_6;
    i = 0;
    state_6 = state;
    while (!(i === limit)) {
      state_6 = folder(i, state_6);
      ++i;
    }
    return state_6;
  };
BgL_gnaturalzd2forzd2eachz00 = function(limit, proc_bang) {
    var i;
    i = 0;
    while (!(i === limit)) {
      proc_bang(i);
...
BgL_naturalzd2forzd2allzf3zf3 = function(limit, is_ok) {
    var tmp1269;
    var i;
    i = 0;
    do {
...
BgL_naturalzd2therezd2existszf3zf3 = function(limit, is_ok) {
    var tmp1270;
    var i;
    i = 0;
    while (!(i === limit)) {
...
BgL_therezd2existszf3z21 = function(lst, is_ok) {
    var tmp1271;
    var lst_7;
    lst_7 = lst;
    while (!(lst_7 === null)) {
      tmp1271 = is_ok(lst_7.car);
      if (tmp1271 !== false) {
        return tmp1271;
      } else {
        lst_7 = lst_7.cdr;
...
BgL_foldzd2overzd2permzd2treezd2 = function(universe, b_folder, b_state, t_folder, t_state) {
    var BgL_sc__zd2za2zd2_1za2;
    var g1272;
    g1272 = function(final_t_state) {
        return final_t_state;
      };
    BgL_sc__zd2za2zd2_1za2 = function(universe, b_state, t_state, accross) {
        var BgL_sc__zd2za2za2zd2_2z00;
        var g1273;
        if (universe === null) {
          return t_folder(b_state, t_state, accross);
        } else {
          g1273 = null;
          BgL_sc__zd2za2za2zd2_2z00 = function(in_10, out, t_state) {
              var accross_11;
              var rest;
              var first;
              first = in_10.car;
              ...
              if (rest === null) {
                ...
                accross_11 = function(new_t_state) {
                    return BgL_sc__zd2za2za2zd2_2z00(rest, new sc_Pair(first, out), new_t_state);
                  };
              }
              return b_folder(first, b_state, t_state, function(new_b_state, new_t_state) {
                        return BgL_sc__zd2za2zd2_1za2(fold(out, sc_cons, rest), new_b_state, new_t_state, accross_11);
                      }, accross_11);
            };
          return BgL_sc__zd2za2za2zd2_2z00(universe, g1273, t_state);
        }
      };
    return BgL_sc__zd2za2zd2_1za2(universe, b_state, t_state, g1272);
  };
BgL_makezd2minimalzf3z21 = function(max_size) {
    var perm;
    var iotas;
    iotas = BgL_proczd2ze3vectorz31(max_size + 1, giota);
    perm = sc_makeVector(max_size, 0);
    return function(size, graph, folder, state) {
            return BgL_foldzd2overzd2permzd2treezd2(iotas[size], function(perm_x, x, state, deeper, accross) {
                      switch (BgL_cmpzd2nextzd2vertexz00(graph, perm, x, perm_x)) {
                      case "\uEBACless":
                        return false;
                        break;
                      case "\uEBACequal":
                        perm[x] = perm_x;
                        return deeper(x + 1, state);
                        break;
                      case "\uEBACmore":
                        return accross(state);
                        break;
                      default:
                        return BgL_fatalzd2errorzd2("???");
                        break;
                      }
                    }, 0, function(leaf_depth, state, accross) {
                      return folder(perm, state, accross);
                    }, state);
          };
  };
BgL_cmpzd2nextzd2vertexz00 = function(graph, perm, x, perm_x) {
    var BgL_sc_yzd2ze3xzf3_3zc2;
    var perm_y;
    var BgL_sc_xzd2ze3yzf3_4zc2;
    var y;
    var from_perm_x;
    var from_x;
    from_x = graph[x];
    from_perm_x = graph[perm_x];
    y = 0;
    while (!(x === y)) {
      BgL_sc_xzd2ze3yzf3_4zc2 = from_x[y];
      perm_y = perm[y];
      if (BgL_sc_xzd2ze3yzf3_4zc2 === from_perm_x[perm_y]) {
        BgL_sc_yzd2ze3xzf3_3zc2 = graph[y][x];
        if (BgL_sc_yzd2ze3xzf3_3zc2 === graph[perm_y][perm_x]) {
          ++y;
        } else {
          if (BgL_sc_yzd2ze3xzf3_3zc2 !== false) {
            return "\uEBACless";
          } else {
            return "\uEBACmore";
          }
        ...
        if (BgL_sc_xzd2ze3yzf3_4zc2 !== false) {
          return "\uEBACless";
        } else {
          return "\uEBACmore";
        }
...
BgL_foldzd2overzd2rdgz00 = function(size, max_out, folder, state) {
    var BgL_sc__zd2za2zd2_5za2;
    var is_root_minimal;
    var cont;
    var is_non_root_minimal;
    var cont_15;
    var minimal_folder;
    var out_degrees;
    var edges;
    ...
    var root;
    root = size - 1;
    is_edge = BgL_proczd2ze3vectorz31(size, function(from) {
          return sc_makeVector(size, false);
        });
    edges = sc_makeVector(size, null);
    out_degrees = sc_makeVector(size, 0);
    minimal_folder = BgL_makezd2minimalzf3z21(root);
    cont_15 = function(perm, state, accross) {
        return accross(true);
      };
    is_non_root_minimal = function(size) {
        return minimal_folder(size, is_edge, cont_15, true);
      };
    cont = function(perm, state, accross) {
        switch (BgL_cmpzd2nextzd2vertexz00(is_edge, perm, root, root)) {
        case "\uEBACless":
          return false;
          break;
        case "\uEBACequal":
    ...
    is_root_minimal = function() {
        return minimal_folder(root, is_edge, cont, true);
      };
    BgL_sc__zd2za2zd2_5za2 = function(vertex, state) {
        var BgL_sc__zd2za2za2zd2_6z00;
        var from_vertex;
        ...
        var from_root;
        var is_reach;
        if (is_non_root_minimal(vertex) === false) {
          return state;
        } else {
          if (vertex === root) {
            is_reach = BgL_makezd2reachzf3z21(root, edges);
            from_root = is_edge[root];
            g1274 = null;
            g1275 = null;
            BgL_sc__zd2za2zd2_7za2 = function(v, outs, efr, efrr, state) {
                var state_18;
                var tmp1276;
                var storage;
                var v_19;
                ...
                state_22 = state;
                do {
                  storage = {efrr_23: undefined};
                  with (storage) {
                    efrr_23 = tmp;
                    tmp1276 = v_19 === root;
                    if ((tmp1276 !== false? tmp1276: outs_20 === max_out) === false) {
                      from_root[v_19] = true;
                      state_18 = BgL_sc__zd2za2zd2_7za2(v_19 + 1, outs_20 + 1, new sc_Pair(v_19, efr_21), new sc_Pair(is_reach[v_19], efrr_23), state_22);
                      from_root[v_19] = false;
                      ++v_19;
                      tmp = efrr_23;
                      state_22 = state_18;
                    } else {
                      if (BgL_naturalzd2forzd2allzf3zf3(root, function(v) {
                              return BgL_therezd2existszf3z21(efrr_23, function(r) {
                                        return r[v];
                                      });
                            }) && is_root_minimal() !== false) {
                        edges[root] = efr_21;
                        return folder(BgL_proczd2ze3vectorz31(size, function(i) {
                                    return edges[i];
                                  }), state_22);
                      } else {
                        return state_22;
            ...
            return BgL_sc__zd2za2zd2_7za2(0, 0, g1274, g1275, state);
          } else {
            from_vertex = is_edge[vertex];
            BgL_sc__zd2za2za2zd2_6z00 = function(sv, outs, state) {
                var state_24;
                var state_25;
                var state_26;
                var state_27;
                ...
                var state_29;
                if (sv === vertex) {
                  out_degrees[vertex] = outs;
                  return BgL_sc__zd2za2zd2_5za2(vertex + 1, state);
                } else {
                  state_29 = BgL_sc__zd2za2za2zd2_6z00(sv + 1, outs, state);
                  from_sv = is_edge[sv];
                  sv_out = out_degrees[sv];
                  if (sv_out === max_out) {
                    state_25 = state_29;
                  } else {
                    edges[sv] = new sc_Pair(vertex, edges[sv]);
                    from_sv[vertex] = true;
                    out_degrees[sv] = sv_out + 1;
                    state_28 = BgL_sc__zd2za2za2zd2_6z00(sv + 1, outs, state_29);
                    if (outs === max_out) {
                      state_26 = state_28;
                    } else {
                      from_vertex[sv] = true;
                      edges[vertex] = new sc_Pair(sv, edges[vertex]);
                      state_27 = BgL_sc__zd2za2za2zd2_6z00(sv + 1, outs + 1, state_28);
                      edges[vertex] = edges[vertex].cdr;
                      from_vertex[sv] = false;
                      state_26 = state_27;
                    }
                    out_degrees[sv] = sv_out;
                    from_sv[vertex] = false;
                    edges[sv] = edges[sv].cdr;
                    state_25 = state_26;
                  }
                  if (outs === max_out) {
                    return state_25;
                    ...
                    edges[vertex] = new sc_Pair(sv, edges[vertex]);
                    from_vertex[sv] = true;
                    state_24 = BgL_sc__zd2za2za2zd2_6z00(sv + 1, outs + 1, state_25);
                    from_vertex[sv] = false;
                    edges[vertex] = edges[vertex].cdr;
                    return state_24;
                  }
            ...
            return BgL_sc__zd2za2za2zd2_6z00(0, 0, state);
          }
        }
      };
    return BgL_sc__zd2za2zd2_5za2(0, state);
  };
BgL_makezd2reachzf3z21 = function(size, BgL_sc_vertexzd2ze3out_8z31) {
    var res;
    res = BgL_proczd2ze3vectorz31(size, function(v) {
          var x;
          var L1277;
          var L1277_31;
          var from_v;
          from_v = sc_makeVector(size, false);
          from_v[v] = true;
          L1277_31 = BgL_sc_vertexzd2ze3out_8z31[v];
          L1277 = L1277_31;
          while (!(L1277 === null)) {
            x = L1277.car;
            from_v[x] = true;
    ...
    BgL_gnaturalzd2forzd2eachz00(size, function(m) {
        var from_m;
        from_m = res[m];
        return BgL_gnaturalzd2forzd2eachz00(size, function(f) {
                  var from_f;
                  from_f = res[f];
                  if (from_f[m] !== false) {
                    return BgL_gnaturalzd2forzd2eachz00(size, function(t) {
                              if (from_m[t] !== false) {
                                return from_f[t] = true;
                              } else {
                                return false;
                              }
                            });
...
run = function(n) {
    return BgL_foldzd2overzd2rdgz00(n, 2, sc_cons, null);
  };
main = function() {
    return BgL_runzd2benchmarkzd2("graphs", BgL_graphszd2iterszd2, function(result) {
              return true;
            }, function(n) {
              return function() {
                      return run(n);
