...
(function() {
  ...
  }], ["", "../benchmark-files/fannkuch_redux.dart",, A, {
    "^": "",
    main: function() {
      H.printString("Fannkuch(RunTime): " + H.S(new A.Fannkuch("Fannkuch").measure$0()) + " us.");
    },
    Fannkuch: {
      "^": "BenchmarkBase;name",
      fannkuch$1: function(n) {
        var p, q, s, m, i, sign, maxflips, sum, q0, flips, qq, sum0, j, t, sx, j0;
        p = new Array(n);
        q = new Array(n);
        s = new Array(n);
        m = n - 1;
...
//# sourceMappingURL=fannkuch_redux.js.map
