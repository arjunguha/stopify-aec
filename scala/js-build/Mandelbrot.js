...
/** @constructor */
function $c_Lmandelbrot$() {
  $c_O.call(this);
  this.size$1 = 0;
  this.bytesPerRow$1 = 0;
  this.nextRow$1 = 0;
  this.limitSquared$1 = 0.0;
  this.max$1 = 0
}
$c_Lmandelbrot$.prototype = new $h_O();
$c_Lmandelbrot$.prototype.constructor = $c_Lmandelbrot$;
/** @constructor */
function $h_Lmandelbrot$() {
  /*<skip>*/
}
$h_Lmandelbrot$.prototype = $c_Lmandelbrot$.prototype;
$c_Lmandelbrot$.prototype.init___ = (function() {
  this.size$1 = 0;
  this.bytesPerRow$1 = 0;
  this.nextRow$1 = 0;
  this.limitSquared$1 = 4.0;
  this.max$1 = 50;
  return this
});
$c_Lmandelbrot$.prototype.main__AT__V = (function(args) {
  ...
  if ((!isEmpty$4)) {
    ...
    while (true) {
      var arg1 = i;
      var elem = $m_Lmandelbrot$CalculateRow$().apply__I__AB(arg1);
  ...
  var this$12 = $as_sc_TraversableOnce($f_sc_IterableLike__zipWithIndex__scg_CanBuildFrom__O(this$11, bf$1)).toVector__sci_Vector();
  var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(this$2$1) {
    return (function(x$1$2) {
      var x$1 = $as_T2(x$1$2);
      return $uI(x$1.$$und2$f)
    })
  })(this));
  var ord = $m_s_math_Ordering$Int$();
  $as_sc_IterableLike($f_sc_SeqLike__sortBy__F1__s_math_Ordering__O(this$12, f, ord)).foreach__F1__V(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(this$3$1) {
    return (function(x0$1$2) {
      var x0$1 = $as_T2(x0$1$2);
      if ((x0$1 !== null)) {
        var bitmap = $asArrayOf_B(x0$1.$$und1$f, 1);
        return bitmap
      } else {
...
var $d_Lmandelbrot$ = new $TypeData().initClass({
  Lmandelbrot$: 0
}, false, "mandelbrot$", {
  Lmandelbrot$: 1,
  O: 1
});
$c_Lmandelbrot$.prototype.$classData = $d_Lmandelbrot$;
var $n_Lmandelbrot$ = (void 0);
function $m_Lmandelbrot$() {
  if ((!$n_Lmandelbrot$)) {
    $n_Lmandelbrot$ = new $c_Lmandelbrot$().init___()
  };
  return $n_Lmandelbrot$
}
/** @constructor */
function $c_Lmandelbrot$CalculateRow$() {
  $c_O.call(this)
}
$c_Lmandelbrot$CalculateRow$.prototype = new $h_O();
$c_Lmandelbrot$CalculateRow$.prototype.constructor = $c_Lmandelbrot$CalculateRow$;
/** @constructor */
function $h_Lmandelbrot$CalculateRow$() {
  /*<skip>*/
}
$h_Lmandelbrot$CalculateRow$.prototype = $c_Lmandelbrot$CalculateRow$.prototype;
$c_Lmandelbrot$CalculateRow$.prototype.init___ = (function() {
  return this
});
$c_Lmandelbrot$CalculateRow$.prototype.apply__I__AB = (function(y) {
  var bitmap = $newArrayObject($d_B.getArrayOf(), [$m_Lmandelbrot$().bytesPerRow$1]);
  var bits = 0;
  var bitnum = 0;
  var x = 0;
  var aindex = 0;
  while ((x < $m_Lmandelbrot$().size$1)) {
    var cr = ((-1.5) + ((2.0 * x) / $m_Lmandelbrot$().size$1));
    var ci = ((-1.0) + ((2.0 * y) / $m_Lmandelbrot$().size$1));
    var zr = 0.0;
    var tr = 0.0;
    var zi = 0.0;
    var ti = 0.0;
    var j = $m_Lmandelbrot$().max$1;
    do {
      zi = (((2.0 * zr) * zi) + ci);
      zr = ((tr - ti) + cr);
      ti = (zi * zi);
      tr = (zr * zr);
      j = (((-1) + j) | 0)
    } while ((((tr + ti) <= $m_Lmandelbrot$().limitSquared$1) && (j > 0)));
    bits = (bits << 1);
    if (((tr + ti) <= $m_Lmandelbrot$().limitSquared$1)) {
      bits = ((1 + bits) | 0)
    };
    bitnum = ((1 + bitnum) | 0);
    if ((x === (((-1) + $m_Lmandelbrot$().size$1) | 0))) {
      bits = (bits << ((8 - bitnum) | 0));
      bitnum = 8
    };
    if ((bitnum === 8)) {
      bitmap.set(aindex, ((bits << 24) >> 24));
      aindex = ((1 + aindex) | 0);
      bits = 0;
      bitnum = 0
    };
...
var $d_Lmandelbrot$CalculateRow$ = new $TypeData().initClass({
  Lmandelbrot$CalculateRow$: 0
}, false, "mandelbrot$CalculateRow$", {
  Lmandelbrot$CalculateRow$: 1,
  O: 1
});
$c_Lmandelbrot$CalculateRow$.prototype.$classData = $d_Lmandelbrot$CalculateRow$;
var $n_Lmandelbrot$CalculateRow$ = (void 0);
function $m_Lmandelbrot$CalculateRow$() {
  if ((!$n_Lmandelbrot$CalculateRow$)) {
    $n_Lmandelbrot$CalculateRow$ = new $c_Lmandelbrot$CalculateRow$().init___()
  };
  return $n_Lmandelbrot$CalculateRow$
}
/** @constructor */
function $c_jl_Class() {
  $c_O.call(this);
...
$c_scm_ArrayBuffer.prototype.$classData = $d_scm_ArrayBuffer;
$m_Lmandelbrot$().main__AT__V($makeNativeArrayWrapper($d_T.getArrayOf(), []));
}).call(this);
