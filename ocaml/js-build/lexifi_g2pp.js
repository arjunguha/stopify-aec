...
var Pervasives         = __webpack_require__(4);
var CamlinternalFormat = __webpack_require__(28);
...
var Curry                   = __webpack_require__(1);
var Js_exn                  = __webpack_require__(17);
var Caml_array              = __webpack_require__(11);
var Caml_exceptions         = __webpack_require__(5);
var Caml_builtin_exceptions = __webpack_require__(0);
...
var fminutes_in_day = minutes_in_day;

var minutes_to_noon = 720;

function date_of_gregorian(param) {
  var m = param[/* month */1];
  var y = param[/* year */0];
  return (Caml_int32.imul((((
                    m === 2 || m === 1 ? ((Caml_int32.imul(1461, (y + 4800 | 0) - 1 | 0) / 4 | 0) + (Caml_int32.imul(367, m + 10 | 0) / 12 | 0) | 0) - (Caml_int32.imul(3, ((y + 4900 | 0) - 1 | 0) / 100 | 0) / 4 | 0) | 0 : ((Caml_int32.imul(1461, y + 4800 | 0) / 4 | 0) + (Caml_int32.imul(367, m - 2 | 0) / 12 | 0) | 0) - (Caml_int32.imul(3, (y + 4900 | 0) / 100 | 0) / 4 | 0) | 0
                  ) + param[/* day */2] | 0) - 32075 | 0) - 2444238 | 0, minutes_in_day) + Caml_int32.imul(param[/* hour */3], 60) | 0) + param[/* minute */4] | 0;
}

function gregorian_of_date(minutes_since_epoch) {
  var jul = Caml_int32.div(minutes_since_epoch, minutes_in_day);
  var l = (jul + 68569 | 0) + 2444238 | 0;
  var n = (l << 2) / 146097 | 0;
  var l$1 = l - ((Caml_int32.imul(146097, n) + 3 | 0) / 4 | 0) | 0;
  var i = Caml_int32.imul(4000, l$1 + 1 | 0) / 1461001 | 0;
  var l$2 = (l$1 - (Caml_int32.imul(1461, i) / 4 | 0) | 0) + 31 | 0;
  var j = Caml_int32.imul(80, l$2) / 2447 | 0;
  var d = l$2 - (Caml_int32.imul(2447, j) / 80 | 0) | 0;
  var l$3 = j / 11 | 0;
  var m = (j + 2 | 0) - Caml_int32.imul(12, l$3) | 0;
  var y = (Caml_int32.imul(100, n - 49 | 0) + i | 0) + l$3 | 0;
  var daytime = Caml_int32.mod_(minutes_since_epoch, minutes_in_day);
...
function of_string(s) {
  var sub = function (ofs, len) {
    var _acc = s.charCodeAt(ofs) - 48 | 0;
    var _ofs = ofs + 1 | 0;
    var _len = len - 1 | 0;
    while(true) {
      var len$1 = _len;
      ...
      if (len$1) {
        _len = len$1 - 1 | 0;
        _ofs = ofs$1 + 1 | 0;
        _acc = (Caml_int32.imul(acc, 10) + s.charCodeAt(ofs$1) | 0) - 48 | 0;
        continue ;
  ...
  if (s.length < 10) {
    Pervasives.invalid_arg("date_of_string");
  }
  var year = sub(0, 4);
  var month = sub(5, 2);
  var day = sub(8, 2);
  if (check_date(year, month, day)) {
    if (s.length < 16) {
      return date_of_gregorian(/* record */[
                  /* year */year,
                  /* month */month,
                  /* day */day,
                  /* hour */12,
    ...
    return Pervasives.invalid_arg("date_of_string");
  }
}

function days_between(t1, t2) {
  return (t1 - t2 | 0) / fminutes_in_day;
}

function act_365(t1, t2) {
  return days_between(t1, t2) / 365;
}
...
function add_months(date, nbmonths) {
  var date$1 = gregorian_of_date(date);
  var m = date$1[/* month */1] + nbmonths | 0;
  var match_000 = date$1[/* year */0] + ((m - 1 | 0) / 12 | 0) | 0;
  var match_001 = (m - 1 | 0) % 12 + 1 | 0;
  var m$1 = match_001;
  var y = match_000;
  var match = m$1 <= 0 ? /* tuple */[
      y - 1 | 0,
      m$1 + 12 | 0
    ] : /* tuple */[
      y,
  ...
  return date_of_gregorian(/* record */[
              /* year */y$1,
              /* month */m$2,
              /* day */Pervasives.min(date$1[/* day */2], end_of_month(y$1, m$2)),
              /* hour */date$1[/* hour */3],
              /* minute */date$1[/* minute */4]
            ]);
}

function add_years(date, nbyears) {
  return add_months(date, Caml_int32.imul(nbyears, 12));
}

var max_date = of_string("2299-12-31T23:59:59");

var min_date = of_string("1980-01-01T12:00:00");

var $$Date = /* module */[
  /* hours_in_day */24,
  /* minutes_in_day */minutes_in_day,
  /* fminutes_in_day */fminutes_in_day,
  /* minutes_to_noon */minutes_to_noon,
  /* date_of_gregorian */date_of_gregorian,
  /* gregorian_of_date */gregorian_of_date,
...
function erf(x) {
  ...
  var t4 = t * t3;
  var t5 = t * t4;
  return 1 - (0.254829592 * t + -0.284496736 * t2 + 1.421413741 * t3 + -1.453152027 * t4 + 1.061405429 * t5) * Math.exp(-x * x);
}

function ugaussian_P(x) {
  var u = x / Math.sqrt(2);
  var erf$1 = u < 0 ? -erf(-u) : erf(u);
  return 0.5 * (1 + erf$1);
}

function string_of_error(param) {
  if (param !== 0) {
    return "Interval borders have both positive values.";
  } else {
    return "Interval borders have both negative values.";
  }
}

var Rootfinder = Caml_exceptions.create("Lexifi_g2pp.Math.Rootfinder.Rootfinder");

function brent(a, b, $$eval, eps) {
  if (a > b) {
    Pervasives.invalid_arg("Math.brent: arguments should verify xlo <= xhi.");
  }
  var match_000 = Curry._1($$eval, a);
  var match_001 = Curry._1($$eval, b);
  var fb = match_001;
  var fa = match_000;
  if (0 < fa * fb) {
    throw [
          Rootfinder,
          fa < 0 ? /* NotbracketedBelow */0 : /* NotbracketedAbove */1
        ];
  }
  if (0 > eps) {
    throw [
  ...
  var match = Math.abs(fa) < Math.abs(fb) ? /* tuple */[
      b,
      fb,
      a,
      fa
  ...
  while(true) {
    ...
    var a$2 = _a;
    var i = _i;
    if (Math.abs(b$1 - a$2) < eps || fb$1 === 0 || 10000 < i) {
      return b$1;
    } else {
      var s = fa$2 !== fc && fb$1 !== fc ? a$2 * fb$1 * fc / ((fa$2 - fb$1) * (fa$2 - fc)) + b$1 * fa$2 * fc / ((fb$1 - fa$2) * (fb$1 - fc)) + c * fa$2 * fb$1 / ((fc - fa$2) * (fc - fb$1)) : b$1 - fb$1 * (b$1 - a$2) / (fb$1 - fa$2);
      var match$1 = 4 * s < 3 * a$2 + b$1 || b$1 < s || mflag && 2 * Math.abs(s - b$1) >= Math.abs(b$1 - c) || !mflag && 2 * Math.abs(s - b$1) >= Math.abs(c - d) || mflag && Math.abs(b$1 - c) < eps || !mflag && Math.abs(c - d) < eps ? /* tuple */[
          0.5 * (a$2 + b$1),
          /* true */1
        ] : /* tuple */[
          s,
      ...
      var mflag$1 = match$1[1];
      var s$1 = match$1[0];
      var fs = Curry._1($$eval, s$1);
      if (fa$2 * fs < 0) {
        if (Math.abs(fa$2) < Math.abs(fs)) {
          _mflag = mflag$1;
          _fc = fb$1;
          _fb = fa$2;
          _fa = fs;
      ...
      } else if (Math.abs(fs) < Math.abs(fb$1)) {
        _mflag = mflag$1;
        _fc = fb$1;
        _fb = fs;
        _fa = fb$1;
...
var Rootfinder$1 = /* module */[
  /* string_of_error */string_of_error,
  /* Rootfinder */Rootfinder,
  /* brent */brent
];

var gauss_hermite_coefficients_000 = /* float array */[
  0,
  0.6568095668820999044613,
  -0.6568095668820997934390,
  -1.3265570844949334805563,
  1.3265570844949330364670,
  2.0259480158257567872226,
  -2.0259480158257558990442,
  -2.7832900997816496513337,
  2.7832900997816474308877,
  3.6684708465595856630159,
  -3.6684708465595838866591
];

var gauss_hermite_coefficients_001 = /* float array */[
  0.6547592869145917315876,
  0.6609604194409607336169,
  0.6609604194409606225946,
  0.6812118810666693002887,
  0.6812118810666689672217,
  0.7219536247283847574252,
  0.7219536247283852015144,
  0.8025168688510405656800,
  0.8025168688510396775015,
  1.0065267861723647957461,
  1.0065267861723774522886
];

var gauss_hermite_coefficients = /* tuple */[
  gauss_hermite_coefficients_000,
  gauss_hermite_coefficients_001
];

var Gaussian_quadrature = /* module */[/* gauss_hermite_coefficients */gauss_hermite_coefficients];
...
var $$Math = /* module */[
  ...
  /* a5 */1.061405429,
  /* erf */erf,
  /* ugaussian_P */ugaussian_P,
  /* Rootfinder */Rootfinder$1,
  /* Gaussian_quadrature */Gaussian_quadrature
];

function $star$star(param, r) {
  var x = param[0];
  if (x) {
    return Curry._2(param[1], r, x[0]);
  } else {
    return r;
  }
}

var Infeasible = Caml_exceptions.create("Lexifi_g2pp.Optimization.Infeasible");

function f_incr(f, ncalls, x) {
  var f$1;
  try {
    f$1 = Curry._1(f, x);
  }
    ...
    if (exn === Infeasible) {
      f$1 = Pervasives.infinity;
    } else {
      throw exn;
    }
  }
  ncalls[0] = ncalls[0] + 1 | 0;
  return f$1;
}

function default_parameters(n) {
  return /* record */[
          /* np */Pervasives.min(Caml_int32.imul(10, n), 40),
          /* cr */0.9
        ];
}

function parameters(np, cr, n) {
  return $star$star(/* tuple */[
              cr,
              (function (r, cr) {
                  return /* record */[
                          /* np */r[/* np */0],
...
function optimize(param, f, lower_bounds, upper_bounds, call_back, termination) {
  var cr = param[/* cr */1];
  var np = param[/* np */0];
  var n = lower_bounds.length;
  var rng = Curry._1(Random.State[/* make */0], /* int array */[0]);
  var ncalls = [0];
  var target = termination[/* target */2];
  var maxf = termination[/* maxf */1];
  var fx = Caml_array.caml_make_vect(np, 0);
  var fx0 = [Pervasives.infinity];
  var v = $$Array.make_matrix(np, n, 0);
  var best_idx = [0];
  var x = $$Array.init(np, (function (i) {
          var x_i = $$Array.init(n, (function (j) {
                  var blo = Caml_array.caml_array_get(lower_bounds, j);
                  var db = Caml_array.caml_array_get(upper_bounds, j) - blo;
                  return blo + db * Curry._2(Random.State[/* float */8], rng, 1);
                }));
          var f$1 = f_incr(f, ncalls, x_i);
          Caml_array.caml_array_set(fx, i, f$1);
          if (f$1 < fx0[0]) {
            best_idx[0] = i;
            fx0[0] = f$1;
            Curry._2(call_back, ncalls[0], f$1);
          }
          return x_i;
        }));
  var x0 = $$Array.copy(Caml_array.caml_array_get(x, best_idx[0]));
  var recombination = function () {
    return $$Array.iteri((function (i, v_i) {
                  var f$1 = f_incr(f, ncalls, v_i);
                  if (f$1 < Caml_array.caml_array_get(fx, i)) {
                    Caml_array.caml_array_set(fx, i, f$1);
                    $$Array.blit(v_i, 0, Caml_array.caml_array_get(x, i), 0, n);
                    if (f$1 < fx0[0]) {
                      best_idx[0] = i;
                      fx0[0] = f$1;
                      Curry._2(call_back, ncalls[0], f$1);
                      return $$Array.blit(v_i, 0, x0, 0, n);
                    } else {
                      return 0;
                    }
                  } else {
  ...
  var _nb_it = termination[/* maxit */0];
  while(true) {
    var nb_it = _nb_it;
    var differential_weight = 0.5 + Curry._2(Random.State[/* float */8], rng, 0.5);
    $$Array.iteri((function(differential_weight){
        return function (i, x_i) {
          var difw = differential_weight;
          var i$1 = i;
          var x_i$1 = x_i;
          var v_i = Caml_array.caml_array_get(v, i);
          var drawn = [/* :: */[
              i$1,
              /* [] */0
            ]];
          ...
          var rand = function () {
            var res = [0];
            var adjust = function (v, drawn) {
              if (drawn) {
                var drawn$1 = drawn[0];
                if (drawn$1 <= v) {
                  return /* :: */[
                          drawn$1,
                          adjust(v + 1 | 0, drawn[1])
                        ];
                } else {
                  res[0] = v;
                  return /* :: */[
            ...
            drawn[0] = adjust(Curry._2(Random.State[/* int */4], rng, range[0]), drawn[0]);
            range[0] = range[0] - 1 | 0;
            return Caml_array.caml_array_get(x, res[0]);
          };
          var x_r1 = Curry._2(Random.State[/* float */8], rng, 1) <= 0.5 ? Caml_array.caml_array_get(x, best_idx[0]) : rand(/* () */0);
          var x_r2 = rand(/* () */0);
          var x_r3 = rand(/* () */0);
          var j0 = Curry._2(Random.State[/* int */4], rng, n);
          for(var j = 0 ,j_finish = n - 1 | 0; j <= j_finish; ++j){
            var aux = Caml_array.caml_array_get(x_r1, j) + difw * (Caml_array.caml_array_get(x_r2, j) - Caml_array.caml_array_get(x_r3, j));
            var v$1 = (j === j0 || Curry._2(Random.State[/* float */8], rng, 1) <= cr) && Caml_array.caml_array_get(lower_bounds, j) <= aux && aux <= Caml_array.caml_array_get(upper_bounds, j) ? aux : Caml_array.caml_array_get(x_i$1, j);
            Caml_array.caml_array_set(v_i, j, v$1);
          }
          return /* () */0;
        }
        }(differential_weight)), x);
    recombination(/* () */0);
    if (fx0[0] <= target) {
      return /* record */[
              /* x0 */x0,
              /* f */fx0[0],
              /* nb_feval */ncalls[0],
              /* status : Target_reached */2
            ];
    } else if (maxf < ncalls[0]) {
      return /* record */[
              /* x0 */x0,
              /* f */fx0[0],
              /* nb_feval */ncalls[0],
              /* status : Maxf_reached */1
            ];
    } else if (nb_it) {
      _nb_it = nb_it - 1 | 0;
      continue ;
...
function least_squares(absolute, feedback, max_global, parameters_of_vector, pricer, variables, quotes) {
  if (feedback) {
    Curry._1(feedback[0], "Calibrating");
  }
  var match = $$Array.fold_left((function (param, param$1) {
          var up = param[5];
          var lo = param[4];
          var x = param[3];
          var free_vars_to_vars = param[1];
          var i = param[0];
          if (param$1.tag) {
            var match = param$1[0];
            return /* tuple */[
  ...
  var x = match[3];
  var strict_subset = match[2];
  var match_000 = $$Array.of_list(List.rev(match[1]));
  var match_003 = $$Array.of_list(List.rev(match[4]));
  var match_004 = $$Array.of_list(List.rev(match[5]));
  var lower_bounds = match_003;
  var free_var_index_to_var_index = match_000;
  var parameters_of_active_vars;
  if (strict_subset !== 0) {
    var all_vars = $$Array.map((function (param) {
            if (param.tag) {
    ...
    parameters_of_active_vars = (function (x) {
        $$Array.iteri((function (i, x) {
                return Caml_array.caml_array_set(all_vars, Caml_array.caml_array_get(free_var_index_to_var_index, i), x);
              }), x);
        return Curry._1(parameters_of_vector, all_vars);
      });
  } else {
    parameters_of_active_vars = parameters_of_vector;
  }
  var m = quotes.length;
  var prices = Caml_array.caml_make_vect(m, 0);
  var norm = absolute ? (function (acc, price, quote) {
        var dif = price - quote;
        return acc + dif * dif;
      }) : (function (acc, price, quote) {
        var rel = (price - quote) / quote;
        return acc + rel * rel;
      });
  var quotes_idx = $$Array.init(quotes.length, (function (i) {
          return i;
        }));
  var distance = function (prices) {
    return $$Array.fold_left((function (acc, i) {
                  return Curry._3(norm, acc, Caml_array.caml_array_get(prices, i), Caml_array.caml_array_get(quotes, i));
                }), 0, quotes_idx);
  };
  var div = 10000 / m;
  var x$1;
  if (max_global > 0) {
    ...
    if (feedback) {
      var f = feedback[0];
      call_back = (function (evals, dist) {
          return Curry._2(Printf.kprintf(f, /* Format */[
                          /* String_literal */Block.__(11, [
                              "Global Optimizer   Evals: ",
                              /* Int */Block.__(4, [
                                  /* Int_i */3,
                          ...
                          "Global Optimizer   Evals: %5i   RMS: %12.8g%%"
                        ]), evals, Math.sqrt(dist * div));
        });
    } else {
      call_back = (function (_, _$1) {
          return /* () */0;
        });
    }
    var f$1 = function (x) {
      Curry._2(pricer, Curry._1(parameters_of_active_vars, x), prices);
      return distance(prices);
    };
    x$1 = optimize(default_parameters(lower_bounds.length), f$1, lower_bounds, match_004, call_back, /* record */[
            /* maxit */Pervasives.max_int,
            /* maxf */max_global,
            /* target */0
          ])[/* x0 */0];
  } else {
    x$1 = $$Array.of_list(List.rev(x));
  }
  var cr_parameters = Curry._1(parameters_of_active_vars, x$1);
  Curry._2(pricer, cr_parameters, prices);
  var err = distance(prices);
  return /* record */[
          /* cr_parameters */cr_parameters,
          /* cr_root_mean_squared_error */Math.sqrt(err * div),
          /* cr_quoted_prices */quotes,
          /* cr_calibrated_prices */prices
        ];
}

var Optimization = /* module */[
  /* ** */$star$star,
...
function extended_swaption_of_swaption(today, zc, param) {
  var maturity = add_years(today, param[/* swaption_maturity_in_year */0]);
  var frq;
  switch (param[/* swap_frequency */1]) {
    case 0 : 
        frq = 3;
        break;
    case 1 : 
  ...
  var nschedule = Caml_int32.div(Caml_int32.imul(12, param[/* swap_term_in_year */2]), frq);
  var swap_schedule = $$Array.init(nschedule, (function (i) {
          return /* tuple */[
                  add_months(maturity, Caml_int32.imul(i, frq)),
                  add_months(maturity, Caml_int32.imul(i + 1 | 0, frq))
                ];
        }));
  var swap_schedule$1 = $$Array.to_list(swap_schedule);
  var match = List.fold_left((function (param, param$1) {
          var tp = param$1[1];
          var tf = param$1[0];
          return /* tuple */[
                  param[0] + Curry._1(zc, tp) * act_365(tp, tf),
                  Pervasives.min(param[1], tf),
                  Pervasives.max(param[2], tp)
                ];
        }), /* tuple */[
        0,
        max_date,
  ...
  var strike = (Curry._1(zc, match[1]) - Curry._1(zc, match[2])) / match[0];
  return /* record */[
          /* maturity */maturity,
          /* strike */strike,
          /* swap_schedule */swap_schedule$1
        ];
}

function b_fun(z, tau) {
  return (1 - Math.exp(-z * tau)) / z;
}

var Sdomain = Caml_exceptions.create("Lexifi_g2pp.G2pp_calibration.Sdomain");

function bigv(param, tau) {
  var g_nu = param[/* g_nu */3];
  var g_sigma = param[/* g_sigma */2];
  var g_b = param[/* g_b */1];
  var g_a = param[/* g_a */0];
  var t = function (sigma, x) {
    var expxtau = Math.exp(-x * tau);
    var exp2xtau = expxtau * expxtau;
    return sigma * sigma / (x * x) * (tau + 2 / x * expxtau - 1 / (2 * x) * exp2xtau - 3 / (2 * x));
  };
  var t1 = t(g_sigma, g_a);
  var t2 = t(g_nu, g_b);
  var ba = b_fun(g_a, tau);
  var bb = b_fun(g_b, tau);
  var t3 = 2 * param[/* g_rho */4] * g_nu * g_sigma / (g_a * g_b) * (tau - ba - bb + b_fun(g_a + g_b, tau));
  return /* tuple */[
          t1 + t2 + t3,
          ba,
          bb
...
function bigmx(param, today, tmat, s, t) {
  var g_rho = param[/* g_rho */4];
  var g_nu = param[/* g_nu */3];
  var g_sigma = param[/* g_sigma */2];
  var g_b = param[/* g_b */1];
  var g_a = param[/* g_a */0];
  var ts = act_365(t, s);
  var tmatt = act_365(tmat, t);
  var tmat0 = act_365(tmat, today);
  var tmats = act_365(tmat, s);
  var t0 = act_365(t, today);
  var s0 = act_365(s, today);
  return (g_sigma * g_sigma / (g_a * g_a) + g_sigma * g_rho * g_nu / (g_a * g_b)) * (1 - Math.exp(-g_a * ts)) - g_sigma * g_sigma / (2 * g_a * g_a) * (Math.exp(-g_a * tmatt) - Math.exp(-g_a * (tmats + ts))) - g_rho * g_sigma * g_nu / (g_b * (g_a + g_b)) * (Math.exp(-g_b * tmatt) - Math.exp(-g_b * tmat0 - g_a * t0 + (g_a + g_b) * s0));
}

function bigmy(param, today, tmat, s, t) {
  var g_rho = param[/* g_rho */4];
  var g_nu = param[/* g_nu */3];
  var g_sigma = param[/* g_sigma */2];
  var g_b = param[/* g_b */1];
  ...
  var t0 = act_365(t, today);
  var s0 = act_365(s, today);
  return (g_nu * g_nu / (g_b * g_b) + g_sigma * g_rho * g_nu / (g_a * g_b)) * (1 - Math.exp(-g_b * ts)) - g_nu * g_nu / (2 * g_b * g_b) * (Math.exp(-g_b * tmatt) - Math.exp(-g_b * (tmats + ts))) - g_rho * g_sigma * g_nu / (g_a * (g_a + g_b)) * (Math.exp(-g_a * tmatt) - Math.exp(-g_a * tmat0 - g_b * t0 + (g_a + g_b) * s0));
}

var w_quadrature = gauss_hermite_coefficients_001;

var x_quadrature = gauss_hermite_coefficients_000;

var nquadrature = x_quadrature.length;

function pricer_of_swaption(today, zc, swaption) {
  var swaption$1 = extended_swaption_of_swaption(today, zc, swaption);
  var maturity = swaption$1[/* maturity */0];
  var strike = swaption$1[/* strike */1];
  var tmat0 = act_365(maturity, today);
  var schedulei = $$Array.of_list(swaption$1[/* swap_schedule */2]);
  var lastindex = schedulei.length - 1 | 0;
  var taui = $$Array.map((function (param) {
          return act_365(param[1], param[0]);
        }), schedulei);
  var ci = $$Array.mapi((function (i, tau) {
          if (i === lastindex) {
            return 1 + tau * strike;
          } else {
            return tau * strike;
  ...
  var n_schedi = schedulei.length;
  var bai = Caml_array.caml_make_vect(n_schedi, 0);
  var bbi = Caml_array.caml_make_vect(n_schedi, 0);
  var aici = Caml_array.caml_make_vect(n_schedi, 0);
  var log_aici = Caml_array.caml_make_vect(n_schedi, 0);
  var scales = Caml_array.caml_make_vect(n_schedi, 0);
  var t1_cst = Caml_array.caml_make_vect(n_schedi, 0);
  var scale = Caml_array.caml_make_vect(n_schedi, 0);
  return (function (params) {
      var g_nu = params[/* g_nu */3];
      var g_sigma = params[/* g_sigma */2];
      var g_b = params[/* g_b */1];
      var g_a = params[/* g_a */0];
      var match = bigv(params, act_365(maturity, today));
      var v0_mat = match[0];
      var zc_mat = Curry._1(zc, maturity);
      var a_fun = function (end_date) {
        var match = bigv(params, act_365(end_date, today));
        var match$1 = bigv(params, act_365(end_date, maturity));
        return /* tuple */[
                Curry._1(zc, end_date) / zc_mat * Math.exp(0.5 * (match$1[0] - match[0] + v0_mat)),
                match$1[1],
                match$1[2]
              ];
      };
      var sigmax = g_sigma * Math.sqrt(b_fun(2 * g_a, tmat0));
      var sigmay = g_nu * Math.sqrt(b_fun(2 * g_b, tmat0));
      var rhoxy = params[/* g_rho */4] * g_sigma * g_nu / (sigmax * sigmay) * b_fun(g_a + g_b, tmat0);
      var rhoxyc = 1 - rhoxy * rhoxy;
      var rhoxycs = Math.sqrt(rhoxyc);
      var t2 = rhoxy / (sigmax * rhoxycs);
      var sigmay_rhoxycs = sigmay * rhoxycs;
      var t4 = rhoxy * sigmay / sigmax;
      var mux = -bigmx(params, today, maturity, today, maturity);
      var muy = -bigmy(params, today, maturity, today, maturity);
      for(var i = 0 ,i_finish = n_schedi - 1 | 0; i <= i_finish; ++i){
        var match$1 = a_fun(Caml_array.caml_array_get(schedulei, i)[1]);
        var bb = match$1[2];
        var ba = match$1[1];
        var x = Caml_array.caml_array_get(ci, i) * match$1[0];
        var log_ac = Math.log(x);
        Caml_array.caml_array_set(aici, i, x);
        Caml_array.caml_array_set(log_aici, i, log_ac);
        Caml_array.caml_array_set(bai, i, ba);
        Caml_array.caml_array_set(bbi, i, bb);
        var t3 = muy - 0.5 * rhoxyc * sigmay * sigmay * bb;
        var cst = bb * (mux * t4 - t3);
        Caml_array.caml_array_set(t1_cst, i, x * Math.exp(cst));
        Caml_array.caml_array_set(scale, i, -(ba + bb * t4));
      }
      var exact_yhat = function (x) {
        var lo = Pervasives.neg_infinity;
        var up = 0;
        for(var i = 0 ,i_finish = n_schedi - 1 | 0; i <= i_finish; ++i){
          var baix = Caml_array.caml_array_get(bai, i) * x;
          lo = Pervasives.max(lo, (Caml_array.caml_array_get(log_aici, i) - baix) / Caml_array.caml_array_get(bbi, i));
          up += (Caml_array.caml_array_get(aici, i) * Math.exp(-baix));
        }
        var lo$1 = lo;
        var s_up = up;
        if (n_schedi === 1) {
          ...
          var log_s = Math.log(s_up);
          var tmp = log_s / Caml_array.caml_array_get(bbi, n_schedi - 1 | 0);
          var up$1;
          if (tmp <= 0) {
            up$1 = tmp;
          } else {
            var tmp$1 = log_s / Caml_array.caml_array_get(bbi, 0);
            up$1 = 0 <= tmp$1 ? tmp$1 : Pervasives.neg_infinity;
          }
          var yl = lo$1 - 1e-5;
          var yu = up$1 + 1e-5;
          var y0 = sigmay * (rhoxy * (x - mux) / sigmax + -3.71901648545568 * rhoxycs) - rhoxyc / g_b + muy;
          var y1 = sigmay * (rhoxy * (x - mux) / sigmax - -3.71901648545568 * rhoxycs) + muy;
          if (y1 <= yl) {
            return y1 + 1;
          } else if (yu <= y0) {
            return y0 - 1;
            ...
            try {
              for(var i$1 = 0 ,i_finish$1 = n_schedi - 1 | 0; i$1 <= i_finish$1; ++i$1){
                Caml_array.caml_array_set(scales, i$1, Caml_array.caml_array_get(aici, i$1) * Math.exp(-Caml_array.caml_array_get(bai, i$1) * x));
              }
              var to_solve = function (yhat) {
                var sum = -1;
                for(var i = 0 ,i_finish = n_schedi - 1 | 0; i <= i_finish; ++i){
                  sum += (Caml_array.caml_array_get(scales, i) * Math.exp(-Caml_array.caml_array_get(bbi, i) * yhat));
                }
                if (sum !== sum) {
                  throw [
                        Caml_builtin_exceptions.assert_failure,
              ...
              return brent(Pervasives.max(yl, y0), Pervasives.min(yu, y1), to_solve, 1e-4);
            }
            catch (raw_exn){
              var exn = Js_exn.internalToOCamlException(raw_exn);
              if (exn[0] === Rootfinder) {
      ...
      var eps = 0.5 * sigmax;
      var f = exact_yhat(mux);
      var df = 0.5 * (exact_yhat(mux + eps) - exact_yhat(mux - eps)) / eps;
      var yhat = function (x) {
        return f + df * (x - mux);
      };
      var integrand = function (x) {
        var t1 = Math.exp(-0.5 * Math.pow((x - mux) / sigmax, 2));
        var yhat$1 = yhat(x);
        var t1$1 = (yhat$1 - muy) / sigmay_rhoxycs;
        var h1 = t1$1 - t2 * (x - mux);
        var t2$1 = ugaussian_P(-h1);
        var acc = 0;
        for(var i = 0 ,i_finish = n_schedi - 1 | 0; i <= i_finish; ++i){
          var h2 = h1 + Caml_array.caml_array_get(bbi, i) * sigmay_rhoxycs;
          acc += (Caml_array.caml_array_get(t1_cst, i) * Math.exp(Caml_array.caml_array_get(scale, i) * x) * ugaussian_P(-h2));
        }
        return t1 * (t2$1 - acc);
      };
      var sqrt2sigmax = Math.sqrt(2) * sigmax;
      var sum = 0;
      for(var i$1 = 0 ,i_finish$1 = nquadrature - 1 | 0; i$1 <= i_finish$1; ++i$1){
        sum += (Caml_array.caml_array_get(w_quadrature, i$1) * integrand(sqrt2sigmax * Caml_array.caml_array_get(x_quadrature, i$1) + mux));
      }
      var integral = sum / Math.sqrt(pi);
      return zc_mat * integral;
    });
}

function black_price(today, zc, swaption, vol) {
  var swaption$1 = extended_swaption_of_swaption(today, zc, swaption);
  var strike = swaption$1[/* strike */1];
  var sqrtt = act_365(swaption$1[/* maturity */0], today);
  var match = List.fold_left((function (param, param$1) {
          var tp = param$1[1];
          var tf = param$1[0];
          return /* tuple */[
        ...
        max_date,
        min_date
      ], swaption$1[/* swap_schedule */2]);
  var lvl = match[0];
  var s0 = (Curry._1(zc, match[1]) - Curry._1(zc, match[2])) / lvl;
  var d1 = Math.log(s0 / strike) / (vol * sqrtt) + 0.5 * vol * sqrtt;
  var d2 = d1 - vol * sqrtt;
  return lvl * (s0 * ugaussian_P(d1) - strike * ugaussian_P(d2));
}

function calibrate(feedback, max_global, today, swaption_quotes, variables, zc, _) {
  ...
  var quotes = $$Array.map((function (param) {
          return black_price(today, zc, param[0], param[1]);
        }), swaption_quotes);
  var parameters_of_vector = function (x) {
    var g_a = Caml_array.caml_array_get(x, 0);
    var g_b = Caml_array.caml_array_get(x, 1);
    var g_sigma = Caml_array.caml_array_get(x, 2);
    var g_nu = Caml_array.caml_array_get(x, 3);
    var g_rho = Caml_array.caml_array_get(x, 4);
    return /* float array */[
            g_a,
            g_b,
            g_sigma,
  ...
  var pricers = $$Array.map((function (param) {
          return pricer_of_swaption(today, zc, param[0]);
        }), swaption_quotes);
  var pricer = function (params, h) {
    try {
      for(var i = 0 ,i_finish = pricers.length - 1 | 0; i <= i_finish; ++i){
        Caml_array.caml_array_set(h, i, Curry._1(Caml_array.caml_array_get(pricers, i), params));
      }
      return /* () */0;
    }
    catch (exn){
  ...
  return least_squares(/* None */0, feedback, max_global, parameters_of_vector, pricer, variables, quotes);
}

var G2pp_calibration = /* module */[
  /* pi */pi,
  /* extended_swaption_of_swaption */extended_swaption_of_swaption,
  /* b_fun */b_fun,
  /* Sdomain */Sdomain,
  /* bigv */bigv,
  /* bigmx */bigmx,
  /* bigmy */bigmy,
  /* x_quadrature */x_quadrature,
  /* w_quadrature */w_quadrature,
  /* nquadrature */nquadrature,
  /* pricer_of_swaption */pricer_of_swaption,
  /* black_price */black_price,
  /* calibrate */calibrate
];

var swaption_quotes = Caml_obj.caml_obj_dup(/* array */[
      /* tuple */[
        /* record */[
          /* swaption_maturity_in_year */1,
          /* swap_frequency : Freq_6M */1,
          /* swap_term_in_year */1
        ],
        1.052
      ],
...
var named_variables = Caml_obj.caml_obj_dup(/* array */[
      /* tuple */[
        "a",
        /* Optimize_value */Block.__(1, [/* float array */[
              0,
              1,
              0.02
            ]])
...
var variables = $$Array.map((function (prim) {
        return prim[1];
      }), named_variables);

var today = of_string("2012-01-01");

function zc(t) {
  return Math.exp(-0.03 * act_365(t, today));
}
...
var match = calibrate(/* Some */[Pervasives.print_endline], 2000, today, swaption_quotes, variables, zc, /* () */0);

var params = match[/* cr_parameters */0];

var l = $$Array.to_list(swaption_quotes);

var rms = List.fold_left((function (acc, param) {
        var swaption = param[0];
        var g2pp_price = pricer_of_swaption(today, zc, swaption)(params);
        var market_price = black_price(today, zc, swaption, param[1]);
        Curry._4(Printf.printf(/* Format */[
                  ...
                  "%dY%dY Swaption Calibrated Price: %.2f Market Price: %.2f\n"
                ]), swaption[/* swaption_maturity_in_year */0], swaption[/* swap_term_in_year */2], 10000 * g2pp_price, 10000 * market_price);
        var x = (g2pp_price - market_price) / market_price;
        return acc + x * x;
      }), 0, l);

var rms$1 = 100 * Math.sqrt(rms / List.length(l));
...
Curry._5(Printf.printf(/* Format */[
          ...
          "a = %.5f, b = %.5f, sigma = %.5f, nu = %.5f, rho = %.5f\n"
        ]), params[/* g_a */0], params[/* g_b */1], params[/* g_sigma */2], params[/* g_nu */3], params[/* g_rho */4]);
...
Curry._2(Printf.printf(/* Format */[
          ...
          "RMS = %.5f%%, re calculated RMS = %.5f%%\n"
        ]), match[/* cr_root_mean_squared_error */1], rms$1);

try {
  var fn = Caml_sys.caml_sys_getenv("OCAML_GC_STATS");
  Gc.print_stat(Pervasives.open_out(fn));
}
catch (exn){
...
exports.G2pp_calibration = G2pp_calibration;
exports.swaption_quotes  = swaption_quotes;
exports.named_variables  = named_variables;
exports.variables        = variables;
exports.r                = r;
exports.today            = today;
exports.zc               = zc;
exports.sq               = sq;
/* max_date Not a pure module */
...
var Curry   = __webpack_require__(1);
var Printf  = __webpack_require__(19);
var Caml_gc = __webpack_require__(31);
...
var Caml_sys                = __webpack_require__(10);
var Nativeint               = __webpack_require__(37);
var Caml_array              = __webpack_require__(11);
var Caml_int64              = __webpack_require__(15);
var Pervasives              = __webpack_require__(4);
var Caml_string             = __webpack_require__(2);
