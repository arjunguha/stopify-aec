...
"use strict";
function _interopRequireWildcard(r){if(r&&r.__esModule)return r;var e={};if(null!=r)for(var a in r)Object.prototype.hasOwnProperty.call(r,a)&&(e[a]=r[a]);return e.default=r,e}Object.defineProperty(exports,"__esModule",{value:!0}),exports.map=exports.for_each=exports.andmap=exports.ormap=exports.__rjs_quoted__=void 0;var _core=__webpack_require__(8),$rjs_core=_interopRequireWildcard(_core),_kernelRkt=__webpack_require__(25),M0=_interopRequireWildcard(_kernelRkt),cl306=function(r,e){if(M0.procedure_p(r)){if(M0.procedure_arity_includes_p(r,1))a=M0.list_p(e);else var a=!1;l=a}else var l=!1;if(l)c=function e(a){if(M0.null_p(a))c=M0.rnull;else var l=M0.cdr(a),c=M0.cons(r(M0.car(a)),e(l));return c}(e);else var c=M0.map(r,e);return c},cl307=function(r,e,a){if(M0.procedure_p(r)){if(M0.procedure_arity_includes_p(r,2)){if(M0.list_p(e)){if(M0.list_p(a))l=M0._eq_(M0.length(e),M0.length(a));else var l=!1;c=l}else var c=!1;t=c}else var t=!1;i=t}else var i=!1;if(i)n=function e(a,l){if(M0.null_p(a))i=M0.rnull;else var c=M0.cdr(a),t=M0.cdr(l),i=M0.cons(r(M0.car(a),M0.car(l)),e(c,t));return i}(e,a);else var n=M0.map(r,e,a);return n},cl308=$rjs_core.attachProcedureArity(function(r,e){var a=$rjs_core.Pair.listFromArray($rjs_core.argumentsSlice($rjs_core.argumentsToArray(arguments),2));return M0.apply(M0.map,r,e,a)}),map650=$rjs_core.attachProcedureArity(function(){var r={2:cl306,3:cl307}[arguments.length];if(void 0!==r)return r.apply(null,arguments);if(M0._gt__eq_(cl308.length,1))e=cl308.apply(null,arguments);else var e=M0.error("case-lambda: invalid case");return e},[M0.make_arity_at_least(2)]),map2=map650,cl321=function(r,e){if(M0.procedure_p(r)){if(M0.procedure_arity_includes_p(r,1))a=M0.list_p(e);else var a=!1;l=a}else var l=!1;if(l)c=function e(a){if(M0.null_p(a))c=M0.rvoid();else{var l=M0.cdr(a);r(M0.car(a));var c=e(l)}return c}(e);else var c=M0.for_each(r,e);return c},cl322=function(r,e,a){if(M0.procedure_p(r)){if(M0.procedure_arity_includes_p(r,2)){if(M0.list_p(e)){if(M0.list_p(a))l=M0._eq_(M0.length(e),M0.length(a));else var l=!1;c=l}else var c=!1;t=c}else var t=!1;i=t}else var i=!1;if(i)n=function e(a,l){if(M0.null_p(a))i=M0.rvoid();else{var c=M0.cdr(a),t=M0.cdr(l);r(M0.car(a),M0.car(l));var i=e(c,t)}return i}(e,a);else var n=M0.for_each(r,e,a);return n},cl323=$rjs_core.attachProcedureArity(function(r,e){var a=$rjs_core.Pair.listFromArray($rjs_core.argumentsSlice($rjs_core.argumentsToArray(arguments),2));return M0.apply(M0.for_each,r,e,a)}),for_each667=$rjs_core.attachProcedureArity(function(){var r={2:cl321,3:cl322}[arguments.length];if(void 0!==r)return r.apply(null,arguments);if(M0._gt__eq_(cl323.length,1))e=cl323.apply(null,arguments);else var e=M0.error("case-lambda: invalid case");return e},[M0.make_arity_at_least(2)]),for_each2=for_each667,cl336=function(r,e){if(M0.procedure_p(r)){if(M0.procedure_arity_includes_p(r,1))a=M0.list_p(e);else var a=!1;l=a}else var l=!1;if(l){if(M0.null_p(e))c=!0;else var c=function e(a){if(M0.null_p(M0.cdr(a)))t=r(M0.car(a));else{var l=M0.cdr(a);if(r(M0.car(a)))c=e(l);else var c=!1;var t=c}return t}(e);t=c}else var t=M0.andmap(r,e);return t},cl337=function(r,e,a){if(M0.procedure_p(r)){if(M0.procedure_arity_includes_p(r,2)){if(M0.list_p(e)){if(M0.list_p(a))l=M0._eq_(M0.length(e),M0.length(a));else var l=!1;c=l}else var c=!1;t=c}else var t=!1;i=t}else var i=!1;if(i){if(M0.null_p(e))n=!0;else var n=function e(a,l){if(M0.null_p(M0.cdr(a)))n=r(M0.car(a),M0.car(l));else{var c=M0.cdr(a),t=M0.cdr(l);if(r(M0.car(a),M0.car(l)))i=e(c,t);else var i=!1;var n=i}return n}(e,a);_=n}else var _=M0.andmap(r,e,a);return _},cl338=$rjs_core.attachProcedureArity(function(r,e){var a=$rjs_core.Pair.listFromArray($rjs_core.argumentsSlice($rjs_core.argumentsToArray(arguments),2));return M0.apply(M0.andmap,r,e,a)}),andmap684=$rjs_core.attachProcedureArity(function(){var r={2:cl336,3:cl337}[arguments.length];if(void 0!==r)return r.apply(null,arguments);if(M0._gt__eq_(cl338.length,1))e=cl338.apply(null,arguments);else var e=M0.error("case-lambda: invalid case");return e},[M0.make_arity_at_least(2)]),andmap2=andmap684,cl355=function(r,e){if(M0.procedure_p(r)){if(M0.procedure_arity_includes_p(r,1))a=M0.list_p(e);else var a=!1;l=a}else var l=!1;if(l){if(M0.null_p(e))c=!1;else var c=function e(a){if(M0.null_p(M0.cdr(a)))i=r(M0.car(a));else{var l=M0.cdr(a),c=r(M0.car(a));if(c)t=c;else var t=e(l);var i=t}return i}(e);t=c}else var t=M0.ormap(r,e);return t},cl356=function(r,e,a){if(M0.procedure_p(r)){if(M0.procedure_arity_includes_p(r,2)){if(M0.list_p(e)){if(M0.list_p(a))l=M0._eq_(M0.length(e),M0.length(a));else var l=!1;c=l}else var c=!1;t=c}else var t=!1;i=t}else var i=!1;if(i){if(M0.null_p(e))n=!1;else var n=function e(a,l){if(M0.null_p(M0.cdr(a)))_=r(M0.car(a),M0.car(l));else{var c=M0.cdr(a),t=M0.cdr(l),i=r(M0.car(a),M0.car(l));if(i)n=i;else var n=e(c,t);var _=n}return _}(e,a);_=n}else var _=M0.ormap(r,e,a);return _},cl357=$rjs_core.attachProcedureArity(function(r,e){var a=$rjs_core.Pair.listFromArray($rjs_core.argumentsSlice($rjs_core.argumentsToArray(arguments),2));return M0.apply(M0.ormap,r,e,a)}),ormap701=$rjs_core.attachProcedureArity(function(){var r={2:cl355,3:cl356}[arguments.length];if(void 0!==r)return r.apply(null,arguments);if(M0._gt__eq_(cl357.length,1))e=cl357.apply(null,arguments);else var e=M0.error("case-lambda: invalid case");return e},[M0.make_arity_at_least(2)]),ormap2=ormap701,__rjs_quoted__={};exports.__rjs_quoted__=__rjs_quoted__,exports.ormap=ormap2,exports.andmap=andmap2,exports.for_each=for_each2,exports.map=map2;
...
"use strict";
function _interopRequireWildcard(r){if(r&&r.__esModule)return r;var e={};if(null!=r)for(var t in r)Object.prototype.hasOwnProperty.call(r,t)&&(e[t]=r[t]);return e.default=r,e}Object.defineProperty(exports,"__esModule",{value:!0}),exports.__rjs_quoted__=void 0;var _core=__webpack_require__(8),$rjs_core=_interopRequireWildcard(_core),_mlistRkt=__webpack_require__(66),M0=_interopRequireWildcard(_mlistRkt),_kernelRkt=__webpack_require__(25),M1=_interopRequireWildcard(_kernelRkt),_mainRkt=__webpack_require__(87),M2=_interopRequireWildcard(_mainRkt),destruc_iters=50,time=function(r){M1.values();return r},run_bench=function(r,e,t,n){M1.values();return function r(t,i){M1.values();if(M1._lt_(t,e))_=r(t+1,n());else var _=i;return _}(0,M1.mcons($rjs_core.Symbol.make("undefined"),M1.rnull))},run_benchmark=$rjs_core.attachProcedureArity(function(r,e,t,n){var i=$rjs_core.Pair.listFromArray($rjs_core.argumentsSlice($rjs_core.argumentsToArray(arguments),4)),_=M0.list__gt_mlist(i);M1.values();M1.newline();var a=M2.apply(n,_),u=time(run_bench(r,e,t,a));M1.values();if(M1.not(t(u))){M2.display("*** wrong result ***"),M1.newline(),M2.display("*** got: "),M2.display(u);s=M1.newline()}else{M2.display("OK");var s=M1.newline()}return s}),append_to_tail_bang_=function(r,e){M1.values();if(M1.null_p(r))t=e;else var t=function t(n,i){M1.values();if(M1.null_p(i))M1.set_mcdr_bang_(n,e),_=r;else var _=t(i,M1.mcdr(i));return _}(r,M1.mcdr(r));return t},destructive=function(r,e){M1.values();var t=function r(e,t){if(M1._eq_(e,0))M1.rvoid(),n=t;else var n=r(e-1,M1.mcons($rjs_core.Pair.Empty,t));return n}(10,$rjs_core.Pair.Empty);M1.values();return function r(n){if(M1._eq_(n,0))M1.rvoid(),i=t;else{M1.null_p(M1.mcar(t))?function r(t){if(M1.null_p(t))i=M1.rvoid();else{M1.null_p(M1.mcar(t))?M1.set_mcar_bang_(t,M1.mcons($rjs_core.Pair.Empty,$rjs_core.Pair.Empty)):M1.rvoid();var n=M1.mcar(t);append_to_tail_bang_(n,function r(e,t){if(M1._eq_(e,0))M1.rvoid(),n=t;else var n=r(e-1,M1.mcons($rjs_core.Pair.Empty,t));return n}(e,$rjs_core.Pair.Empty));var i=r(M1.mcdr(t))}return i}(t):function r(e,t){if(M1.null_p(t))u=M1.rvoid();else{var i=function r(e,t){if(M1.zero_p(e))M1.rvoid(),i=t;else{M1.set_mcar_bang_(t,n);var i=r(e-1,M1.mcdr(t))}return i}(M1.quotient(M0.mlength(M1.mcar(t)),2),M1.mcar(t)),_=M1.quotient(M0.mlength(M1.mcar(e)),2);if(M1.values(),M1._eq_(_,0))M1.set_mcar_bang_(e,$rjs_core.Pair.Empty),a=M1.mcar(e);else var a=function r(e,t){if(M1._eq_(e,1)){M1.rvoid();var i=M1.mcdr(t);M1.values(),M1.set_mcdr_bang_(t,$rjs_core.Pair.Empty),_=i}else{M1.set_mcar_bang_(t,n);var _=r(e-1,M1.mcdr(t))}return _}(_,M1.mcar(e));M1.set_mcdr_bang_(i,a);var u=r(M1.mcdr(e),M1.mcdr(t))}return u}(t,M1.mcdr(t));var i=r(n-1)}return i}(r)},main=$rjs_core.attachProcedureArity(function(){var r=$rjs_core.Pair.listFromArray($rjs_core.argumentsToArray(arguments));M0.list__gt_mlist(r),M1.values();return run_benchmark("destruc",destruc_iters,function(r){M1.values();return!0},function(r,e){M1.values();return function(){M1.values();return destructive(r,e)}},600,50)});main();var __rjs_quoted__={};exports.__rjs_quoted__=__rjs_quoted__;
