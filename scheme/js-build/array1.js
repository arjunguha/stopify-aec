...
var go;
var BgL_myzd2tryzd2;
var BgL_createzd2yzd2;
var BgL_createzd2xzd2;
...
BgL_createzd2xzd2 = function(n) {
    var i;
    var result;
    result = sc_makeVector(n);
    i = 0;
    while (!(i >= n)) {
      result[i] = i;
      ++i;
...
BgL_myzd2tryzd2 = function(n) {
    return BgL_createzd2yzd2(BgL_createzd2xzd2(n)).length;
  };
go = function(n) {
    var repeat;
    var result;
...
main = function() {
    ...
    return BgL_runzd2benchmarkzd2("array1", 5, function(result) {
              return sc_isEqual(result, 200000);
            }, function(n) {
              return function() {
                      return go(n);
                    };
