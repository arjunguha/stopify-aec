(function() {
            ...
            case 3:
                {
                    ...
                    var a$11 = $thiz.display1__AO();$thiz.display1$und$eq__AO__V($f_sci_VectorPointer__copyOf__AO__AO($thiz, a$11));$thiz.display3__AO().set(31 & (index >>> 15 | 0), $thiz.display2__AO());$thiz.display2__AO().set(31 & (index >>> 10 | 0), $thiz.display1__AO());$thiz.display1__AO().set(31 & (index >>> 5 | 0), $thiz.display0__AO());
                    break
                }
            case 2:
                {
                    var a$12 = $thiz.display2__AO();$thiz.display2$und$eq__AO__V($f_sci_VectorPointer__copyOf__AO__AO($thiz, a$12));
                    var a$13 = $thiz.display1__AO();$thiz.display1$und$eq__AO__V($f_sci_VectorPointer__copyOf__AO__AO($thiz, a$13));$thiz.display2__AO().set(31 & (index >>> 10 | 0), $thiz.display1__AO());$thiz.display1__AO().set(31 & (index >>> 5 | 0), $thiz.display0__AO());
                    break
                }
            case 1:
                {
                    var a$14 = $thiz.display1__AO();$thiz.display1$und$eq__AO__V($f_sci_VectorPointer__copyOf__AO__AO($thiz, a$14));$thiz.display1__AO().set(31 & (index >>> 5 | 0), $thiz.display0__AO());
                    break
                }
            case 0:
                {
    ...
    function $c_LNBodySystem() {
        $c_O.call(this)
    }
    $c_LNBodySystem.prototype = new $h_O;
    $c_LNBodySystem.prototype.constructor = $c_LNBodySystem;

    function $h_LNBodySystem() {}
    $h_LNBodySystem.prototype = $c_LNBodySystem.prototype;
    $c_LNBodySystem.prototype.energy__D = function() {
        var elem$1 = 0;
        elem$1 = 0;
        var end = this.bodies$2.u.length;
        var isEmpty$4 = end <= 0;
        ...
        if (!isEmpty$4) {
            ...
            while (true) {
                var v1 = i;
                elem$1 = elem$1 + 0.5 * this.bodies$2.get(v1).mass$1 * this.bodies$2.get(v1).speedSq__D();
                var x = 1 + v1 | 0;
                var end$1 = this.bodies$2.u.length;
                var isEmpty$4$1 = x >= end$1;
                var scala$collection$immutable$Range$$lastElement$4$1 = -1 + end$1 | 0;
                if (!isEmpty$4$1) {
                    var i$1 = x;
                    while (true) {
                        var v1$1 = i$1;
                        var dx = this.bodies$2.get(v1).x$1 - this.bodies$2.get(v1$1).x$1;
                        var dy = this.bodies$2.get(v1).y$1 - this.bodies$2.get(v1$1).y$1;
                        var dz = this.bodies$2.get(v1).z$1 - this.bodies$2.get(v1$1).z$1;
                        var x$1 = dx * dx + dy * dy + dz * dz;
                        var distance = $uD($g.Math.sqrt(x$1));
                        elem$1 = elem$1 - this.bodies$2.get(v1).mass$1 * this.bodies$2.get(v1$1).mass$1 / distance;
    ...
    $c_LNBodySystem.prototype.advance__D__V = function(dt) {
        var i = 0;
        while (i < this.bodies$2.u.length) {
            var j = 1 + i | 0;
            while (j < this.bodies$2.u.length) {
                var dx = this.bodies$2.get(i).x$1 - this.bodies$2.get(j).x$1;
                var dy = this.bodies$2.get(i).y$1 - this.bodies$2.get(j).y$1;
                var dz = this.bodies$2.get(i).z$1 - this.bodies$2.get(j).z$1;
                var x = dx * dx + dy * dy + dz * dz;
                var distance = $uD($g.Math.sqrt(x));
                var mag = dt / (distance * distance * distance);
                this.bodies$2.get(i).advance__D__D__D__D__V(dx, dy, dz, -this.bodies$2.get(j).mass$1 * mag);
                this.bodies$2.get(j).advance__D__D__D__D__V(dx, dy, dz, this.bodies$2.get(i).mass$1 * mag);
                j = 1 + j | 0
            };
            i = 1 + i | 0
        };
        i = 0;
        while (i < this.bodies$2.u.length) {
            this.bodies$2.get(i).move__D__V(dt);
            i = 1 + i | 0
        }
    };

    function $c_LNBodySystem$Body() {
        $c_O.call(this);
        this.x$1 = 0;
        this.y$1 = 0;
        this.z$1 = 0;
    ...
    $c_LNBodySystem$Body.prototype = new $h_O;
    $c_LNBodySystem$Body.prototype.constructor = $c_LNBodySystem$Body;

    function $h_LNBodySystem$Body() {}
    $h_LNBodySystem$Body.prototype = $c_LNBodySystem$Body.prototype;
    $c_LNBodySystem$Body.prototype.move__D__V = function(dt) {
        this.x$1 = this.x$1 + dt * this.vx$1;
        this.y$1 = this.y$1 + dt * this.vy$1;
        this.z$1 = this.z$1 + dt * this.vz$1
    };
    $c_LNBodySystem$Body.prototype.init___LNBodySystem = function($$outer) {
        if ($$outer === null) {
    ...
    $c_LNBodySystem$Body.prototype.advance__D__D__D__D__V = function(dx, dy, dz, delta) {
        this.vx$1 = this.vx$1 + dx * delta;
        this.vy$1 = this.vy$1 + dy * delta;
        this.vz$1 = this.vz$1 + dz * delta
    };
    $c_LNBodySystem$Body.prototype.speedSq__D = function() {
        return this.vx$1 * this.vx$1 + this.vy$1 * this.vy$1 + this.vz$1 * this.vz$1
    };

    function $is_LNBodySystem$Body(obj) {
        return !!(obj && obj.$classData && obj.$classData.ancestors.LNBodySystem$Body)
    }

    function $as_LNBodySystem$Body(obj) {
        return $is_LNBodySystem$Body(obj) || obj === null ? obj : $throwClassCastException(obj, "NBodySystem$Body")
    }

    function $isArrayOf_LNBodySystem$Body(obj, depth) {
        return !!(obj && obj.$classData && obj.$classData.arrayDepth === depth && obj.$classData.arrayBase.ancestors.LNBodySystem$Body)
    }

    function $asArrayOf_LNBodySystem$Body(obj, depth) {
        return $isArrayOf_LNBodySystem$Body(obj, depth) || obj === null ? obj : $throwArrayCastException(obj, "LNBodySystem$Body;", depth)
    }
    var $d_LNBodySystem$Body = new $TypeData().initClass({
        LNBodySystem$Body: 0
    }, false, "NBodySystem$Body", {
        LNBodySystem$Body: 1,
        O: 1
    });
    $c_LNBodySystem$Body.prototype.$classData = $d_LNBodySystem$Body;
    ...
    function $c_LJovianSystem$() {
        $c_LNBodySystem.call(this);
        this.bodies$2 = null
    }
    $c_LJovianSystem$.prototype = new $h_LNBodySystem;
    $c_LJovianSystem$.prototype.constructor = $c_LJovianSystem$;

    function $h_LJovianSystem$() {}
    $h_LJovianSystem$.prototype = $c_LJovianSystem$.prototype;
    $c_LJovianSystem$.prototype.init___ = function() {
        $n_LJovianSystem$ = this;
        this.bodies$2 = this.initialValues__p2__ALNBodySystem$Body();
        return this
    };
    $c_LJovianSystem$.prototype.initialValues__p2__ALNBodySystem$Body = function() {
        var sun = new $c_LNBodySystem$Body().init___LNBodySystem(this);
        sun.mass$1 = 39.47841760435743;
        var jupiter = new $c_LNBodySystem$Body().init___LNBodySystem(this);
        jupiter.x$1 = 4.841431442464721;
        jupiter.y$1 = -1.1603200440274284;
        jupiter.z$1 = -0.10362204447112311;
        jupiter.vx$1 = 0.606326392995832;
        jupiter.vy$1 = 2.81198684491626;
        jupiter.vz$1 = -0.02521836165988763;
        jupiter.mass$1 = 0.03769367487038949;
        var saturn = new $c_LNBodySystem$Body().init___LNBodySystem(this);
        saturn.x$1 = 8.34336671824458;
        saturn.y$1 = 4.124798564124305;
        saturn.z$1 = -0.4035234171143214;
        saturn.vx$1 = -1.0107743461787924;
        saturn.vy$1 = 1.8256623712304119;
        saturn.vz$1 = 0.008415761376584154;
        saturn.mass$1 = 0.011286326131968767;
        var uranus = new $c_LNBodySystem$Body().init___LNBodySystem(this);
        uranus.x$1 = 12.894369562139131;
        uranus.y$1 = -15.111151401698631;
        uranus.z$1 = -0.22330757889265573;
        uranus.vx$1 = 1.0827910064415354;
        uranus.vy$1 = 0.8687130181696082;
        uranus.vz$1 = -0.010832637401363636;
        uranus.mass$1 = 0.0017237240570597112;
        var neptune = new $c_LNBodySystem$Body().init___LNBodySystem(this);
        neptune.x$1 = 15.379697114850917;
        neptune.y$1 = -25.919314609987964;
        neptune.z$1 = 0.17925877295037118;
        neptune.vx$1 = 0.979090732243898;
        neptune.vy$1 = 0.5946989986476762;
        neptune.vz$1 = -0.034755955504078104;
        neptune.mass$1 = 0.0020336868699246304;
        var xs = new $c_sjs_js_WrappedArray().init___sjs_js_Array([sun, jupiter, saturn, uranus, neptune]);
        var len = $uI(xs.array$6.length);
        var array = $newArrayObject($d_LNBodySystem$Body.getArrayOf(), [len]);
        var elem$1 = 0;
        elem$1 = 0;
        ...
        while (i < len$1) {
            ...
            var b = $as_LNBodySystem$Body(arg1$1);
            elem$1$1 = elem$1$1 + b.vx$1 * b.mass$1;
            elem$1$2 = elem$1$2 + b.vy$1 * b.mass$1;
            elem$1$3 = elem$1$3 + b.vz$1 * b.mass$1;
            i = 1 + i | 0
        };
        sun.vx$1 = -elem$1$1 / 39.47841760435743;
        sun.vy$1 = -elem$1$2 / 39.47841760435743;
        sun.vz$1 = -elem$1$3 / 39.47841760435743;
        return array
    };
    var $d_LJovianSystem$ = new $TypeData().initClass({
        LJovianSystem$: 0
    }, false, "JovianSystem$", {
        LJovianSystem$: 1,
        LNBodySystem: 1,
    ...
    $c_LJovianSystem$.prototype.$classData = $d_LJovianSystem$;
    var $n_LJovianSystem$ = void 0;

    function $m_LJovianSystem$() {
        if (!$n_LJovianSystem$) {
            $n_LJovianSystem$ = new $c_LJovianSystem$().init___()
        };
        return $n_LJovianSystem$
    }

    function $c_LNBody$() {
        $c_O.call(this)
    }
    $c_LNBody$.prototype = new $h_O;
    $c_LNBody$.prototype.constructor = $c_LNBody$;

    function $h_LNBody$() {}
    $h_LNBody$.prototype = $c_LNBody$.prototype;
    $c_LNBody$.prototype.init___ = function() {
        return this
    };
    $c_LNBody$.prototype.main__V = function() {
        var n = 50000000;
        var array = [$m_LJovianSystem$().energy__D()];
        var jsx$3 = $m_s_Console$();
        var this$2 = new $c_sci_StringOps().init___T("%.9f\n");
        ...
        while (i < len) {
            ...
            var elem = $f_sci_StringLike__unwrapArg__psci_StringLike__O__O(this$2, arg1);
            array$1.push(elem);
            i = 1 + i | 0
        };
        ...
        while (n > 0) {
            $m_LJovianSystem$().advance__D__V(0.01);
            n = -1 + n | 0
        };
        var array$2 = [$m_LJovianSystem$().energy__D()];
        var jsx$6 = $m_s_Console$();
        var this$17 = new $c_sci_StringOps().init___T("%.9f\n");
        ...
        while (i$2 < len$3) {
            ...
            var elem$1 = $f_sci_StringLike__unwrapArg__psci_StringLike__O__O(this$17, arg1$1);
            array$3.push(elem$1);
            i$2 = 1 + i$2 | 0
        };
        $m_s_reflect_ManifestFactory$ObjectManifest$();
        ...
        while (i$3 < end$1) {
            var jsx$4 = j$1;
            var index$3 = i$3;
            result$1.set(jsx$4, array$3[index$3]);
            i$3 = 1 + i$3 | 0;
            j$1 = 1 + j$1 | 0
        };
        jsx$6.print__O__V(jsx$5.format__T__AO__T($$this$1, result$1))
    };
    $c_LNBody$.prototype.$$js$exported$meth$main__O = function() {
        this.main__V()
    };
    $c_LNBody$.prototype.main = function() {
        return this.$$js$exported$meth$main__O()
    };
    var $d_LNBody$ = new $TypeData().initClass({
        LNBody$: 0
    }, false, "NBody$", {
        LNBody$: 1,
        O: 1,
    ...
    $c_LNBody$.prototype.$classData = $d_LNBody$;
    var $n_LNBody$ = void 0;

    function $m_LNBody$() {
        if (!$n_LNBody$) {
            $n_LNBody$ = new $c_LNBody$().init___()
        };
        return $n_LNBody$
    }
                ...
                matchEnd9: {
                    ...
                    if (!o18.isEmpty__Z()) {
                        ...
                        switch (conversion) {
                            ...
                            case 67:
                                {
                                    var c = 65535 & this.intArg$1__p1__O__I(arg);this.pad$1__p1__T__T__jl_Boolean__T__I__C__jl_Appendable($as_T($g.String.fromCharCode(c)), "", false, flags, width, conversion);
                                    break
                                }
                            case 100:
                                {
                                    var this$72 = this.numberArg$1__p1__O__D(arg);this.with$und$plus$1__p1__T__Z__T__I__C__jl_Appendable("" + this$72, false, flags, width, conversion);
                                    break
                                }
                            case 111:
                                {
                            ...
                            case 71:
                                {
                                    ...
                                    if (m >= 0.0001 && m < $uD($g.Math.pow(10, p))) {
                                        var v = $g.Math.log10;
                                        if (!(v === void 0)) {
                                        ...
                                        var sig = $uD($g.Math.pow(10, sig0)) <= m ? 1 + sig0 | 0 : sig0;
