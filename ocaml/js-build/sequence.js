...
var Caml_missing_polyfill    = __webpack_require__(13);
var Caml_builtin_exceptions  = __webpack_require__(0);
...
var Caml_array              = __webpack_require__(10);
var Pervasives              = __webpack_require__(4);
var CamlinternalLazy        = __webpack_require__(31);
var Caml_builtin_exceptions = __webpack_require__(0);
  ...
  return /* Sequence */[
          ...
          (function (param) {
              ...
              if (typeof match === "number") {
                ...
                var s = match[1];
                var match$1 = Curry._2(f, seed, match[0]);
...
function to_list(param) {
  var to_list$1 = function (_s, next, i) {
    while(true) {
      ...
      if (i) {
        ...
        return List.rev(to_list_rev(/* Sequence */[
                        s,
                        next
                      ]));
      }
  ...
  return to_list$1(param[0], param[1], 500);
}

function range($staropt$star, $staropt$star$1, $staropt$star$2, start_v, stop_v) {
...
function test_to_list(s, f, g) {
  return Caml_obj.caml_equal(to_list(Curry._1(f, s)), Curry._1(g, to_list(s)));
}
  ...
  if (l) {
    ...
    var loop = function (_i, _l) {
      while(true) {
        ...
        var i = _i;
        if (l) {
          Caml_array.caml_array_set(a, i, l[0]);
          _l = l[1];
          _i = i - 1 | 0;
          continue ;
...
function find_map(t, f) {
  ...
  while(true) {
    ...
    if (typeof match === "number") {
      ...
      var some_b = Curry._1(f$1, match[0]);
      if (some_b) {
        return some_b;
      } else {
        _s = match[1];
...
function mem($staropt$star, t, a) {
  var equal = $staropt$star ? $staropt$star[0] : Caml_obj.caml_equal;
  var _s = t[0];
  var next = t[1];
  var a$1 = a;
  while(true) {
...
function nth_exn(s, n) {
  if (n < 0) {
    ...
    if (match) {
      ...
      return Pervasives.failwith("Sequence.nth");
    }
  }
}

function merge(param, param$1, cmp) {
  var next2 = param$1[1];
  var next1 = param[1];
    ...
    if (typeof s1 === "number") {
      ...
      if (typeof s2 === "number") {
        return /* Yield */Block.__(1, [
                  a,
                  /* tuple */[
                    /* Skip */Block.__(0, [s1$prime]),
                    /* Done */0
                  ]
                ]);
      } else if (s2.tag) {
        var b = s2[0];
        if (Curry._2(cmp, a, b) <= 0) {
          return /* Yield */Block.__(1, [
                    a,
                    /* tuple */[
                      /* Skip */Block.__(0, [s1$prime]),
  ...
  return /* Sequence */[
          /* tuple */[
            /* Skip */Block.__(0, [param[0]]),
            /* Skip */Block.__(0, [param$1[0]])
          ],
          next
        ];
}
...
function hd_exn(s) {
  ...
  if (match) {
    ...
    return Pervasives.failwith("hd_exn");
  }
}
...
function tl_eagerly_exn(s) {
  ...
  if (match) {
    ...
    return Pervasives.failwith("Sequence.tl_exn");
  }
}
...
function lift_identity(next, s) {
  ...
  if (typeof match === "number") {
    ...
    return /* Skip */Block.__(0, [/* `Identity */[
                316735838,
                match[0]
              ]]);
  }
          ...
          (function (s) {
              ...
              if (typeof match === "number") {
                ...
                if (match$1) {
                  ...
                  return /* Skip */Block.__(0, [match[1]]);
                }
              } else {
                return /* Skip */Block.__(0, [match[0]]);
              }
...
function filter_mapi(s, f) {
  ...
  return filter_opt(map(s$1, (function (param) {
                    return Curry._2(f, param[0], param[1]);
                  })));
}
...
function find_exn(s, f) {
  ...
  if (match) {
    ...
    return Pervasives.failwith("Sequence.find_exn");
  }
}
...
function append(s1, s2) {
  ...
  return /* Sequence */[
          ...
          (function (param) {
              if (param[0] >= 472258093) {
                var match = Curry._1(next1, param[1]);
                if (typeof match === "number") {
                  return /* Skip */Block.__(0, [/* `Second_list */[
                              -630817751,
                              s2$1
                            ]]);
                } else if (match.tag) {
                  ...
                  return /* Skip */Block.__(0, [/* `First_list */[
                              472258093,
                              match[0]
                            ]]);
                }
              } else {
                var match$1 = Curry._1(next2, param[1]);
                if (typeof match$1 === "number") {
                  return /* Done */0;
                } else if (match$1.tag) {
                  return /* Yield */Block.__(1, [
...
function concat_mapi(s, f) {
  return bind(mapi(s, (function (i, s) {
                    return /* tuple */[
                            i,
                            s
                          ];
...
function length_is_bounded_by($staropt$star, max, t) {
  var min = $staropt$star ? $staropt$star[0] : -1;
  if (max) {
    var match = bounded_length(t, max[0]);
    if (typeof match === "number" || match[0] !== 16394 || match[1] < min) {
      return /* false */0;
    } else {
      return /* true */1;
    }
...
function reduce(s, f) {
  ...
  if (match) {
    var match$1 = match[0];
    return /* Some */[fold(match$1[1], match$1[0], f)];
  } else {
    return /* None */0;
  }
}
...
function reduce_exn(s, f) {
  ...
  if (match) {
    ...
    return Pervasives.failwith("Sequence.reduce_exn");
  }
}

function find_consecutive_duplicate(param, equal) {
  var next = param[1];
  var _last_elt = /* None */0;
  var _s = param[0];
  while(true) {
    var s = _s;
...
function remove_consecutive_duplicates(s, equal) {
  return unfold_with(s, /* None */0, (function (prev, a) {
                if (prev) {
                  if (Curry._2(equal, a, prev[0])) {
                    return /* Skip */Block.__(0, [/* Some */[a]]);
                  } else {
                    return /* Yield */Block.__(1, [
                              a,
                              /* Some */[a]
...
function sub(s, pos, len) {
  if (pos < 0 || len < 0) {
    Pervasives.failwith("Sequence.sub");
  }
  var next = s[1];
  return /* Sequence */[
          /* tuple */[
...
function take(s, len) {
  if (len < 0) {
    Pervasives.failwith("Sequence.take");
  }
  var next = s[1];
  return /* Sequence */[
          /* tuple */[
...
function drop(s, len) {
  if (len < 0) {
    Pervasives.failwith("Sequence.drop");
  }
  var next = s[1];
  return /* Sequence */[
          /* tuple */[
...
function drop_while(s, f) {
  ...
  return /* Sequence */[
          ...
          (function (param) {
              if (param[0] >= 316735838) {
                return lift_identity(next, param[1]);
              } else {
                var match = Curry._1(next, param[1]);
                if (typeof match === "number") {
                  return /* Done */0;
                  ...
                  var a = match[0];
                  if (Curry._1(f, a)) {
                    return /* Skip */Block.__(0, [/* `Dropping */[
                                -557110719,
                                s
                              ]]);
                  } else {
              ...
              if (variant !== 815032112) {
                if (variant >= 951752159) {
                  ...
                  if (typeof match === "number") {
                    ...
                    return /* Skip */Block.__(0, [/* `Running */[
                                951752159,
                                match[0]
                              ]]);
                  }
                ...
                var match$2 = Curry._1(next, param[1]);
                if (typeof match$2 === "number") {
                  return /* Done */0;
                } else if (match$2.tag) {
                  return /* Yield */Block.__(1, [
...
function cycle(s) {
  return bind(repeat(/* () */0), (function () {
                return s;
              }));
}

function cartesian_product(sa, sb) {
  return bind(sa, (function (a) {
...
function delayed_fold(s, init, f, finish) {
  var loop = function (_s, next, finish, f, acc) {
    while(true) {
      var s = _s;
      var match = Curry._1(next, s);
      if (typeof match === "number") {
        ...
        var s$1 = match[1];
        return Curry._3(f, acc, match[0], (function(s$1){
                  return function (param) {
                    return loop(s$1, next, finish, f, param);
                  }
                  }(s$1)));
      } else {
        _s = match[0];
  ...
  return loop(s[0], s[1], finish, f, init);
}
  ...
  var find_step = function (_s) {
    while(true) {
      ...
      if (typeof match === "number") {
        ...
        return /* Yield */Block.__(1, [
                  match[0],
                  /* T */[Block.__(246, [(function(s$1){
                        return function () {
                          return find_step(s$1);
                        }
                        }(s$1))])]
                ]);
      } else {
  ...
  return /* Sequence */[
          ...
          (function (param) {
              ...
              if (tag === 250) {
                ...
                return CamlinternalLazy.force_lazy_block(l);
              } else {
                return l;
              }
            })
...
function bind$1(m, f) {
  return (function (k) {
      return Curry._1(m, (function (a) {
                    var m$prime = Curry._1(f, a);
                    return Curry._1(m$prime, k);
                  }));
    });
}
...
var Sequence = /* module */[
  ...
  /* filteri */filteri,
  /* length */length,
  /* to_list_rev_with_length */to_list_rev_with_length,
  /* to_array */to_array,
  /* find */find,
  /* find_map */find_map,
  /* for_all */for_all,
  ...
  /* hd_exn */hd_exn,
  /* tl */tl,
  /* tl_eagerly_exn */tl_eagerly_exn,
  /* lift_identity */lift_identity,
  /* next */next,
  /* filter_opt */filter_opt,
  /* filter_map */filter_map,
  /* filter_mapi */filter_mapi,
  /* split_n_eagerly */split_n_eagerly,
  /* findi */findi,
  /* find_exn */find_exn,
  /* append */append,
  /* concat_map */concat_map,
  /* concat_mapi */concat_mapi,
  /* zip */zip,
  /* zip_full */zip_full,
  /* bounded_length */bounded_length,
  /* length_is_bounded_by */length_is_bounded_by,
  /* iteri */iteri,
  /* foldi */foldi,
  /* reduce */reduce,
  /* reduce_exn */reduce_exn,
  /* find_consecutive_duplicate */find_consecutive_duplicate,
  ...
  /* shift_right_with_list */shift_right_with_list,
  /* shift_left */drop,
  /* Infix */Infix,
  ...
  /* singleton */singleton,
  /* delayed_fold */delayed_fold,
  /* force_eagerly */force_eagerly,
  /* memoize */memoize,
  /* drop_eagerly */drop_eagerly,
  /* drop_while_option */drop_while_option,
  /* Generator */Generator
];

var s12345 = map(filter(of_list(/* :: */[
              1,
              /* :: */[
                2,
                /* :: */[
...
function test(f, g) {
  if (test_to_list(s12345, f, g)) {
    return test_to_list(sempty, f, g);
  } else {
    return /* false */0;
  }
}

var s = range(/* None */0, /* None */0, /* None */0, 0, 100000);

function do_stuff_1(n) {
  var s = range(/* None */0, /* None */0, /* None */0, 0, n);
  return fold(map(s, (function (x) {
                    return (x << 1);
...
function do_stuff_2(n) {
  var s = range(/* None */0, /* None */0, /* None */0, 0, n);
  return fold(filter(map(s, (function (x) {
                        return (x << 1);
                      })), (function (x) {
                    return +(x % 2 === 0);
                  })), 0, (function (prim, prim$1) {
...
exports.s12345     = s12345;
exports.sempty     = sempty;
exports.test       = test;
exports.s          = s;
exports.do_stuff_1 = do_stuff_1;
exports.do_stuff_2 = do_stuff_2;
/* s12345 Not a pure module */
...
var Block   = __webpack_require__(6);
var Curry   = __webpack_require__(1);
var Printf  = __webpack_require__(24);
var Caml_gc = __webpack_require__(30);
...
var Pervasives         = __webpack_require__(4);
var CamlinternalFormat = __webpack_require__(26);
...
var Caml_io                  = __webpack_require__(17);
var Caml_obj                 = __webpack_require__(3);
var Caml_bytes               = __webpack_require__(28);
var Caml_float               = __webpack_require__(29);
var Caml_int32               = __webpack_require__(7);
var Pervasives               = __webpack_require__(4);
var Caml_format              = __webpack_require__(18);
var Caml_string              = __webpack_require__(2);
...
var Obj             = __webpack_require__(32);
var Curry           = __webpack_require__(1);
var Caml_exceptions = __webpack_require__(5);
...
var Marshal                 = __webpack_require__(33);
var Caml_array              = __webpack_require__(10);
var Caml_missing_polyfill   = __webpack_require__(13);
var Caml_builtin_exceptions = __webpack_require__(0);
