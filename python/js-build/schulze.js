    ...
    */
	...
	(function () {
		...
		__pragma__ ('<all>')
			...
			__all__.line = line;
			__all__.lines = lines;
			__all__.memberId = memberId;
			__all__.n = n;
			__all__.numbers = numbers;
			__all__.order = order;
			__all__.p = p;
			__all__.reverseCandidates = reverseCandidates;
			__all__.row = row;
			__all__.size = size;
			__all__.v = v;
			__all__.votes = votes;
