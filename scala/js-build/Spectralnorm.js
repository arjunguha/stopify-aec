...
/** @constructor */
function $c_LSpectralNorm() {
  $c_O.call(this);
  this.n$1 = 0;
  this.A$1 = null;
  this.At$1 = null
}
$c_LSpectralNorm.prototype = new $h_O();
$c_LSpectralNorm.prototype.constructor = $c_LSpectralNorm;
/** @constructor */
function $h_LSpectralNorm() {
  /*<skip>*/
}
$h_LSpectralNorm.prototype = $c_LSpectralNorm.prototype;
$c_LSpectralNorm.prototype.approximate__D = (function() {
  var n = this.n$1;
  var elems$2 = null;
  elems$2 = [];
  var i = 0;
  ...
  var u = $makeNativeArrayWrapper($d_D.getArrayOf(), elems$2);
  var n$1 = this.n$1;
  var elems$2$1 = null;
  elems$2$1 = [];
  var i$1 = 0;
  ...
  var v = $makeNativeArrayWrapper($d_D.getArrayOf(), elems$2$1);
  var n$2 = this.n$1;
  var elems$2$2 = null;
  elems$2$2 = [];
  var i$2 = 0;
  ...
  var w = $makeNativeArrayWrapper($d_D.getArrayOf(), elems$2$2);
  var i$3 = 0;
  while ((i$3 < 10)) {
    this.mult__AD__AD__F2__V(u, w, this.A$1);
    this.mult__AD__AD__F2__V(w, v, this.At$1);
    this.mult__AD__AD__F2__V(v, w, this.A$1);
    this.mult__AD__AD__F2__V(w, u, this.At$1);
    i$3 = ((1 + i$3) | 0)
  };
  var vbv = 0.0;
  var vv = 0.0;
  i$3 = 0;
  while ((i$3 < this.n$1)) {
    vbv = (vbv + (u.get(i$3) * v.get(i$3)));
    vv = (vv + (v.get(i$3) * v.get(i$3)));
    i$3 = ((1 + i$3) | 0)
  };
  var x = (vbv / vv);
  return $uD($g.Math.sqrt(x))
});
$c_LSpectralNorm.prototype.mult__AD__AD__F2__V = (function(v, w, M) {
  var i = 0;
  while ((i < this.n$1)) {
    var s = 0.0;
    var j = 0;
    while ((j < this.n$1)) {
      ...
      var v1 = i;
      var v2 = j;
      s = (jsx$1 + ($uD(M.apply__O__O__O(v1, v2)) * v.get(j)));
      j = ((1 + j) | 0)
    };
    w.set(i, s);
    i = ((1 + i) | 0)
...
$c_LSpectralNorm.prototype.init___I = (function(n) {
  this.n$1 = n;
  this.A$1 = new $c_sjsr_AnonFunction2().init___sjs_js_Function2((function($this) {
    return (function(i$2, j$2) {
      var i = $uI(i$2);
      var j = $uI(j$2);
      return (1.0 / ((1 + (((($imul(((i + j) | 0), ((1 + ((i + j) | 0)) | 0)) / 2) | 0) + i) | 0)) | 0))
    })
  })(this));
  this.At$1 = new $c_sjsr_AnonFunction2().init___sjs_js_Function2((function(this$2) {
    return (function(j$3$2, i$3$2) {
      var j$3 = $uI(j$3$2);
      var i$3 = $uI(i$3$2);
      return (1.0 / ((1 + (((($imul(((i$3 + j$3) | 0), ((1 + ((i$3 + j$3) | 0)) | 0)) / 2) | 0) + i$3) | 0)) | 0))
    })
  })(this));
  return this
});
var $d_LSpectralNorm = new $TypeData().initClass({
  LSpectralNorm: 0
}, false, "SpectralNorm", {
  LSpectralNorm: 1,
  O: 1
});
$c_LSpectralNorm.prototype.$classData = $d_LSpectralNorm;
...
$h_Lspectralnorm$.prototype = $c_Lspectralnorm$.prototype;
$c_Lspectralnorm$.prototype.init___ = (function() {
  return this
});
...
$c_Lspectralnorm$.prototype.$classData = $d_Lspectralnorm$;
var $n_Lspectralnorm$ = (void 0);
function $m_Lspectralnorm$() {
  if ((!$n_Lspectralnorm$)) {
    $n_Lspectralnorm$ = new $c_Lspectralnorm$().init___()
  };
  return $n_Lspectralnorm$
}
/** @constructor */
function $c_jl_Class() {
  $c_O.call(this);
...
$c_sjs_js_WrappedArray.prototype.$classData = $d_sjs_js_WrappedArray;
$m_Lspectralnorm$().main__AT__V($makeNativeArrayWrapper($d_T.getArrayOf(), []));
}).call(this);
