...
var time;
var BgL_destruczd2iterszd2;
const_main = "*** wrong result ***";
BgL_destruczd2iterszd2 = 1000;
time = function(x) {
    return x;
  };
    ...
    while (!(i === 0)) {
      if (l_16.car === null) {
        ...
        while (!(l === null)) {
          ...
          while (!(j_10 === 0)) {
            --j_10;
            a_11 = new sc_Pair(null, a_11);
          }
          stmp_2 = a_11;
          BgL_appendzd2tozd2tailz12z12(l.car, stmp_2);
          l = l.cdr;
        }
      } else {
        l2_9 = l_16.cdr;
        ...
        l2 = l2_9;
        while (!(l2 === null)) {
          n_4 = parseInt(sc_length(l1.car) / 2);
          if (n_4 === 0) {
            l1.car = null;
            stmp = l1.car;
          } else {
          ...
          j_8 = parseInt(sc_length(l2.car) / 2);
          a_7 = l2.car;
          j_5 = j_8;
          a_6 = a_7;
          while (!(j_5 === 0)) {
...
main = function() {
    ...
    return BgL_runzd2benchmarkzd2("destruc", BgL_destruczd2iterszd2, function(result) {
              return true;
            }, function(n, m) {
              return function() {
                      return destructive(n, m);
                    };
            }, 600, 50);
  };
main();
