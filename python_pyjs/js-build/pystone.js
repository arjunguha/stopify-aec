...
$pyjs['loaded_modules']['main'] = function (__mod_name__) {
	...
	$m['__version__'] = '1.1';
	var $tupleassign1 = $p['__ass_unpack']($p['list']($p['range'](1, 6)), 5, null);
	$m['Ident1'] = $tupleassign1[0];
	$m['Ident2'] = $tupleassign1[1];
	$m['Ident3'] = $tupleassign1[2];
	$m['Ident4'] = $tupleassign1[3];
	$m['Ident5'] = $tupleassign1[4];
	$m['Record'] = (function(){
		var $cls_definition = new Object();
		var $method;
		$cls_definition['__module__'] = 'main';
		$method = $pyjs__bind_method2('__init__', function(PtrComp, Discr, EnumComp, IntComp, StringComp) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
				PtrComp = arguments[1];
				Discr = arguments[2];
				EnumComp = arguments[3];
				IntComp = arguments[4];
				StringComp = arguments[5];
			}
			if (typeof PtrComp == 'undefined') PtrComp=arguments['callee']['__args__'][3][1];
			if (typeof Discr == 'undefined') Discr=arguments['callee']['__args__'][4][1];
			if (typeof EnumComp == 'undefined') EnumComp=arguments['callee']['__args__'][5][1];
			if (typeof IntComp == 'undefined') IntComp=arguments['callee']['__args__'][6][1];
			if (typeof StringComp == 'undefined') StringComp=arguments['callee']['__args__'][7][1];
	...
	, 1, [null,null,['self'],['PtrComp', null],['Discr', 0],['EnumComp', 0],['IntComp', 0],['StringComp', 0]]);
		$cls_definition['__init__'] = $method;
		$method = $pyjs__bind_method2('copy', function() {
			if (this['__is_instance__'] === true) {
				var self = this;
			...
			return $m['Record']($p['getattr'](self, 'PtrComp'), $p['getattr'](self, 'Discr'), $p['getattr'](self, 'EnumComp'), $p['getattr'](self, 'IntComp'), $p['getattr'](self, 'StringComp'));
		}
	, 1, [null,null,['self']]);
		$cls_definition['copy'] = $method;
		var $bases = new Array(pyjslib['object']);
		var $data = $p['dict']();
		for (var $item in $cls_definition) { $data['__setitem__']($item, $cls_definition[$item]); }
		return $p['_create_class']('Record', $p['tuple']($bases), $data);
	})();
	$m['TRUE'] = 1;
	$m['FALSE'] = 0;
	$m['main'] = function(loops) {
		if (typeof loops == 'undefined') loops=arguments['callee']['__args__'][2][1];
		var stones,benchtime;
		var $tupleassign2 = $p['__ass_unpack']((typeof pystones == "undefined"?$m['pystones']:pystones)(loops), 2, null);
		benchtime = $tupleassign2[0];
		stones = $tupleassign2[1];
		return null;
	};
	$m['main']['__name__'] = 'main';

	$m['main']['__bind_type__'] = 0;
	$m['main']['__args__'] = [null,null,['loops', $m['LOOPS']]];
	$m['pystones'] = function(loops) {
		if (typeof loops == 'undefined') loops=arguments['callee']['__args__'][2][1];

		return (typeof Proc0 == "undefined"?$m['Proc0']:Proc0)(loops);
	};
	$m['pystones']['__name__'] = 'pystones';

	$m['pystones']['__bind_type__'] = 0;
	$m['pystones']['__args__'] = [null,null,['loops', $m['LOOPS']]];
	$m['IntGlob'] = 0;
	$m['BoolGlob'] = $m['FALSE'];
	$m['Char1Glob'] = '\x00';
	$m['Char2Glob'] = '\x00';
	$m['Array1Glob'] = (typeof ($mul1=$p['list']([0]))==typeof ($mul2=51) && typeof $mul1=='number'?
		$mul1*$mul2:
		$p['op_mul']($mul1,$mul2));
	$m['Array2Glob'] = function(){
		var $iter1_nextval,$iter1_type,$collcomp1,$iter1_iter,$iter1_idx,$mul4,$mul3,$iter1_array;
	$collcomp1 = $p['list']();
	$iter1_iter = (typeof ($mul3=$p['list']([$m['Array1Glob']]))==typeof ($mul4=51) && typeof $mul3=='number'?
		$mul3*$mul4:
		$p['op_mul']($mul3,$mul4));
	$iter1_nextval=$p['__iter_prepare']($iter1_iter,false);
	while (typeof($p['__wrapped_next']($iter1_nextval)['$nextval']) != 'undefined') {
		$m['x'] = $iter1_nextval['$nextval'];
		$collcomp1['append']($p['__getslice']($m['x'], 0, null));
	}

	return $collcomp1;}();
	$m['PtrGlb'] = null;
	$m['PtrGlbNext'] = null;
	$m['Proc0'] = function(loops) {
		if (typeof loops == 'undefined') loops=arguments['callee']['__args__'][2][1];
		var String1Loc,String2Loc,$iter3_array,$div2,loopsPerBenchtime,$div3,IntLoc2,$mul5,IntLoc3,$iter2_iter,$iter3_nextval,$sub9,$sub8,benchtime,$iter3_iter,$sub3,$sub2,$sub1,nulltime,$sub6,$sub5,$sub4,$mul8,$iter2_type,IntLoc1,$sub12,$sub11,$sub10,CharIndex,$iter2_idx,$iter3_idx,$add4,$mul9,$iter3_type,$mul7,$mul6,$div1,$div4,EnumLoc,$iter2_nextval,$mul10,i,$sub7,$add2,$add3,$add1,starttime,$iter2_array;
		starttime = $m['time']();
		$iter2_iter = $p['range'](loops);
		$iter2_nextval=$p['__iter_prepare']($iter2_iter,false);
		while (typeof($p['__wrapped_next']($iter2_nextval)['$nextval']) != 'undefined') {
			i = $iter2_nextval['$nextval'];
		}
		nulltime = $p['__op_sub']($sub1=$m['time'](),$sub2=starttime);
		$m['PtrGlbNext'] = $m['Record']();
		$m['PtrGlb'] = $m['Record']();
		$m['PtrGlb']['PtrComp'] = $m['PtrGlbNext'];
		$m['PtrGlb']['Discr'] = $m['Ident1'];
		$m['PtrGlb']['EnumComp'] = $m['Ident3'];
		$m['PtrGlb']['IntComp'] = 40;
		$m['PtrGlb']['StringComp'] = 'DHRYSTONE PROGRAM, SOME STRING';
		String1Loc = "DHRYSTONE PROGRAM, 1'ST STRING";
		$m['Array2Glob']['__getitem__'](8)['__setitem__'](7, 10);
		starttime = $m['time']();
		$iter3_iter = $p['range'](loops);
		$iter3_nextval=$p['__iter_prepare']($iter3_iter,false);
		while (typeof($p['__wrapped_next']($iter3_nextval)['$nextval']) != 'undefined') {
			i = $iter3_nextval['$nextval'];
			(typeof Proc5 == "undefined"?$m['Proc5']:Proc5)();
			(typeof Proc4 == "undefined"?$m['Proc4']:Proc4)();
			IntLoc1 = 2;
			IntLoc2 = 3;
			String2Loc = "DHRYSTONE PROGRAM, 2'ND STRING";
			EnumLoc = $m['Ident2'];
			$m['BoolGlob'] = !$p['bool']((typeof Func2 == "undefined"?$m['Func2']:Func2)(String1Loc, String2Loc));
			while ($p['bool'](($p['cmp'](IntLoc1, IntLoc2) == -1))) {
				IntLoc3 = $p['__op_sub']($sub3=(typeof ($mul5=5)==typeof ($mul6=IntLoc1) && typeof $mul5=='number'?
					$mul5*$mul6:
					$p['op_mul']($mul5,$mul6)),$sub4=IntLoc2);
				IntLoc3 = (typeof Proc7 == "undefined"?$m['Proc7']:Proc7)(IntLoc1, IntLoc2);
				IntLoc1 = $p['__op_add']($add1=IntLoc1,$add2=1);
			}
			(typeof Proc8 == "undefined"?$m['Proc8']:Proc8)($m['Array1Glob'], $m['Array2Glob'], IntLoc1, IntLoc3);
			$m['PtrGlb'] = (typeof Proc1 == "undefined"?$m['Proc1']:Proc1)($m['PtrGlb']);
			CharIndex = 'A';
			while ($p['bool'](($p['cmp'](CharIndex, $m['Char2Glob']) < 1))) {
				if ($p['bool']($p['op_eq'](EnumLoc, (typeof Func1 == "undefined"?$m['Func1']:Func1)(CharIndex, 'C')))) {
					EnumLoc = (typeof Proc6 == "undefined"?$m['Proc6']:Proc6)($m['Ident1']);
				}
				CharIndex = $p['chr']($p['__op_add']($add3=$p['ord'](CharIndex),$add4=1));
			}
			IntLoc3 = (typeof ($mul7=IntLoc2)==typeof ($mul8=IntLoc1) && typeof $mul7=='number'?
				$mul7*$mul8:
				$p['op_mul']($mul7,$mul8));
			IntLoc2 = (typeof ($div1=IntLoc3)==typeof ($div2=IntLoc1) && typeof $div1=='number' && $div2 !== 0?
				$div1/$div2:
				$p['op_div']($div1,$div2));
			IntLoc2 = $p['__op_sub']($sub7=(typeof ($mul9=7)==typeof ($mul10=$p['__op_sub']($sub5=IntLoc3,$sub6=IntLoc2)) && typeof $mul9=='number'?
				$mul9*$mul10:
				$p['op_mul']($mul9,$mul10)),$sub8=IntLoc1);
			IntLoc1 = (typeof Proc2 == "undefined"?$m['Proc2']:Proc2)(IntLoc1);
		}
		benchtime = $p['__op_sub']($sub11=$p['__op_sub']($sub9=$m['time'](),$sub10=starttime),$sub12=nulltime);
		if ($p['bool']($p['op_eq'](benchtime, 0.0))) {
			loopsPerBenchtime = 0.0;
		}
		else {
			loopsPerBenchtime = (typeof ($div3=loops)==typeof ($div4=benchtime) && typeof $div3=='number' && $div4 !== 0?
				$div3/$div4:
				$p['op_div']($div3,$div4));
		}
		return $p['tuple']([benchtime, loopsPerBenchtime]);
	};
	$m['Proc0']['__name__'] = 'Proc0';

	$m['Proc0']['__bind_type__'] = 0;
	$m['Proc0']['__args__'] = [null,null,['loops', $m['LOOPS']]];
	$m['Proc1'] = function(PtrParIn) {
		var $assign1,NextRecord;
		$assign1 = $m['PtrGlb']['copy']();
		PtrParIn['PtrComp'] = $assign1;
		NextRecord = $assign1;
		PtrParIn['IntComp'] = 5;
		NextRecord['IntComp'] = $p['getattr'](PtrParIn, 'IntComp');
		NextRecord['PtrComp'] = $p['getattr'](PtrParIn, 'PtrComp');
		NextRecord['PtrComp'] = (typeof Proc3 == "undefined"?$m['Proc3']:Proc3)($p['getattr'](NextRecord, 'PtrComp'));
		if ($p['bool']($p['op_eq']($p['getattr'](NextRecord, 'Discr'), $m['Ident1']))) {
			NextRecord['IntComp'] = 6;
			NextRecord['EnumComp'] = (typeof Proc6 == "undefined"?$m['Proc6']:Proc6)($p['getattr'](PtrParIn, 'EnumComp'));
			NextRecord['PtrComp'] = $p['getattr']($m['PtrGlb'], 'PtrComp');
			NextRecord['IntComp'] = (typeof Proc7 == "undefined"?$m['Proc7']:Proc7)($p['getattr'](NextRecord, 'IntComp'), 10);
		}
		else {
	...
	$m['Proc1']['__name__'] = 'Proc1';

	$m['Proc1']['__bind_type__'] = 0;
	$m['Proc1']['__args__'] = [null,null,['PtrParIn']];
	$m['Proc2'] = function(IntParIO) {
		var EnumLoc,$sub16,$sub15,$sub14,$sub13,$add6,$add5,IntLoc;
		IntLoc = $p['__op_add']($add5=IntParIO,$add6=10);
		while ($p['bool'](1)) {
			if ($p['bool']($p['op_eq']($m['Char1Glob'], 'A'))) {
				IntLoc = $p['__op_sub']($sub13=IntLoc,$sub14=1);
				IntParIO = $p['__op_sub']($sub15=IntLoc,$sub16=$m['IntGlob']);
				EnumLoc = $m['Ident1'];
			}
			if ($p['bool']($p['op_eq'](EnumLoc, $m['Ident1']))) {
				break;
			}
		}
		return IntParIO;
	};
	$m['Proc2']['__name__'] = 'Proc2';

	$m['Proc2']['__bind_type__'] = 0;
	$m['Proc2']['__args__'] = [null,null,['IntParIO']];
	$m['Proc3'] = function(PtrParOut) {

		if ($p['bool'](($m['PtrGlb'] !== null))) {
			PtrParOut = $p['getattr']($m['PtrGlb'], 'PtrComp');
		}
		else {
			$m['IntGlob'] = 100;
		}
		$m['PtrGlb']['IntComp'] = (typeof Proc7 == "undefined"?$m['Proc7']:Proc7)(10, $m['IntGlob']);
		return PtrParOut;
	};
	$m['Proc3']['__name__'] = 'Proc3';

	$m['Proc3']['__bind_type__'] = 0;
	$m['Proc3']['__args__'] = [null,null,['PtrParOut']];
	$m['Proc4'] = function() {
		var $or1,BoolLoc,$or2;
		BoolLoc = $p['op_eq']($m['Char1Glob'], 'A');
		BoolLoc = ($p['bool']($or1=BoolLoc)?$or1:$m['BoolGlob']);
		$m['Char2Glob'] = 'B';
		return null;
	};
	$m['Proc4']['__name__'] = 'Proc4';

	$m['Proc4']['__bind_type__'] = 0;
	$m['Proc4']['__args__'] = [null,null];
	$m['Proc5'] = function() {
	...
	$m['Proc5']['__name__'] = 'Proc5';

	$m['Proc5']['__bind_type__'] = 0;
	$m['Proc5']['__args__'] = [null,null];
	$m['Proc6'] = function(EnumParIn) {
		var EnumParOut;
		EnumParOut = EnumParIn;
		if ($p['bool'](!$p['bool']((typeof Func3 == "undefined"?$m['Func3']:Func3)(EnumParIn)))) {
			EnumParOut = $m['Ident4'];
		}
		if ($p['bool']($p['op_eq'](EnumParIn, $m['Ident1']))) {
			EnumParOut = $m['Ident1'];
		}
		else if ($p['bool']($p['op_eq'](EnumParIn, $m['Ident2']))) {
			if ($p['bool'](($p['cmp']($m['IntGlob'], 100) == 1))) {
				EnumParOut = $m['Ident1'];
			}
			else {
				EnumParOut = $m['Ident4'];
		...
		else if ($p['bool']($p['op_eq'](EnumParIn, $m['Ident3']))) {
			EnumParOut = $m['Ident2'];
		}
		else if ($p['bool']($p['op_eq'](EnumParIn, $m['Ident4']))) {
		}
		else if ($p['bool']($p['op_eq'](EnumParIn, $m['Ident5']))) {
			EnumParOut = $m['Ident3'];
		}
		return EnumParOut;
	};
	$m['Proc6']['__name__'] = 'Proc6';

	$m['Proc6']['__bind_type__'] = 0;
	$m['Proc6']['__args__'] = [null,null,['EnumParIn']];
	$m['Proc7'] = function(IntParI1, IntParI2) {
		var IntParOut,$add10,$add8,$add9,IntLoc,$add7;
		IntLoc = $p['__op_add']($add7=IntParI1,$add8=2);
		IntParOut = $p['__op_add']($add9=IntParI2,$add10=IntLoc);
		return IntParOut;
	};
	$m['Proc7']['__name__'] = 'Proc7';

	$m['Proc7']['__bind_type__'] = 0;
	$m['Proc7']['__args__'] = [null,null,['IntParI1'],['IntParI2']];
	$m['Proc8'] = function(Array1Par, Array2Par, IntParI1, IntParI2) {
		var $sub20,IntIndex,$iter4_type,$iter4_iter,$add21,$add20,$add22,IntLoc,$sub19,$sub18,$sub17,$add14,$add15,$add16,$add17,$add11,$add12,$add13,$add18,$add19,$iter4_nextval,$iter4_idx,$iter4_array;
		IntLoc = $p['__op_add']($add11=IntParI1,$add12=5);
		Array1Par['__setitem__'](IntLoc, IntParI2);
		Array1Par['__setitem__']($p['__op_add']($add13=IntLoc,$add14=1), Array1Par['__getitem__'](IntLoc));
		Array1Par['__setitem__']($p['__op_add']($add15=IntLoc,$add16=30), IntLoc);
		$iter4_iter = $p['range'](IntLoc, $p['__op_add']($add17=IntLoc,$add18=2));
		$iter4_nextval=$p['__iter_prepare']($iter4_iter,false);
		while (typeof($p['__wrapped_next']($iter4_nextval)['$nextval']) != 'undefined') {
			IntIndex = $iter4_nextval['$nextval'];
			Array2Par['__getitem__'](IntLoc)['__setitem__'](IntIndex, IntLoc);
		}
		Array2Par['__getitem__'](IntLoc)['__setitem__']($p['__op_sub']($sub19=IntLoc,$sub20=1), $p['__op_add']($add19=Array2Par['__getitem__'](IntLoc)['__getitem__']($p['__op_sub']($sub17=IntLoc,$sub18=1)),$add20=1));
		Array2Par['__getitem__']($p['__op_add']($add21=IntLoc,$add22=20))['__setitem__'](IntLoc, Array1Par['__getitem__'](IntLoc));
		$m['IntGlob'] = 5;
		return null;
	};
	$m['Proc8']['__name__'] = 'Proc8';

	$m['Proc8']['__bind_type__'] = 0;
	$m['Proc8']['__args__'] = [null,null,['Array1Par'],['Array2Par'],['IntParI1'],['IntParI2']];
	$m['Func1'] = function(CharPar1, CharPar2) {
		var CharLoc2,CharLoc1;
		CharLoc1 = CharPar1;
		CharLoc2 = CharLoc1;
		if ($p['bool'](!$p['op_eq'](CharLoc2, CharPar2))) {
			return $m['Ident1'];
		}
		else {
			return $m['Ident2'];
	...
	$m['Func1']['__name__'] = 'Func1';

	$m['Func1']['__bind_type__'] = 0;
	$m['Func1']['__args__'] = [null,null,['CharPar1'],['CharPar2']];
	$m['Func2'] = function(StrParI1, StrParI2) {
		var $add28,$and1,$add23,$add25,$add24,$add27,$add26,$and2,CharLoc,IntLoc;
		IntLoc = 1;
		while ($p['bool'](($p['cmp'](IntLoc, 1) < 1))) {
			if ($p['bool']($p['op_eq']($m['Func1'](StrParI1['__getitem__'](IntLoc), StrParI2['__getitem__']($p['__op_add']($add23=IntLoc,$add24=1))), $m['Ident1']))) {
				CharLoc = 'A';
				IntLoc = $p['__op_add']($add25=IntLoc,$add26=1);
			}
		}
		if ($p['bool'](($p['bool']($and1=((($p['cmp'](CharLoc, 'W'))|1) == 1))?($p['cmp'](CharLoc, 'Z') < 1):$and1))) {
			IntLoc = 7;
		}
		if ($p['bool']($p['op_eq'](CharLoc, 'X'))) {
			return $m['TRUE'];
		}
		else {
			if ($p['bool'](($p['cmp'](StrParI1, StrParI2) == 1))) {
				IntLoc = $p['__op_add']($add27=IntLoc,$add28=7);
				return $m['TRUE'];
			}
			else {
				return $m['FALSE'];
	...
	$m['Func2']['__name__'] = 'Func2';

	$m['Func2']['__bind_type__'] = 0;
	$m['Func2']['__args__'] = [null,null,['StrParI1'],['StrParI2']];
	$m['Func3'] = function(EnumParIn) {
		var EnumLoc;
		EnumLoc = EnumParIn;
		if ($p['bool']($p['op_eq'](EnumLoc, $m['Ident3']))) {
			return $m['TRUE'];
		}
		return $m['FALSE'];
	};
	$m['Func3']['__name__'] = 'Func3';

	$m['Func3']['__bind_type__'] = 0;
	$m['Func3']['__args__'] = [null,null,['EnumParIn']];
	$m['main']($m['LOOPS']);
	return this;
}; /* end main */
