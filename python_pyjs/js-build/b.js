...
$pyjs['loaded_modules']['main'] = function (__mod_name__) {
	...
	$collcomp1 = $p['list']();
	$iter1_iter = $p['range'](1000);
	$iter1_nextval=$p['__iter_prepare']($iter1_iter,false);
	while (typeof($p['__wrapped_next']($iter1_nextval)['$nextval']) != 'undefined') {
		$m['i'] = $iter1_nextval['$nextval'];
		$collcomp1['append']($p['list']($p['range'](1000)));
	}
	...
	$m['a'] = (function(){
		...
		$method = $pyjs__bind_method2('main', function(table) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			var $iter2_nextval,$iter2_type,_buffer,$iter2_iter,column,$iter3_array,$iter2_idx,$iter3_idx,$iter3_iter,$iter3_type,_buffer_write,$iter3_nextval,$iter2_array,row;
			_buffer = $p['list']([]);
			_buffer_write = function(str) {

				_buffer['append'](str);
				return null;
			};
			_buffer_write['__name__'] = '_buffer_write';

			_buffer_write['__bind_type__'] = 0;
			_buffer_write['__args__'] = [null,null,['str']];
	...
	, 1, [null,null,['self'],['table']]);
		$cls_definition['main'] = $method;
		var $bases = new Array($p['object']);
		var $data = $p['dict']();
		for (var $item in $cls_definition) { $data['__setitem__']($item, $cls_definition[$item]); }
		return $p['_create_class']('a', $p['tuple']($bases), $data);
	})();
	$m['r'] = $m['a']()['main']($m['table']);
	if ($p['bool'](!$p['op_eq'](12901045, $p['len']($m['r'])))) {
		throw ($p['Exception']('Bad result'));
	}
	return this;
}; /* end main */
