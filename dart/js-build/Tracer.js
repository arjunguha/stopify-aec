...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
  ...
  }], ["", "../benchmark-files/Tracer/Tracer.dart",, D, {
    "^": "",
    main: function() {
  ...
  }, 1], ["ray_trace", "../benchmark-files/Tracer/default/renderscene.dart",, D, {
    "^": "",
    Color: {
    ...
    Engine: {
      ...
      rayTrace$4: function(info, ray, scene, depth) {
        var t1, t2, result, shininess, t3, t4, t5, color, i, t6, light, t7, t8, t9, t10, t11, m, t12, t13, t14, $L, t15, t16, reflectionRay, refl, shadowInfo, dB, m0, glossWeight;
        t1 = info.color;
        ...
        for (t1 = depth <= this.rayDepth, t2 = ray.direction, t3 = t2.x, t4 = t2.y, t2 = t2.z, t5 = depth + 1, color = result, i = 0; t6 = scene.lights, i < t6.length; ++i) {
          ...
          if ($L > 0) {
            t15 = info.color;
            t16 = light.color;
            color = new D.Color(color.red + t15.red * (t16.red * $L), color.green + t15.green * (t16.green * $L), color.blue + t15.blue * (t16.blue * $L));
          }
          if (t1) {
            t15 = info.shape;
            t16 = t15.material;
            if (t16.reflection > 0) {
              t16 = 2 * -(t13 * t3 + t14 * t4 + t12 * t2);
              reflectionRay = new D.Ray(info.position, new D.Vector(t3 + t13 * t16, t4 + t14 * t16, t2 + t12 * t16));
          ...
          if (t7) {
            ...
            m = Math.sqrt(t8 * t8 + t10 * t10 + t6 * t6);
            t9 = info.normal;
            glossWeight = Math.pow(Math.max(t9.x * (t8 / m) + t9.y * (t10 / m) + t9.z * (t6 / m), 0), shininess);
            t6 = light.color;
    ...
    Vector: {
      ...
      $sub: function(_, w) {
        return new D.Vector(this.x - w.x, this.y - w.y, this.z - w.z);
      },
