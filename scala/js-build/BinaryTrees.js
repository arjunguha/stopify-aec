...
$c_LTree.prototype = new $h_O();
$c_LTree.prototype.constructor = $c_LTree;
/** @constructor */
function $h_LTree() {
  /*<skip>*/
}
$h_LTree.prototype = $c_LTree.prototype;
$c_LTree.prototype.init___LTree__LTree = (function(left, right) {
  this.left$1 = left;
  this.right$1 = right;
  return this
});
$c_LTree.prototype.isum__I = (function() {
  var tl = this.left$1;
  return ((tl === null) ? 1 : ((((1 + tl.isum__I()) | 0) + this.right$1.isum__I()) | 0))
});
var $d_LTree = new $TypeData().initClass({
  LTree: 0
}, false, "Tree", {
  LTree: 1,
  O: 1
});
$c_LTree.prototype.$classData = $d_LTree;
/** @constructor */
function $c_LTree$() {
  $c_O.call(this)
}
...
$h_LTree$.prototype = $c_LTree$.prototype;
$c_LTree$.prototype.init___ = (function() {
  return this
});
$c_LTree$.prototype.apply__I__LTree = (function(depth) {
  return ((depth > 0) ? new $c_LTree().init___LTree__LTree($m_LTree$().apply__I__LTree((((-1) + depth) | 0)), $m_LTree$().apply__I__LTree((((-1) + depth) | 0))) : new $c_LTree().init___LTree__LTree(null, null))
});
var $d_LTree$ = new $TypeData().initClass({
  LTree$: 0
}, false, "Tree$", {
...
function $m_LTree$() {
  if ((!$n_LTree$)) {
    $n_LTree$ = new $c_LTree$().init___()
  };
  return $n_LTree$
}
/** @constructor */
function $c_Lbinarytrees$() {
  $c_O.call(this)
}
$c_Lbinarytrees$.prototype = new $h_O();
$c_Lbinarytrees$.prototype.constructor = $c_Lbinarytrees$;
/** @constructor */
function $h_Lbinarytrees$() {
  /*<skip>*/
}
$h_Lbinarytrees$.prototype = $c_Lbinarytrees$.prototype;
$c_Lbinarytrees$.prototype.init___ = (function() {
  return this
});
$c_Lbinarytrees$.prototype.print$1__p1__T__I__I__V = (function(name, depth, check) {
  var x = ((((name + " of depth ") + depth) + "\t check: ") + check);
...
$c_Lbinarytrees$.prototype.main__AT__V = (function(args) {
  ...
  while ((depth <= 19)) {
    ...
    while ((i < iterations)) {
      i = ((1 + i) | 0);
      sum = ((sum + $m_LTree$().apply__I__LTree(depth).isum__I()) | 0)
    };
...
$c_Lbinarytrees$.prototype.$classData = $d_Lbinarytrees$;
var $n_Lbinarytrees$ = (void 0);
function $m_Lbinarytrees$() {
  if ((!$n_Lbinarytrees$)) {
    $n_Lbinarytrees$ = new $c_Lbinarytrees$().init___()
  };
  return $n_Lbinarytrees$
}
/** @constructor */
function $c_jl_Class() {
  $c_O.call(this);
...
$m_Lbinarytrees$().main__AT__V($makeNativeArrayWrapper($d_T.getArrayOf(), []));
}).call(this);
