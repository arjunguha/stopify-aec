...
var Caml_array = __webpack_require__(23);
...
var Char                    = __webpack_require__(14);
...
function pretty_rule() {
  return /* () */0;
}

function pretty_rules(rules) {
  return List.iter(pretty_rule, rules);
}
...
function deletion_message() {
  return /* () */0;
}

function non_orientable() {
  return /* () */0;
}
...
function kb_complete(greater, complete_rules, rules) {
  ...
  return List.iter(pretty_rule, rules$1);
}
...
for(var i = 1; i <= 20; ++i){
  kb_complete(greater, /* [] */0, geom_rules);
}
...
var Pervasives         = __webpack_require__(4);
var CamlinternalFormat = __webpack_require__(27);
