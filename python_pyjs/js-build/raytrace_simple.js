...
$pyjs['loaded_modules']['main'] = function (__mod_name__) {
	...
	$m['Vector'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function(initx, inity, initz) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
	...
	, 1, [null,null,['self'],['initx'],['inity'],['initz']]);
		$cls_definition['__init__'] = $method;
		$method = $pyjs__bind_method2('__str__', function() {
			if (this['__is_instance__'] === true) {
				var self = this;
			...
			return $p['sprintf']('(%s,%s,%s)', $p['tuple']([$p['getattr'](self, 'x'), $p['getattr'](self, 'y'), $p['getattr'](self, 'z')]));
		}
	, 1, [null,null,['self']]);
		$cls_definition['__str__'] = $method;
		$method = $pyjs__bind_method2('__repr__', function() {
			...
			return $p['sprintf']('Vector(%s,%s,%s)', $p['tuple']([$p['getattr'](self, 'x'), $p['getattr'](self, 'y'), $p['getattr'](self, 'z')]));
		}
	, 1, [null,null,['self']]);
		$cls_definition['__repr__'] = $method;
		$method = $pyjs__bind_method2('magnitude', function() {
			...
			return $m['math']['sqrt'](self['dot'](self));
		}
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('__add__', function(other) {
			...
			var $add9,$add12,$add2,$add3,$add6,$add7,$add4,$add5,$add10,$add8,$add1,$add11;
			if ($p['bool'](other['isPoint']())) {
				return (typeof Point == "undefined"?$m['Point']:Point)($p['__op_add']($add1=$p['getattr'](self, 'x'),$add2=$p['getattr'](other, 'x')), $p['__op_add']($add3=$p['getattr'](self, 'y'),$add4=$p['getattr'](other, 'y')), $p['__op_add']($add5=$p['getattr'](self, 'z'),$add6=$p['getattr'](other, 'z')));
			}
			else {
				return $m['Vector']($p['__op_add']($add7=$p['getattr'](self, 'x'),$add8=$p['getattr'](other, 'x')), $p['__op_add']($add9=$p['getattr'](self, 'y'),$add10=$p['getattr'](other, 'y')), $p['__op_add']($add11=$p['getattr'](self, 'z'),$add12=$p['getattr'](other, 'z')));
			}
			return null;
		}
	, 1, [null,null,['self'],['other']]);
		...
		$method = $pyjs__bind_method2('__sub__', function(other) {
			...
			var $sub3,$sub2,$sub1,$sub6,$sub5,$sub4;
			other['mustBeVector']();
			return $m['Vector']($p['__op_sub']($sub1=$p['getattr'](self, 'x'),$sub2=$p['getattr'](other, 'x')), $p['__op_sub']($sub3=$p['getattr'](self, 'y'),$sub4=$p['getattr'](other, 'y')), $p['__op_sub']($sub5=$p['getattr'](self, 'z'),$sub6=$p['getattr'](other, 'z')));
		}
	, 1, [null,null,['self'],['other']]);
		$cls_definition['__sub__'] = $method;
		$method = $pyjs__bind_method2('scale', function(factor) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			var $mul6,$mul5,$mul4,$mul3,$mul2,$mul1;
			return $m['Vector']((typeof ($mul1=factor)==typeof ($mul2=$p['getattr'](self, 'x')) && typeof $mul1=='number'?
				$mul1*$mul2:
				$p['op_mul']($mul1,$mul2)), (typeof ($mul3=factor)==typeof ($mul4=$p['getattr'](self, 'y')) && typeof $mul3=='number'?
				$mul3*$mul4:
				$p['op_mul']($mul3,$mul4)), (typeof ($mul5=factor)==typeof ($mul6=$p['getattr'](self, 'z')) && typeof $mul5=='number'?
				$mul5*$mul6:
				$p['op_mul']($mul5,$mul6)));
		}
	, 1, [null,null,['self'],['factor']]);
		$cls_definition['scale'] = $method;
		$method = $pyjs__bind_method2('dot', function(other) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			var $mul12,$mul11,$mul10,$add13,$add14,$add15,$add16,$mul9,$mul8,$mul7;
			other['mustBeVector']();
			return $p['__op_add']($add15=$p['__op_add']($add13=(typeof ($mul7=$p['getattr'](self, 'x'))==typeof ($mul8=$p['getattr'](other, 'x')) && typeof $mul7=='number'?
				$mul7*$mul8:
				$p['op_mul']($mul7,$mul8)),$add14=(typeof ($mul9=$p['getattr'](self, 'y'))==typeof ($mul10=$p['getattr'](other, 'y')) && typeof $mul9=='number'?
				$mul9*$mul10:
				$p['op_mul']($mul9,$mul10))),$add16=(typeof ($mul11=$p['getattr'](self, 'z'))==typeof ($mul12=$p['getattr'](other, 'z')) && typeof $mul11=='number'?
				$mul11*$mul12:
				$p['op_mul']($mul11,$mul12)));
		}
	, 1, [null,null,['self'],['other']]);
		$cls_definition['dot'] = $method;
		$method = $pyjs__bind_method2('cross', function(other) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			var $mul17,$mul16,$mul15,$mul14,$mul13,$mul22,$sub10,$mul19,$mul18,$mul23,$sub9,$sub12,$sub11,$mul24,$sub7,$sub8,$mul20,$mul21;
			other['mustBeVector']();
			return $m['Vector']($p['__op_sub']($sub7=(typeof ($mul13=$p['getattr'](self, 'y'))==typeof ($mul14=$p['getattr'](other, 'z')) && typeof $mul13=='number'?
				$mul13*$mul14:
				$p['op_mul']($mul13,$mul14)),$sub8=(typeof ($mul15=$p['getattr'](self, 'z'))==typeof ($mul16=$p['getattr'](other, 'y')) && typeof $mul15=='number'?
				$mul15*$mul16:
				$p['op_mul']($mul15,$mul16))), $p['__op_sub']($sub9=(typeof ($mul17=$p['getattr'](self, 'z'))==typeof ($mul18=$p['getattr'](other, 'x')) && typeof $mul17=='number'?
				$mul17*$mul18:
				$p['op_mul']($mul17,$mul18)),$sub10=(typeof ($mul19=$p['getattr'](self, 'x'))==typeof ($mul20=$p['getattr'](other, 'z')) && typeof $mul19=='number'?
				$mul19*$mul20:
				$p['op_mul']($mul19,$mul20))), $p['__op_sub']($sub11=(typeof ($mul21=$p['getattr'](self, 'x'))==typeof ($mul22=$p['getattr'](other, 'y')) && typeof $mul21=='number'?
				$mul21*$mul22:
				$p['op_mul']($mul21,$mul22)),$sub12=(typeof ($mul23=$p['getattr'](self, 'y'))==typeof ($mul24=$p['getattr'](other, 'x')) && typeof $mul23=='number'?
				$mul23*$mul24:
				$p['op_mul']($mul23,$mul24))));
		}
	, 1, [null,null,['self'],['other']]);
		$cls_definition['cross'] = $method;
		$method = $pyjs__bind_method2('normalized', function() {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			var $div2,$div1;
			return self['scale']((typeof ($div1=1.0)==typeof ($div2=self['magnitude']()) && typeof $div1=='number' && $div2 !== 0?
				$div1/$div2:
				$p['op_div']($div1,$div2)));
		}
	, 1, [null,null,['self']]);
		$cls_definition['normalized'] = $method;
		$method = $pyjs__bind_method2('negated', function() {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			return self['scale']((typeof ($usub1=1)=='number'?
				-$usub1:
				$p['op_usub']($usub1)));
		}
	, 1, [null,null,['self']]);
		$cls_definition['negated'] = $method;
		$method = $pyjs__bind_method2('__eq__', function(other) {
			...
			var $and1,$and2,$and3;
			return ($p['bool']($and1=$p['op_eq']($p['getattr'](self, 'x'), $p['getattr'](other, 'x')))?($p['bool']($and2=$p['op_eq']($p['getattr'](self, 'y'), $p['getattr'](other, 'y')))?$p['op_eq']($p['getattr'](self, 'z'), $p['getattr'](other, 'z')):$and2):$and1);
		}
	, 1, [null,null,['self'],['other']]);
		$cls_definition['__eq__'] = $method;
		$method = $pyjs__bind_method2('isVector', function() {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
	...
	, 1, [null,null,['self']]);
		$cls_definition['isVector'] = $method;
		$method = $pyjs__bind_method2('isPoint', function() {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
	...
	, 1, [null,null,['self']]);
		$cls_definition['isPoint'] = $method;
		$method = $pyjs__bind_method2('mustBeVector', function() {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
	...
	, 1, [null,null,['self']]);
		$cls_definition['mustBeVector'] = $method;
		$method = $pyjs__bind_method2('mustBePoint', function() {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			throw ('Vectors are not points!');
			return null;
		}
	, 1, [null,null,['self']]);
		$cls_definition['mustBePoint'] = $method;
		$method = $pyjs__bind_method2('reflectThrough', function(normal) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			return $p['__op_sub']($sub13=self,$sub14=d['scale'](2));
		}
	, 1, [null,null,['self'],['normal']]);
		$cls_definition['reflectThrough'] = $method;
		var $bases = new Array($p['object']);
		var $data = $p['dict']();
		for (var $item in $cls_definition) { $data['__setitem__']($item, $cls_definition[$item]); }
		return $p['_create_class']('Vector', $p['tuple']($bases), $data);
	})();
	$m['Vector']['ZERO'] = $m['Vector'](0, 0, 0);
	$m['Vector']['RIGHT'] = $m['Vector'](1, 0, 0);
	$m['Vector']['UP'] = $m['Vector'](0, 1, 0);
	$m['Vector']['OUT'] = $m['Vector'](0, 0, 1);
	if (!( $p['op_eq']($m['Vector']['RIGHT']['reflectThrough']($p['getattr']($m['Vector'], 'UP')), $p['getattr']($m['Vector'], 'RIGHT')) )) {
	   throw $p['AssertionError']();
	 }
	if (!( $p['op_eq']($m['Vector']((typeof ($usub2=1)=='number'?
		-$usub2:
		$p['op_usub']($usub2)), (typeof ($usub3=1)=='number'?
		-$usub3:
		$p['op_usub']($usub3)), 0)['reflectThrough']($p['getattr']($m['Vector'], 'UP')), $m['Vector']((typeof ($usub4=1)=='number'?
		-$usub4:
		$p['op_usub']($usub4)), 1, 0)) )) {
	   throw $p['AssertionError']();
	 }
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('__repr__', function() {
			...
			return $p['sprintf']('Point(%s,%s,%s)', $p['tuple']([$p['getattr'](self, 'x'), $p['getattr'](self, 'y'), $p['getattr'](self, 'z')]));
		}
	, 1, [null,null,['self']]);
		$cls_definition['__repr__'] = $method;
		$method = $pyjs__bind_method2('__add__', function(other) {
			...
			var $add21,$add20,$add22,$add18,$add19,$add17;
			other['mustBeVector']();
			return $m['Point']($p['__op_add']($add17=$p['getattr'](self, 'x'),$add18=$p['getattr'](other, 'x')), $p['__op_add']($add19=$p['getattr'](self, 'y'),$add20=$p['getattr'](other, 'y')), $p['__op_add']($add21=$p['getattr'](self, 'z'),$add22=$p['getattr'](other, 'z')));
		}
	, 1, [null,null,['self'],['other']]);
		$cls_definition['__add__'] = $method;
		$method = $pyjs__bind_method2('__sub__', function(other) {
			...
			var $sub22,$sub23,$sub19,$sub18,$sub26,$sub24,$sub25,$sub17,$sub16,$sub15,$sub21,$sub20;
			if ($p['bool'](other['isPoint']())) {
				return $m['Vector']($p['__op_sub']($sub15=$p['getattr'](self, 'x'),$sub16=$p['getattr'](other, 'x')), $p['__op_sub']($sub17=$p['getattr'](self, 'y'),$sub18=$p['getattr'](other, 'y')), $p['__op_sub']($sub19=$p['getattr'](self, 'z'),$sub20=$p['getattr'](other, 'z')));
			}
			else {
				return $m['Point']($p['__op_sub']($sub21=$p['getattr'](self, 'x'),$sub22=$p['getattr'](other, 'x')), $p['__op_sub']($sub23=$p['getattr'](self, 'y'),$sub24=$p['getattr'](other, 'y')), $p['__op_sub']($sub25=$p['getattr'](self, 'z'),$sub26=$p['getattr'](other, 'z')));
			}
			return null;
		}
	, 1, [null,null,['self'],['other']]);
	...
	$m['Sphere'] = (function(){
		...
		var $method;
		$cls_definition['__module__'] = 'main';
		$method = $pyjs__bind_method2('__init__', function(centre, radius) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
	...
	, 1, [null,null,['self'],['centre'],['radius']]);
		$cls_definition['__init__'] = $method;
		$method = $pyjs__bind_method2('__repr__', function() {
			if (this['__is_instance__'] === true) {
				var self = this;
			...
			return $p['sprintf']('Sphere(%s,%s)', $p['tuple']([$p['repr']($p['getattr'](self, 'centre')), $p['getattr'](self, 'radius')]));
		}
	, 1, [null,null,['self']]);
		$cls_definition['__repr__'] = $method;
		$method = $pyjs__bind_method2('intersectionTime', function(ray) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			var $sub31,$sub30,$sub33,$mul25,$sub27,discriminant,$sub28,$sub29,$sub32,$mul28,v,$mul26,$mul27,cp,$sub34;
			cp = $p['__op_sub']($sub27=$p['getattr'](self, 'centre'),$sub28=$p['getattr'](ray, 'point'));
			v = cp['dot']($p['getattr'](ray, 'vector'));
			discriminant = $p['__op_sub']($sub31=(typeof ($mul25=$p['getattr'](self, 'radius'))==typeof ($mul26=$p['getattr'](self, 'radius')) && typeof $mul25=='number'?
				$mul25*$mul26:
				$p['op_mul']($mul25,$mul26)),$sub32=$p['__op_sub']($sub29=cp['dot'](cp),$sub30=(typeof ($mul27=v)==typeof ($mul28=v) && typeof $mul27=='number'?
				$mul27*$mul28:
				$p['op_mul']($mul27,$mul28))));
			if ($p['bool'](($p['cmp'](discriminant, 0) == -1))) {
				return null;
			}
			else {
				return $p['__op_sub']($sub33=v,$sub34=$m['math']['sqrt'](discriminant));
			}
			return null;
		}
	, 1, [null,null,['self'],['ray']]);
		$cls_definition['intersectionTime'] = $method;
		$method = $pyjs__bind_method2('normalAt', function(p) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			var $sub35,$sub36;
			return $p['__op_sub']($sub35=p,$sub36=$p['getattr'](self, 'centre'))['normalized']();
		}
	, 1, [null,null,['self'],['p']]);
		$cls_definition['normalAt'] = $method;
		var $bases = new Array($p['object']);
		var $data = $p['dict']();
		for (var $item in $cls_definition) { $data['__setitem__']($item, $cls_definition[$item]); }
		return $p['_create_class']('Sphere', $p['tuple']($bases), $data);
	})();
	$m['Halfspace'] = (function(){
		var $cls_definition = new Object();
		var $method;
		$cls_definition['__module__'] = 'main';
		$method = $pyjs__bind_method2('__init__', function(point, normal) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
	...
	, 1, [null,null,['self'],['point'],['normal']]);
		...
		$method = $pyjs__bind_method2('__repr__', function() {
			...
			return $p['sprintf']('Halfspace(%s,%s)', $p['tuple']([$p['repr']($p['getattr'](self, 'point')), $p['repr']($p['getattr'](self, 'normal'))]));
		}
	, 1, [null,null,['self']]);
		$cls_definition['__repr__'] = $method;
		$method = $pyjs__bind_method2('intersectionTime', function(ray) {
			...
			var $div3,v,$div4;
			v = ray['vector']['dot']($p['getattr'](self, 'normal'));
			if ($p['bool'](v)) {
				return (typeof ($div3=1)==typeof ($div4=(typeof ($usub5=v)=='number'?
					-$usub5:
					$p['op_usub']($usub5))) && typeof $div3=='number' && $div4 !== 0?
					$div3/$div4:
					$p['op_div']($div3,$div4));
			}
			else {
	...
	, 1, [null,null,['self'],['p']]);
		...
		var $data = $p['dict']();
		for (var $item in $cls_definition) { $data['__setitem__']($item, $cls_definition[$item]); }
		return $p['_create_class']('Halfspace', $p['tuple']($bases), $data);
	})();
	$m['Ray'] = (function(){
		var $cls_definition = new Object();
		var $method;
		$cls_definition['__module__'] = 'main';
		$method = $pyjs__bind_method2('__init__', function(point, vector) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
	...
	, 1, [null,null,['self'],['point'],['vector']]);
		...
		$method = $pyjs__bind_method2('__repr__', function() {
			...
			return $p['sprintf']('Ray(%s,%s)', $p['tuple']([$p['repr']($p['getattr'](self, 'point')), $p['repr']($p['getattr'](self, 'vector'))]));
		}
	, 1, [null,null,['self']]);
		$cls_definition['__repr__'] = $method;
		$method = $pyjs__bind_method2('pointAtTime', function(t) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			var $add24,$add23;
			return $p['__op_add']($add23=$p['getattr'](self, 'point'),$add24=self['vector']['scale'](t));
		}
	, 1, [null,null,['self'],['t']]);
		$cls_definition['pointAtTime'] = $method;
		var $bases = new Array($p['object']);
		var $data = $p['dict']();
		for (var $item in $cls_definition) { $data['__setitem__']($item, $cls_definition[$item]); }
		return $p['_create_class']('Ray', $p['tuple']($bases), $data);
	})();
	$m['Point']['ZERO'] = $m['Point'](0, 0, 0);
	$m['a'] = $m['Vector'](3, 4, 12);
	$m['b'] = $m['Vector'](1, 1, 1);
	$m['PpmCanvas'] = (function(){
		var $cls_definition = new Object();
		var $method;
		$cls_definition['__module__'] = 'main';
		$method = $pyjs__bind_method2('__init__', function(width, height, filenameBase) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
				width = arguments[1];
				height = arguments[2];
				filenameBase = arguments[3];
			}
			var $add25,$add26,$iter1_array,$mul29,$mul38,$iter1_nextval,$iter1_iter,$iter1_type,i,$iter1_idx,$mul35,$mul34,$mul37,$mul36,$mul31,$mul30,$mul33,$mul32;
			self['bytes'] = (typeof ($mul33=$p['list']([0]))==typeof ($mul34=(typeof ($mul31=(typeof ($mul29=width)==typeof ($mul30=height) && typeof $mul29=='number'?
				$mul29*$mul30:
				$p['op_mul']($mul29,$mul30)))==typeof ($mul32=3) && typeof $mul31=='number'?
				$mul31*$mul32:
				$p['op_mul']($mul31,$mul32))) && typeof $mul33=='number'?
				$mul33*$mul34:
				$p['op_mul']($mul33,$mul34));
			$iter1_iter = $p['range']((typeof ($mul35=width)==typeof ($mul36=height) && typeof $mul35=='number'?
				$mul35*$mul36:
				$p['op_mul']($mul35,$mul36)));
			$iter1_nextval=$p['__iter_prepare']($iter1_iter,false);
			while (typeof($p['__wrapped_next']($iter1_nextval)['$nextval']) != 'undefined') {
				i = $iter1_nextval['$nextval'];
				$p['getattr'](self, 'bytes')['__setitem__']($p['__op_add']($add25=(typeof ($mul37=i)==typeof ($mul38=3) && typeof $mul37=='number'?
					$mul37*$mul38:
					$p['op_mul']($mul37,$mul38)),$add26=2), 255);
			}
			self['width'] = width;
			self['height'] = height;
	...
	, 1, [null,null,['self'],['width'],['height'],['filenameBase']]);
		$cls_definition['__init__'] = $method;
		$method = $pyjs__bind_method2('plot', function(x, y, r, g, b) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			var $mul42,$sub40,$add29,$add28,$mul48,$mul44,$mul45,$mul47,$mul40,$mul41,$add27,$mul43,$sub37,$sub39,$sub38,i,$add30,$add31,$add32,$mul39,$mul46;
			i = (typeof ($mul41=$p['__op_add']($add27=(typeof ($mul39=$p['__op_sub']($sub39=$p['__op_sub']($sub37=$p['getattr'](self, 'height'),$sub38=y),$sub40=1))==typeof ($mul40=$p['getattr'](self, 'width')) && typeof $mul39=='number'?
				$mul39*$mul40:
				$p['op_mul']($mul39,$mul40)),$add28=x))==typeof ($mul42=3) && typeof $mul41=='number'?
				$mul41*$mul42:
				$p['op_mul']($mul41,$mul42));
			$p['getattr'](self, 'bytes')['__setitem__'](i, $p['max'](0, $p['min'](255, $p['float_int']((typeof ($mul43=r)==typeof ($mul44=255) && typeof $mul43=='number'?
				$mul43*$mul44:
				$p['op_mul']($mul43,$mul44))))));
			$p['getattr'](self, 'bytes')['__setitem__']($p['__op_add']($add29=i,$add30=1), $p['max'](0, $p['min'](255, $p['float_int']((typeof ($mul45=g)==typeof ($mul46=255) && typeof $mul45=='number'?
				$mul45*$mul46:
				$p['op_mul']($mul45,$mul46))))));
			$p['getattr'](self, 'bytes')['__setitem__']($p['__op_add']($add31=i,$add32=2), $p['max'](0, $p['min'](255, $p['float_int']((typeof ($mul47=b)==typeof ($mul48=255) && typeof $mul47=='number'?
				$mul47*$mul48:
				$p['op_mul']($mul47,$mul48))))));
			return null;
		}
	, 1, [null,null,['self'],['x'],['y'],['r'],['g'],['b']]);
		$cls_definition['plot'] = $method;
		$method = $pyjs__bind_method2('save', function() {
			...
			var $add33,$add34,f;
			$p['__with']($p['open']($p['__op_add']($add33=$p['getattr'](self, 'filenameBase'),$add34='.ppm'), 'wb'), function($withval1){
				f = (typeof $withval1 == "undefined"?$m['$withval1']:$withval1);
				f['write']($p['sprintf']('P6 %d %d 255\n', $p['tuple']([$p['getattr'](self, 'width'), $p['getattr'](self, 'height')])));
	...
	, 1, [null,null,['self']]);
		...
		var $data = $p['dict']();
		for (var $item in $cls_definition) { $data['__setitem__']($item, $cls_definition[$item]); }
		return $p['_create_class']('PpmCanvas', $p['tuple']($bases), $data);
	})();
	$m['firstIntersection'] = function(intersections) {
		var $iter2_nextval,$iter2_type,$iter2_iter,$or2,i,$and4,$and5,$iter2_idx,candidateT,result,$or1,$iter2_array;
		result = null;
		$iter2_iter = intersections;
		$iter2_nextval=$p['__iter_prepare']($iter2_iter,false);
		while (typeof($p['__wrapped_next']($iter2_nextval)['$nextval']) != 'undefined') {
			i = $iter2_nextval['$nextval'];
			candidateT = i['__getitem__'](1);
			if ($p['bool'](($p['bool']($and4=(candidateT !== null))?($p['cmp'](candidateT, (typeof ($usub6=$m['EPSILON'])=='number'?
				-$usub6:
				$p['op_usub']($usub6))) == 1):$and4))) {
				if ($p['bool'](($p['bool']($or1=(result === null))?$or1:($p['cmp'](candidateT, result['__getitem__'](1)) == -1)))) {
					result = i;
				}
			}
		}
	...
	$m['firstIntersection']['__name__'] = 'firstIntersection';

	$m['firstIntersection']['__bind_type__'] = 0;
	$m['firstIntersection']['__args__'] = [null,null,['intersections']];
	$m['Scene'] = (function(){
		var $cls_definition = new Object();
		var $method;
		$cls_definition['__module__'] = 'main';
		$method = $pyjs__bind_method2('__init__', function() {
			...
			self['objects'] = $p['list']([]);
			self['lightPoints'] = $p['list']([]);
			self['position'] = $m['Point'](0, 1.8, 10);
			self['lookingAt'] = $p['getattr']($m['Point'], 'ZERO');
			self['fieldOfView'] = 45;
	...
	, 1, [null,null,['self']]);
		$cls_definition['__init__'] = $method;
		$method = $pyjs__bind_method2('moveTo', function(p) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
	...
	, 1, [null,null,['self'],['p']]);
		...
		$method = $pyjs__bind_method2('lookAt', function(p) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
	...
	, 1, [null,null,['self'],['p']]);
		$cls_definition['lookAt'] = $method;
		$method = $pyjs__bind_method2('addObject', function(object, surface) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			self['objects']['append']($p['tuple']([object, surface]));
			return null;
		}
	, 1, [null,null,['self'],['object'],['surface']]);
		$cls_definition['addObject'] = $method;
		$method = $pyjs__bind_method2('addLight', function(p) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
	...
	, 1, [null,null,['self'],['p']]);
		$cls_definition['addLight'] = $method;
		$method = $pyjs__bind_method2('render', function(canvas) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			var vpRight,$add36,$iter3_array,colour,height,halfHeight,previousfraction,$add35,currentfraction,$iter4_type,fovRadians,$sub41,$sub42,$sub43,$sub44,$sub45,$sub46,$sub47,$iter3_idx,eye,$mul49,$div14,$iter4_iter,$div10,$div11,$div12,vpUp,width,$iter3_iter,ycomp,pixelHeight,ray,$iter4_array,$sub52,$sub51,$sub50,$mul60,$div13,$div8,$div9,pixelWidth,$iter3_type,halfWidth,$div6,$div7,$div5,xcomp,$sub48,$mul59,$mul58,$add37,$sub49,$mul53,$mul52,$mul51,$mul50,$mul57,$mul56,$mul55,$mul54,$iter4_idx,$add38,$iter4_nextval,y,x,$iter3_nextval;
			fovRadians = (typeof ($div7=(typeof ($mul49=$p['getattr']($m['math'], 'pi'))==typeof ($mul50=(typeof ($div5=$p['getattr'](self, 'fieldOfView'))==typeof ($div6=2.0) && typeof $div5=='number' && $div6 !== 0?
				$div5/$div6:
				$p['op_div']($div5,$div6))) && typeof $mul49=='number'?
				$mul49*$mul50:
				$p['op_mul']($mul49,$mul50)))==typeof ($div8=180.0) && typeof $div7=='number' && $div8 !== 0?
				$div7/$div8:
				$p['op_div']($div7,$div8));
			halfWidth = $m['math']['tan'](fovRadians);
			halfHeight = (typeof ($mul51=0.75)==typeof ($mul52=halfWidth) && typeof $mul51=='number'?
				$mul51*$mul52:
				$p['op_mul']($mul51,$mul52));
			width = (typeof ($mul53=halfWidth)==typeof ($mul54=2) && typeof $mul53=='number'?
				$mul53*$mul54:
				$p['op_mul']($mul53,$mul54));
			height = (typeof ($mul55=halfHeight)==typeof ($mul56=2) && typeof $mul55=='number'?
				$mul55*$mul56:
				$p['op_mul']($mul55,$mul56));
			pixelWidth = (typeof ($div9=width)==typeof ($div10=$p['__op_sub']($sub41=$p['getattr'](canvas, 'width'),$sub42=1)) && typeof $div9=='number' && $div10 !== 0?
				$div9/$div10:
				$p['op_div']($div9,$div10));
			pixelHeight = (typeof ($div11=height)==typeof ($div12=$p['__op_sub']($sub43=$p['getattr'](canvas, 'height'),$sub44=1)) && typeof $div11=='number' && $div12 !== 0?
				$div11/$div12:
				$p['op_div']($div11,$div12));
			eye = $m['Ray']($p['getattr'](self, 'position'), $p['__op_sub']($sub45=$p['getattr'](self, 'lookingAt'),$sub46=$p['getattr'](self, 'position')));
			vpRight = eye['vector']['cross']($p['getattr']($m['Vector'], 'UP'))['normalized']();
			vpUp = vpRight['cross']($p['getattr'](eye, 'vector'))['normalized']();
			previousfraction = 0;
			$iter3_iter = $p['range']($p['getattr'](canvas, 'height'));
			$iter3_nextval=$p['__iter_prepare']($iter3_iter,false);
			while (typeof($p['__wrapped_next']($iter3_nextval)['$nextval']) != 'undefined') {
				y = $iter3_nextval['$nextval'];
				currentfraction = (typeof ($div13=$p['float'](y))==typeof ($div14=$p['getattr'](canvas, 'height')) && typeof $div13=='number' && $div14 !== 0?
					$div13/$div14:
					$p['op_div']($div13,$div14));
				if ($p['bool'](($p['cmp']($p['__op_sub']($sub47=currentfraction,$sub48=previousfraction), 0.05) == 1))) {
					previousfraction = currentfraction;
				}
				$iter4_iter = $p['range']($p['getattr'](canvas, 'width'));
				$iter4_nextval=$p['__iter_prepare']($iter4_iter,false);
				while (typeof($p['__wrapped_next']($iter4_nextval)['$nextval']) != 'undefined') {
					x = $iter4_nextval['$nextval'];
					xcomp = vpRight['scale']($p['__op_sub']($sub49=(typeof ($mul57=x)==typeof ($mul58=pixelWidth) && typeof $mul57=='number'?
						$mul57*$mul58:
						$p['op_mul']($mul57,$mul58)),$sub50=halfWidth));
					ycomp = vpUp['scale']($p['__op_sub']($sub51=(typeof ($mul59=y)==typeof ($mul60=pixelHeight) && typeof $mul59=='number'?
						$mul59*$mul60:
						$p['op_mul']($mul59,$mul60)),$sub52=halfHeight));
					ray = $m['Ray']($p['getattr'](eye, 'point'), $p['__op_add']($add37=$p['__op_add']($add35=$p['getattr'](eye, 'vector'),$add36=xcomp),$add38=ycomp));
					colour = self['rayColour'](ray);
					$pyjs_kwargs_call(canvas, 'plot', colour, null, [{}, x, y]);
				}
			}
			return null;
		}
	, 1, [null,null,['self'],['canvas']]);
		...
		$method = $pyjs__bind_method2('rayColour', function(ray) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			var $add39,$sub53,i,o,$add40,p,s,$pyjs_try_err,t,intersections,$sub54;
			if ($p['bool'](($p['cmp']($p['getattr'](self, 'recursionDepth'), 3) == 1))) {
				return $p['tuple']([0, 0, 0]);
			}
			try {
				self['recursionDepth'] = $p['__op_add']($add39=$p['getattr'](self, 'recursionDepth'),$add40=1);
				intersections = function(){
					var $iter5_nextval,$iter5_idx,$collcomp1,s,$iter5_iter,o,$iter5_array,$iter5_type;
	$collcomp1 = $p['list']();
				$iter5_iter = $p['getattr'](self, 'objects');
				$iter5_nextval=$p['__iter_prepare']($iter5_iter,false);
				while (typeof($p['__wrapped_next']($iter5_nextval)['$nextval']) != 'undefined') {
					var $tupleassign1 = $p['__ass_unpack']($iter5_nextval['$nextval'], 2, null);
					o = $tupleassign1[0];
					s = $tupleassign1[1];
					$collcomp1['append']($p['tuple']([o, o['intersectionTime'](ray), s]));
				}

	return $collcomp1;}();
				i = $m['firstIntersection'](intersections);
				if ($p['bool']((i === null))) {
					return $p['tuple']([0, 0, 0]);
				}
				else {
					var $tupleassign2 = $p['__ass_unpack'](i, 3, null);
					o = $tupleassign2[0];
					t = $tupleassign2[1];
					s = $tupleassign2[2];
					p = ray['pointAtTime'](t);
				...
				self['recursionDepth'] = $p['__op_sub']($sub53=$p['getattr'](self, 'recursionDepth'),$sub54=1);
			}
			return null;
		}
	, 1, [null,null,['self'],['ray']]);
		$cls_definition['rayColour'] = $method;
		$method = $pyjs__bind_method2('_lightIsVisible', function(l, p) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			var $sub56,$sub55,$iter6_idx,$iter6_type,s,$and6,o,$and7,$iter6_array,t,$iter6_iter,$iter6_nextval;
			$iter6_iter = $p['getattr'](self, 'objects');
			$iter6_nextval=$p['__iter_prepare']($iter6_iter,false);
			while (typeof($p['__wrapped_next']($iter6_nextval)['$nextval']) != 'undefined') {
				var $tupleassign3 = $p['__ass_unpack']($iter6_nextval['$nextval'], 2, null);
				o = $tupleassign3[0];
				s = $tupleassign3[1];
				t = o['intersectionTime']($m['Ray'](p, $p['__op_sub']($sub55=l,$sub56=p)));
				if ($p['bool'](($p['bool']($and6=(t !== null))?($p['cmp'](t, $m['EPSILON']) == 1):$and6))) {
					return false;
				}
			}
			return true;
		}
	, 1, [null,null,['self'],['l'],['p']]);
		$cls_definition['_lightIsVisible'] = $method;
		$method = $pyjs__bind_method2('visibleLights', function(p) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			var $iter7_nextval,$iter7_iter,$iter7_array,l,result,$iter7_idx,$iter7_type;
			result = $p['list']([]);
			$iter7_iter = $p['getattr'](self, 'lightPoints');
			$iter7_nextval=$p['__iter_prepare']($iter7_iter,false);
			while (typeof($p['__wrapped_next']($iter7_nextval)['$nextval']) != 'undefined') {
				l = $iter7_nextval['$nextval'];
				if ($p['bool'](self['_lightIsVisible'](l, p))) {
					result['append'](l);
				}
			}
			return result;
	...
	, 1, [null,null,['self'],['p']]);
		$cls_definition['visibleLights'] = $method;
		var $bases = new Array($p['object']);
		var $data = $p['dict']();
		for (var $item in $cls_definition) { $data['__setitem__']($item, $cls_definition[$item]); }
		return $p['_create_class']('Scene', $p['tuple']($bases), $data);
	})();
	$m['addColours'] = function(a, scale, b) {
		var $mul62,$mul61,$mul66,$mul64,$mul63,$add46,$add45,$add44,$add43,$add42,$add41,$mul65;
		return $p['tuple']([$p['__op_add']($add41=a['__getitem__'](0),$add42=(typeof ($mul61=scale)==typeof ($mul62=b['__getitem__'](0)) && typeof $mul61=='number'?
			$mul61*$mul62:
			$p['op_mul']($mul61,$mul62))), $p['__op_add']($add43=a['__getitem__'](1),$add44=(typeof ($mul63=scale)==typeof ($mul64=b['__getitem__'](1)) && typeof $mul63=='number'?
			$mul63*$mul64:
			$p['op_mul']($mul63,$mul64))), $p['__op_add']($add45=a['__getitem__'](2),$add46=(typeof ($mul65=scale)==typeof ($mul66=b['__getitem__'](2)) && typeof $mul65=='number'?
			$mul65*$mul66:
			$p['op_mul']($mul65,$mul66)))]);
	};
	$m['addColours']['__name__'] = 'addColours';

	$m['addColours']['__bind_type__'] = 0;
	$m['addColours']['__args__'] = [null,null,['a'],['scale'],['b']];
	$m['SimpleSurface'] = (function(){
		var $cls_definition = new Object();
		var $method;
		$cls_definition['__module__'] = 'main';
		$method = $pyjs__bind_method2('__init__', function() {
			...
			var $sub57,$sub59,$sub58,$sub60;
			self['baseColour'] = kwargs['get']('baseColour', $p['tuple']([1, 1, 1]));
			self['specularCoefficient'] = kwargs['get']('specularCoefficient', 0.2);
			self['lambertCoefficient'] = kwargs['get']('lambertCoefficient', 0.6);
			self['ambientCoefficient'] = $p['__op_sub']($sub59=$p['__op_sub']($sub57=1.0,$sub58=$p['getattr'](self, 'specularCoefficient')),$sub60=$p['getattr'](self, 'lambertCoefficient'));
			return null;
		}
	, 1, [null,['kwargs'],['self']]);
		$cls_definition['__init__'] = $method;
		$method = $pyjs__bind_method2('baseColourAt', function(p) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			return $p['getattr'](self, 'baseColour');
		}
	, 1, [null,null,['self'],['p']]);
		$cls_definition['baseColourAt'] = $method;
		$method = $pyjs__bind_method2('colourAt', function(scene, ray, p, normal) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			var $iter8_iter,$iter8_idx,$sub62,$sub61,lightPoint,$mul67,lambertAmount,$add48,$add47,reflectedRay,$iter8_type,$iter8_nextval,c,b,$iter8_array,reflectedColour,contribution,$mul68;
			b = self['baseColourAt'](p);
			c = $p['tuple']([0, 0, 0]);
			if ($p['bool'](($p['cmp']($p['getattr'](self, 'specularCoefficient'), 0) == 1))) {
				reflectedRay = $m['Ray'](p, ray['vector']['reflectThrough'](normal));
				reflectedColour = scene['rayColour'](reflectedRay);
				c = $m['addColours'](c, $p['getattr'](self, 'specularCoefficient'), reflectedColour);
			}
			if ($p['bool'](($p['cmp']($p['getattr'](self, 'lambertCoefficient'), 0) == 1))) {
				lambertAmount = 0;
				$iter8_iter = scene['visibleLights'](p);
				$iter8_nextval=$p['__iter_prepare']($iter8_iter,false);
				while (typeof($p['__wrapped_next']($iter8_nextval)['$nextval']) != 'undefined') {
					lightPoint = $iter8_nextval['$nextval'];
					contribution = $p['__op_sub']($sub61=lightPoint,$sub62=p)['normalized']()['dot'](normal);
					if ($p['bool'](($p['cmp'](contribution, 0) == 1))) {
						lambertAmount = $p['__op_add']($add47=lambertAmount,$add48=contribution);
					}
				}
				lambertAmount = $p['min'](1, lambertAmount);
				c = $m['addColours'](c, (typeof ($mul67=$p['getattr'](self, 'lambertCoefficient'))==typeof ($mul68=lambertAmount) && typeof $mul67=='number'?
					$mul67*$mul68:
					$p['op_mul']($mul67,$mul68)), b);
			}
			if ($p['bool'](($p['cmp']($p['getattr'](self, 'ambientCoefficient'), 0) == 1))) {
				c = $m['addColours'](c, $p['getattr'](self, 'ambientCoefficient'), b);
			}
			return c;
		}
	, 1, [null,null,['self'],['scene'],['ray'],['p'],['normal']]);
		$cls_definition['colourAt'] = $method;
		var $bases = new Array($p['object']);
		var $data = $p['dict']();
		for (var $item in $cls_definition) { $data['__setitem__']($item, $cls_definition[$item]); }
		return $p['_create_class']('SimpleSurface', $p['tuple']($bases), $data);
	})();
	$m['CheckerboardSurface'] = (function(){
		var $cls_definition = new Object();
		var $method;
		$cls_definition['__module__'] = 'main';
		$method = $pyjs__bind_method2('__init__', function() {
			...
			$pyjs_kwargs_call($m['SimpleSurface'], '__init__', null, kwargs, [{}, self]);
			self['otherColour'] = kwargs['get']('otherColour', $p['tuple']([0, 0, 0]));
	...
	, 1, [null,['kwargs'],['self']]);
		...
		$method = $pyjs__bind_method2('baseColourAt', function(p) {
			...
			var $add50,$add51,$add52,$add53,$add54,$add55,$add49,$add57,$add58,$div15,$mod2,$mod1,$add56,v,$sub64,$div16,$sub63;
			v = $p['__op_sub']($sub63=p,$sub64=$p['getattr']($m['Point'], 'ZERO'));
			v['scale']((typeof ($div15=1.0)==typeof ($div16=$p['getattr'](self, 'checkSize')) && typeof $div15=='number' && $div16 !== 0?
				$div15/$div16:
				$p['op_div']($div15,$div16)));
			if ($p['bool']((typeof ($mod1=$p['__op_add']($add57=$p['__op_add']($add53=$p['float_int']($p['__op_add']($add49=$p['abs']($p['getattr'](v, 'x')),$add50=0.5)),$add54=$p['float_int']($p['__op_add']($add51=$p['abs']($p['getattr'](v, 'y')),$add52=0.5))),$add58=$p['float_int']($p['__op_add']($add55=$p['abs']($p['getattr'](v, 'z')),$add56=0.5))))==typeof ($mod2=2) && typeof $mod1=='number'?
				(($mod1=$mod1%$mod2)<0&&$mod2>0?$mod1+$mod2:$mod1):
				$p['op_mod']($mod1,$mod2)))) {
				return $p['getattr'](self, 'otherColour');
			}
			else {
				return $p['getattr'](self, 'baseColour');
			}
	...
	, 1, [null,null,['self'],['p']]);
		$cls_definition['baseColourAt'] = $method;
		var $bases = new Array($m['SimpleSurface']);
		var $data = $p['dict']();
		for (var $item in $cls_definition) { $data['__setitem__']($item, $cls_definition[$item]); }
		return $p['_create_class']('CheckerboardSurface', $p['tuple']($bases), $data);
	})();
	$m['_main'] = function() {
		var $mul70,Canvas,$div17,$div18,$div19,$iter9_iter,$mul69,$iter9_nextval,c,$iter9_array,$sub66,s,$iter9_idx,$sub68,$div20,y,$sub67,$sub65,$iter9_type;
		Canvas = $m['PpmCanvas'];
		c = Canvas(100, 100, 'test_raytrace');
		s = $m['Scene']();
		s['addLight']($m['Point'](30, 30, 10));
		s['addLight']($m['Point']((typeof ($usub7=10)=='number'?
			-$usub7:
			$p['op_usub']($usub7)), 100, 30));
		s['lookAt']($m['Point'](0, 3, 0));
		s['addObject']($m['Sphere']($m['Point'](1, 3, (typeof ($usub8=10)=='number'?
			-$usub8:
			$p['op_usub']($usub8))), 2), $pyjs_kwargs_call(null, $m['SimpleSurface'], null, null, [{'baseColour':$p['tuple']([1, 1, 0])}]));
		$iter9_iter = $p['range'](6);
		$iter9_nextval=$p['__iter_prepare']($iter9_iter,false);
		while (typeof($p['__wrapped_next']($iter9_nextval)['$nextval']) != 'undefined') {
			y = $iter9_nextval['$nextval'];
			s['addObject']($m['Sphere']($m['Point']($p['__op_sub']($sub65=(typeof ($usub9=3)=='number'?
				-$usub9:
				$p['op_usub']($usub9)),$sub66=(typeof ($mul69=y)==typeof ($mul70=0.4) && typeof $mul69=='number'?
				$mul69*$mul70:
				$p['op_mul']($mul69,$mul70))), 2.3, (typeof ($usub10=5)=='number'?
				-$usub10:
				$p['op_usub']($usub10))), 0.4), $pyjs_kwargs_call(null, $m['SimpleSurface'], null, null, [{'baseColour':$p['tuple']([(typeof ($div17=y)==typeof ($div18=6.0) && typeof $div17=='number' && $div18 !== 0?
				$div17/$div18:
				$p['op_div']($div17,$div18)), $p['__op_sub']($sub67=1,$sub68=(typeof ($div19=y)==typeof ($div20=6.0) && typeof $div19=='number' && $div20 !== 0?
				$div19/$div20:
				$p['op_div']($div19,$div20))), 0.5])}]));
		}
		s['addObject']($m['Halfspace']($m['Point'](0, 0, 0), $p['getattr']($m['Vector'], 'UP')), $m['CheckerboardSurface']());
		s['render'](c);
		return null;
	};
	$m['_main']['__name__'] = '_main';

	$m['_main']['__bind_type__'] = 0;
	$m['_main']['__args__'] = [null,null];
	$m['main'] = function(n) {
		...
		while (typeof($p['__wrapped_next']($iter11_nextval)['$nextval']) != 'undefined') {
			...
			$m['_main']();
			t2 = time['time']();
			times['append']($p['__op_sub']($sub69=t2,$sub70=t1));
		}
		return times;
	};
