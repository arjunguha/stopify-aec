...
$pyjs['loaded_modules']['main'] = function (__mod_name__) {
	...
	$m['make_tree'] = function(i, d) {
		var i2,$add2,$add1,$sub3,$sub2,$sub1,$sub4;
		if ($p['bool'](($p['cmp'](d, 0) == 1))) {
			i2 = $p['__op_add']($add1=i,$add2=i);
			d = $p['__op_sub']($sub1=d,$sub2=1);
			return $p['tuple']([i, $m['make_tree']($p['__op_sub']($sub3=i2,$sub4=1), d), $m['make_tree'](i2, d)]);
		}
		return $p['tuple']([i, null, null]);
	};
	$m['make_tree']['__name__'] = 'make_tree';

	$m['make_tree']['__bind_type__'] = 0;
	$m['make_tree']['__args__'] = [null,null,['i'],['d']];
	$m['check_tree'] = function(node) {
		var i,l,$add3,r,$add4,$sub6,$sub5;
		var $tupleassign1 = $p['__ass_unpack'](node, 3, null);
		i = $tupleassign1[0];
		l = $tupleassign1[1];
		r = $tupleassign1[2];
		if ($p['bool']((l === null))) {
			...
			return $p['__op_sub']($sub5=$p['__op_add']($add3=i,$add4=$m['check_tree'](l)),$sub6=$m['check_tree'](r));
		}
		return null;
	};
	$m['check_tree']['__name__'] = 'check_tree';

	$m['check_tree']['__bind_type__'] = 0;
	$m['check_tree']['__args__'] = [null,null,['node']];
	$m['make_check'] = function(itde, make, check) {
		if (typeof make == 'undefined') make=arguments['callee']['__args__'][3][1];
		if (typeof check == 'undefined') check=arguments['callee']['__args__'][4][1];
		var i,d;
		var $tupleassign2 = $p['__ass_unpack'](itde, 2, null);
		i = $tupleassign2[0];
		d = $tupleassign2[1];
		return check(make(i, d));
	};
	$m['make_check']['__name__'] = 'make_check';

	$m['make_check']['__bind_type__'] = 0;
	$m['make_check']['__args__'] = [null,null,['itde'],['make', $m['make_tree']],['check', $m['check_tree']]];
	$m['get_argchunks'] = function(i, d, chunksize) {
		if (typeof chunksize == 'undefined') chunksize=arguments['callee']['__args__'][4][1];
		var chunk,$iter1_iter,$mod4,$mod1,$mod3,$mod2,$iter2_type,$iter2_iter,$iter1_array,$add7,$iter1_nextval,$iter2_idx,$iter1_type,$iter2_nextval,k,$add6,$iter1_idx,$add5,$add8,$iter2_array;
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
		var $generator = function () {};
		$generator['next'] = function (noStop) {
		...
		$generator['$genfunc'] = function () {
			...
			if (typeof $generator_state[0] == 'undefined' || $generator_state[0] === 0) {
				...
				if (!( $p['op_eq']((typeof ($mod3=chunksize)==typeof ($mod4=2) && typeof $mod3=='number'?
					(($mod3=$mod3%$mod4)<0&&$mod4>0?$mod3+$mod4:$mod3):
					$p['op_mod']($mod3,$mod4)), 0) )) {
				   throw $p['AssertionError']();
				 }
				chunk = $p['list']([]);
				$iter2_iter = $p['range'](1, $p['__op_add']($add7=i,$add8=1));
				$iter2_nextval=$p['__iter_prepare']($iter2_iter,false);
				$generator_state[0]=1;
			}
			if ($generator_state[0] == 1) {
			...
			if ($generator_state[0] == 2) {
				for (;($generator_state[1] > 0 || typeof($p['__wrapped_next']($iter2_nextval)['$nextval']) != 'undefined');$generator_state[1] = 0) {
					if (typeof $generator_state[1] == 'undefined' || $generator_state[1] === 0) {
						...
						chunk['extend']($p['list']([$p['tuple']([k, d]), $p['tuple']([(typeof ($usub2=k)=='number'?
							-$usub2:
							$p['op_usub']($usub2)), d])]));
						$generator_state[3] = 0;
						$generator_state[1]=1;
					...
					if ($generator_state[1] == 1) {
						if(($generator_state[2]==1)||($generator_state[2]<1&&($p['bool']($p['op_eq']($p['len'](chunk), chunksize))))) {
							$generator_state[2]=1;
							if (typeof $generator_state[3] == 'undefined' || $generator_state[3] === 0) {
								for (var $i = 3 ; $i < ($generator_state['length']<5?5:$generator_state['length']); $i++) $generator_state[$i]=0;
								$yield_value = chunk;
			...
			if ($generator_state[0] == 4) {
				if(($generator_state[1]==1)||($generator_state[1]<1&&($p['bool'](($p['cmp']($p['len'](chunk), 0) == 1))))) {
					$generator_state[1]=1;
					if (typeof $generator_state[2] == 'undefined' || $generator_state[2] === 0) {
						for (var $i = 2 ; $i < ($generator_state['length']<4?4:$generator_state['length']); $i++) $generator_state[$i]=0;
						$yield_value = chunk;
	...
	$m['get_argchunks']['__name__'] = 'get_argchunks';

	$m['get_argchunks']['__bind_type__'] = 0;
	...
	$m['main'] = function(n, min_depth) {
		...
		while (typeof($p['__wrapped_next']($iter3_nextval)['$nextval']) != 'undefined') {
			...
			i = (typeof ($pow1=2)==typeof ($pow2=$p['__op_sub']($sub7=mmd,$sub8=d)) && typeof $pow1=='number'?
				Math['pow']($pow1,$pow2):
				$p['op_pow']($pow1,$pow2));
			cs = 0;
			ch = $m['get_argchunks'](i, d);
			$iter4_iter = ch;
			$iter4_nextval=$p['__iter_prepare']($iter4_iter,false);
			while (typeof($p['__wrapped_next']($iter4_nextval)['$nextval']) != 'undefined') {
	...
	$m['main']['__args__'] = [null,null,['n'],['min_depth', 4]];
	$m['main'](15);
	return this;
}; /* end main */
