...
function spectral_norm () {
    ...
    */
	...
	(function () {
		...
		var part_At_times_u = function (xxx_todo_changeme1) {
			var __left0__ = xxx_todo_changeme1;
			var i = __left0__ [0];
			var u = __left0__ [1];
			var partial_sum = 0;
			var __iterable0__ = __call__ (enumerate, null, u);
		...
		'</use>')
		__pragma__ ('<all>')
			__all__.DEFAULT_N = DEFAULT_N;
			__all__.eval_A = eval_A;
			__all__.eval_A_times_u = eval_A_times_u;
			__all__.eval_AtA_times_u = eval_AtA_times_u;
			__all__.eval_At_times_u = eval_At_times_u;
			__all__.main = main;
			__all__.part_A_times_u = part_A_times_u;
			__all__.part_At_times_u = part_At_times_u;
			__all__.sqrt = sqrt;
		__pragma__ ('</all>')
	}) ();
   return __all__;
