...
$c_Lorg_scalajs_benchmark_richards_Scheduler.prototype.queue__Lorg_scalajs_benchmark_richards_Packet__Lorg_scalajs_benchmark_richards_TaskControlBlock = (function(packet) {
  var t = this.blocks$1.get(packet.id$1);
  if ((t === null)) {
    return t
  } else {
...
$c_Lorg_scalajs_benchmark_richards_Scheduler.prototype.addTask__I__I__Lorg_scalajs_benchmark_richards_Packet__Lorg_scalajs_benchmark_richards_Task__V = (function(id, priority, queue, task) {
  ...
  this.blocks$1.set(id, this.currentTcb$1)
});
  ...
  if ((this.v1$2 !== null)) {
    ...
    if ((count < 4)) {
      if ((this.v2$2 !== null)) {
        ...
        v.a1$1 = this.v1$2.a2$1.get(count);
...
$c_Lorg_scalajs_benchmark_richards_Richards$.prototype = new $h_O();
...
$c_Lorg_scalajs_benchmark_richards_Richards$.prototype.main__V = (function() {
  var this$1 = $as_sci_List($m_sci_List$().range__O__O__s_math_Integral__sc_GenTraversable(0, 10000, $m_s_math_Numeric$IntIsIntegral$()));
  var these = this$1;
...
$c_Lorg_scalajs_benchmark_richards_Richards$.prototype.$$js$exported$meth$main__O = (function() {
  this.main__V()
});
$c_Lorg_scalajs_benchmark_richards_Richards$.prototype.main = (function() {
...
$m_Lorg_scalajs_benchmark_richards_Richards$().main__V();
}).call(this);
