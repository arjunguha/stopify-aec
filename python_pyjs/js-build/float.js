...
$pyjs['loaded_modules']['main'] = function (__mod_name__) {
	...
	$m['Point'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function(i) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			var $div1,$assign1,$div2,x,$mul4,$mul3,$mul2,$mul1;
			$assign1 = $m['sin'](i);
			self['x'] = $assign1;
			x = $assign1;
			self['y'] = (typeof ($mul1=$m['cos'](i))==typeof ($mul2=3) && typeof $mul1=='number'?
				$mul1*$mul2:
				$p['op_mul']($mul1,$mul2));
			self['z'] = (typeof ($div1=(typeof ($mul3=x)==typeof ($mul4=x) && typeof $mul3=='number'?
				$mul3*$mul4:
				$p['op_mul']($mul3,$mul4)))==typeof ($div2=2) && typeof $div1=='number' && $div2 !== 0?
				$div1/$div2:
				$p['op_div']($div1,$div2));
			return null;
		}
	, 1, [null,null,['self'],['i']]);
		...
		$method = $pyjs__bind_method2('__repr__', function() {
			...
			return $p['sprintf']('<Point: x=%s, y=%s, z=%s>', $p['tuple']([$p['getattr'](self, 'x'), $p['getattr'](self, 'y'), $p['getattr'](self, 'z')]));
		}
	, 1, [null,null,['self']]);
		$cls_definition['__repr__'] = $method;
		$method = $pyjs__bind_method2('normalize', function() {
			...
			var $div5,$div3,$add4,$mul10,$mul8,$add2,$mul7,$div8,$add1,$div4,$mul9,$mul6,y,x,$mul5,z,$div6,$div7,norm,$add3;
			x = $p['getattr'](self, 'x');
			y = $p['getattr'](self, 'y');
			z = $p['getattr'](self, 'z');
			norm = $m['sqrt']($p['__op_add']($add3=$p['__op_add']($add1=(typeof ($mul5=x)==typeof ($mul6=x) && typeof $mul5=='number'?
				$mul5*$mul6:
				$p['op_mul']($mul5,$mul6)),$add2=(typeof ($mul7=y)==typeof ($mul8=y) && typeof $mul7=='number'?
				$mul7*$mul8:
				$p['op_mul']($mul7,$mul8))),$add4=(typeof ($mul9=z)==typeof ($mul10=z) && typeof $mul9=='number'?
				$mul9*$mul10:
				$p['op_mul']($mul9,$mul10))));
			self['x'] = (typeof ($div3=$p['getattr'](self, 'x'))==typeof ($div4=norm) && typeof $div3=='number' && $div4 !== 0?
				$div3/$div4:
				$p['op_div']($div3,$div4));
			self['y'] = (typeof ($div5=$p['getattr'](self, 'y'))==typeof ($div6=norm) && typeof $div5=='number' && $div6 !== 0?
				$div5/$div6:
				$p['op_div']($div5,$div6));
			self['z'] = (typeof ($div7=$p['getattr'](self, 'z'))==typeof ($div8=norm) && typeof $div7=='number' && $div8 !== 0?
				$div7/$div8:
				$p['op_div']($div7,$div8));
			return null;
		}
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('maximize', function(other) {
			if (this['__is_instance__'] === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			self['x'] = ($p['bool'](($p['cmp']($p['getattr'](self, 'x'), $p['getattr'](other, 'x')) == 1))? ($p['getattr'](self, 'x')) : ($p['getattr'](other, 'x')));
			self['y'] = ($p['bool'](($p['cmp']($p['getattr'](self, 'y'), $p['getattr'](other, 'y')) == 1))? ($p['getattr'](self, 'y')) : ($p['getattr'](other, 'y')));
			self['z'] = ($p['bool'](($p['cmp']($p['getattr'](self, 'z'), $p['getattr'](other, 'z')) == 1))? ($p['getattr'](self, 'z')) : ($p['getattr'](other, 'z')));
			return self;
		}
	, 1, [null,null,['self'],['other']]);
		$cls_definition['maximize'] = $method;
		var $bases = new Array($p['object']);
		var $data = $p['dict']();
		for (var $item in $cls_definition) { $data['__setitem__']($item, $cls_definition[$item]); }
		return $p['_create_class']('Point', $p['tuple']($bases), $data);
	})();
	$m['maximize'] = function(points) {
		var $iter1_nextval,$iter1_type,$iter1_iter,p,$iter1_array,next,$iter1_idx;
		next = points['__getitem__'](0);
		$iter1_iter = $p['__getslice'](points, 1, null);
		$iter1_nextval=$p['__iter_prepare']($iter1_iter,false);
		while (typeof($p['__wrapped_next']($iter1_nextval)['$nextval']) != 'undefined') {
	...
	$m['maximize']['__name__'] = 'maximize';

	$m['maximize']['__bind_type__'] = 0;
	$m['maximize']['__args__'] = [null,null,['points']];
	$m['benchmark'] = function(n) {
		var $mul11,$iter2_nextval,$iter2_type,$mul12,$iter2_iter,i,$iter3_nextval,$iter3_array,$iter3_idx,p,$iter2_idx,points,$iter3_iter,$iter3_type,$iter2_array;
		points = (typeof ($mul11=$p['list']([null]))==typeof ($mul12=n) && typeof $mul11=='number'?
			$mul11*$mul12:
		...
		while (typeof($p['__wrapped_next']($iter2_nextval)['$nextval']) != 'undefined') {
			i = $iter2_nextval['$nextval'];
			points['__setitem__'](i, $m['Point'](i));
		}
		$iter3_iter = points;
		$iter3_nextval=$p['__iter_prepare']($iter3_iter,false);
		while (typeof($p['__wrapped_next']($iter3_nextval)['$nextval']) != 'undefined') {
		...
		return $m['maximize'](points);
	};
	$m['benchmark']['__name__'] = 'benchmark';

	$m['benchmark']['__bind_type__'] = 0;
	$m['benchmark']['__args__'] = [null,null,['n']];
	$m['POINTS'] = 100000;
	$m['main'] = function(arg) {
		var i,$iter4_nextval,t0,times,$iter4_idx,o,$iter4_type,$iter4_array,$sub2,$sub1,$iter4_iter,tk;
		times = $p['list']([]);
		$iter4_iter = $p['xrange'](arg);
		$iter4_nextval=$p['__iter_prepare']($iter4_iter,false);
		while (typeof($p['__wrapped_next']($iter4_nextval)['$nextval']) != 'undefined') {
			i = $iter4_nextval['$nextval'];
			t0 = $m['time']['time']();
			o = $m['benchmark']($m['POINTS']);
			tk = $m['time']['time']();
...
/*
PYJS_DEPS: ['math.sin', 'math', 'math.cos', 'math.sqrt', 'time']
*/
pygwtOnLoad();
