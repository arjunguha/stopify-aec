...
var browse;
var database;
var BgL_myzd2matchzd2;
var randomize;
var BgL_browsezd2randomzd2;
var init;
var BgL_za2randza2z00;
var BgL_treezd2copyzd2;
var BgL_appendzd2tozd2tailz12z12;
var BgL_generatezd2symbolzd2;
var BgL_za2currentzd2gensymza2zd2;
var put;
var get;
var properties;
var lookup;
...
var time;
var BgL_browsezd2iterszd2;
const_main = new sc_Pair(sc_list("\uEBAC*a", "\uEBAC?b", "\uEBAC*b", "\uEBAC?b", "\uEBACa", "\uEBAC*a", "\uEBACa", "\uEBAC*b", "\uEBAC*a"), new sc_Pair(sc_list("\uEBAC*a", "\uEBAC*b", "\uEBAC*b", "\uEBAC*a", new sc_Pair("\uEBAC*a", null), new sc_Pair("\uEBAC*b", null)), new sc_Pair(sc_list("\uEBAC?", "\uEBAC?", "\uEBAC*", new sc_Pair("\uEBACb", new sc_Pair("\uEBACa", null)), "\uEBAC*", "\uEBAC?", "\uEBAC?"), null)));
BgL_sc_const_1z00_main = new sc_Pair(sc_list("\uEBACa", "\uEBACa", "\uEBACa", "\uEBACb", "\uEBACb", "\uEBACb", "\uEBACb", "\uEBACa", "\uEBACa", "\uEBACa", "\uEBACa", "\uEBACa", "\uEBACb", "\uEBACb", "\uEBACa", "\uEBACa", "\uEBACa"), new sc_Pair(sc_list("\uEBACa", "\uEBACa", "\uEBACb", "\uEBACb", "\uEBACb", "\uEBACb", "\uEBACa", "\uEBACa", new sc_Pair("\uEBACa", new sc_Pair("\uEBACa", null)), new sc_Pair("\uEBACb", new sc_Pair("\uEBACb", null))), new sc_Pair(sc_list("\uEBACa", "\uEBACa", "\uEBACa", "\uEBACb", new sc_Pair("\uEBACb", new sc_Pair("\uEBACa", null)), "\uEBACb", "\uEBACa", "\uEBACb", "\uEBACa"), null)));
BgL_sc_const_2z00_main = "*** wrong result ***";
BgL_browsezd2iterszd2 = 100;
time = function(x) {
    return x;
  };
...
BgL_runzd2benchmarkzd2 = function(name, count, is_ok, run_maker) {
    ...
    if (is_ok(result) === false) {
      sc_display(BgL_sc_const_2z00_main);
      sc_newline();
      sc_display("*** got: ");
      sc_write(result);
      return sc_newline();
...
BgL_za2currentzd2gensymza2zd2 = 0;
BgL_generatezd2symbolzd2 = function() {
    ++BgL_za2currentzd2gensymza2zd2;
    return '\uEBAC' + sc_number2string(BgL_za2currentzd2gensymza2zd2);
  };
BgL_appendzd2tozd2tailz12z12 = function(x, y) {
    var a;
    var b;
    var b_1;
    if (x === null) {
...
BgL_treezd2copyzd2 = function(x) {
    if (!(x instanceof sc_Pair)) {
      return x;
    } else {
      return new sc_Pair(BgL_treezd2copyzd2(x.car), BgL_treezd2copyzd2(x.cdr));
    }
  };
BgL_za2randza2z00 = 21;
init = function(n, m, npats, ipats) {
    var stmp;
    var j;
    var j_2;
    var i;
    ...
    var name_10;
    var ipats_11;
    ipats_11 = BgL_treezd2copyzd2(ipats);
    p = ipats_11;
    while (!(p.cdr === null)) {
      p = p.cdr;
    }
    p.cdr = ipats_11;
    name_10 = BgL_generatezd2symbolzd2();
    a_9 = null;
    n_6 = n;
    i_7 = m;
    name = name_10;
    a_8 = a_9;
    while (!(n_6 === 0)) {
      a_8 = new sc_Pair(name, a_8);
      i_5 = i_7;
      while (!(i_5 === 0)) {
        put(name, BgL_generatezd2symbolzd2(), false);
        --i_5;
      }
      a_4 = null;
      i = npats;
      ...
      a = a_4;
      while (!(i === 0)) {
        a = new sc_Pair(ipats_3.car, a);
        --i;
        ipats_3 = ipats_3.cdr;
      }
      stmp = a;
      put(name, "\uEBACpattern", stmp);
      j_2 = m - i_7;
      j = j_2;
      while (!(j === 0)) {
        put(name, BgL_generatezd2symbolzd2(), false);
      ...
      name = BgL_generatezd2symbolzd2();
    }
    return a_8;
  };
BgL_browsezd2randomzd2 = function() {
    BgL_za2randza2z00 = BgL_za2randza2z00 * 17 % 251;
    return BgL_za2randza2z00;
  };
randomize = function(l) {
    var n;
    var x;
    var n_12;
    var a;
    ...
    a = a_13;
    while (!(l === null)) {
      n_12 = BgL_browsezd2randomzd2() % sc_length(l);
      if (n_12 === 0) {
        a = new sc_Pair(l.car, a);
        l = l.cdr;
      } else {
        n = n_12;
        x = l;
        ...
        a = new sc_Pair(x.cdr.car, a);
        x.cdr = x.cdr.cdr;
      }
    }
    return a;
  };
BgL_myzd2matchzd2 = function(pat, dat, alist) {
    var tmp1276;
    var l;
    var e;
    var d;
    ...
    if (pat === null) {
      ...
      if (dat === null) {
        ...
        tmp1272 = pat.car === "\uEBAC?";
        if ((tmp1272 !== false? tmp1272: pat.car === dat.car) !== false) {
          return BgL_myzd2matchzd2(pat.cdr, dat.cdr, alist);
        } else {
          if (pat.car === "\uEBAC*") {
            tmp1273 = BgL_myzd2matchzd2(pat.cdr, dat, alist);
            if (tmp1273 !== false) {
              return tmp1273;
            } else {
              tmp1274 = BgL_myzd2matchzd2(pat.cdr, dat.cdr, alist);
              if (tmp1274 !== false) {
                return tmp1274;
              } else {
                return BgL_myzd2matchzd2(pat, dat.cdr, alist);
              }
            }
          } else {
            if (!(pat.car instanceof sc_Pair)) {
              if (sc_stringRef(pat.car.slice(1), 0) === new sc_Char("?")) {
                val_16 = sc_assq(pat.car, alist);
                if (val_16 !== false) {
                  return BgL_myzd2matchzd2(new sc_Pair(val_16.cdr, pat.cdr), dat, alist);
                } else {
                  return BgL_myzd2matchzd2(pat.cdr, dat.cdr, new sc_Pair(new sc_Pair(pat.car, dat.car), alist));
                }
              } else {
                if (sc_stringRef(pat.car.slice(1), 0) === new sc_Char("*")) {
                  val = sc_assq(pat.car, alist);
                  if (val !== false) {
                    return BgL_myzd2matchzd2(sc_append(val.cdr, pat.cdr), dat, alist);
                  } else {
                    l_15 = null;
                    e_14 = new sc_Pair(null, dat);
                    l = l_15;
                    e = e_14;
                    d = dat;
                    do {
                      tmp1276 = e === null;
                      if ((tmp1276 !== false? tmp1276: BgL_myzd2matchzd2(pat.cdr, d, new sc_Pair(new sc_Pair(pat.car, l), alist))) !== false) {
                        if (e === null) {
                          return false;
                        } else {
                          return true;
                        ...
                        l = BgL_appendzd2tozd2tailz12z12(l, new sc_Pair(d === null? null: d.car, null));
                        if (d === null) {
                          d = null;
                        } else {
                          d = d.cdr;
              ...
              if (dat.car instanceof sc_Pair) {
                if (BgL_myzd2matchzd2(pat.car, dat.car, alist) !== false) {
                  return BgL_myzd2matchzd2(pat.cdr, dat.cdr, alist);
                } else {
                  return false;
                }
...
database = randomize(init(100, 10, 4, BgL_sc_const_1z00_main));
browse = function(pats) {
    return investigate(database, pats);
  };
investigate = function(units, pats) {
    var p;
    var p_17;
    var pats_18;
    var units_19;
    ...
    while (!(units_19 === null)) {
      pats_18 = pats;
      while (!(pats_18 === null)) {
        p_17 = get(units_19.car, "\uEBACpattern");
        p = p_17;
        while (!(p === null)) {
          BgL_myzd2matchzd2(pats_18.car, p.car, null);
          p = p.cdr;
        }
        pats_18 = pats_18.cdr;
      }
      units_19 = units_19.cdr;
    }
    return false;
  };
main = function() {
    ...
    return BgL_runzd2benchmarkzd2("browse", BgL_browsezd2iterszd2, function(result) {
              return true;
            }, function(pats) {
              return function() {
                      return browse(pats);
