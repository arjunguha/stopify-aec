...
BgL_diviterzd2iterszd2 = 1000000;
time = function(x) {
    return x;
  };
...
BgL_iterativezd2div2zd2 = function(l) {
    var l_3;
    var a;
    var a_4;
    a_4 = null;
...
main = function() {
    ...
    return BgL_runzd2benchmarkzd2("diviter", BgL_diviterzd2iterszd2, function(result) {
              return sc_isEqual(result, BgL_sc_const_1z00_main);
            }, function(l) {
              return function() {
                      return BgL_iterativezd2div2zd2(l);
                    };
            }, BgL_za2llza2z00);
  };
main();
