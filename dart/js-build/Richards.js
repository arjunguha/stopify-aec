...
(function() {
  ...
  }], ["", "../benchmark-files/Richards.dart",, Y, {
    "^": "",
    main: function() {
      new Y.Richards().exercise$0();
    },
    Richards: {
      "^": "Object;",
      exercise$0: function() {
        var i, t1, scheduler, t2;
        for (i = 0; i < 100; ++i) {
          t1 = new Array(6);
          ...
          if (2322 !== scheduler.queueCount)
            H.throwExpression("bad scheduler queue-count");
          if (928 !== scheduler.holdCount)
            H.throwExpression("bad scheduler hold-count");
        }
      }
    },
    Scheduler: {
