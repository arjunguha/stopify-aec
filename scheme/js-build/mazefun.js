...
var main;
var BgL_expectedzd2resultzd2;
var BgL_neighboringzd2cavitieszd2;
var BgL_changezd2cavityzd2auxz00;
var BgL_changezd2cavityzd2;
var BgL_tryzd2tozd2piercez00;
var BgL_piercezd2randomlyzd2;
var pierce;
var BgL_cavezd2tozd2maza7eza7;
var BgL_makezd2maza7ez75;
var BgL_shufflezd2auxzd2;
var shuffle;
var BgL_nextzd2randomzd2;
var BgL_initialzd2randomzd2;
var BgL_matrixzd2mapzd2;
var BgL_matrixzd2siza7ez75;
var BgL_matrixzd2writezd2;
var BgL_matrixzd2readzd2;
var BgL_makezd2matrixzd2;
var BgL_duplicateszf3zf3;
var BgL_listzd2removezd2posz00;
var BgL_listzd2writezd2;
var BgL_listzd2readzd2;
var concat;
var BgL_forz00;
var foldl;
var foldr;
...
BgL_sc_const_1z00_main = sc_list(sc_list("\uEBAC_", "\uEBAC*", "\uEBAC_", "\uEBAC_", "\uEBAC_", "\uEBAC_", "\uEBAC_", "\uEBAC_", "\uEBAC_", "\uEBAC_", "\uEBAC_"), sc_list("\uEBAC_", "\uEBAC*", "\uEBAC*", "\uEBAC*", "\uEBAC*", "\uEBAC*", "\uEBAC*", "\uEBAC*", "\uEBAC_", "\uEBAC*", "\uEBAC*"), sc_list("\uEBAC_", "\uEBAC_", "\uEBAC_", "\uEBAC*", "\uEBAC_", "\uEBAC_", "\uEBAC_", "\uEBAC*", "\uEBAC_", "\uEBAC_", "\uEBAC_"), sc_list("\uEBAC_", "\uEBAC*", "\uEBAC_", "\uEBAC*", "\uEBAC_", "\uEBAC*", "\uEBAC_", "\uEBAC*", "\uEBAC_", "\uEBAC*", "\uEBAC_"), sc_list("\uEBAC_", "\uEBAC*", "\uEBAC_", "\uEBAC_", "\uEBAC_", "\uEBAC*", "\uEBAC_", "\uEBAC*", "\uEBAC_", "\uEBAC*", "\uEBAC_"), sc_list("\uEBAC*", "\uEBAC*", "\uEBAC_", "\uEBAC*", "\uEBAC*", "\uEBAC*", "\uEBAC*", "\uEBAC*", "\uEBAC_", "\uEBAC*", "\uEBAC_"), sc_list("\uEBAC_", "\uEBAC*", "\uEBAC_", "\uEBAC_", "\uEBAC_", "\uEBAC_", "\uEBAC_", "\uEBAC_", "\uEBAC_", "\uEBAC*", "\uEBAC_"), sc_list("\uEBAC_", "\uEBAC*", "\uEBAC_", "\uEBAC*", "\uEBAC_", "\uEBAC*", "\uEBAC*", "\uEBAC*", "\uEBAC*", "\uEBAC*", "\uEBAC*"), sc_list("\uEBAC_", "\uEBAC_", "\uEBAC_", "\uEBAC*", "\uEBAC_", "\uEBAC_", "\uEBAC_", "\uEBAC_", "\uEBAC_", "\uEBAC_", "\uEBAC_"), sc_list("\uEBAC_", "\uEBAC*", "\uEBAC*", "\uEBAC*", "\uEBAC*", "\uEBAC*", "\uEBAC*", "\uEBAC*", "\uEBAC_", "\uEBAC*", "\uEBAC*"), sc_list("\uEBAC_", "\uEBAC*", "\uEBAC_", "\uEBAC_", "\uEBAC_", "\uEBAC_", "\uEBAC_", "\uEBAC_", "\uEBAC_", "\uEBAC_", "\uEBAC_"));
time = function(x) {
    return x;
  };
...
foldr = function(f, base, lst) {
    var foldr_aux;
    foldr_aux = function(lst) {
        var stmp;
        var lst_1;
        if (lst === null) {
          return base;
          ...
          if (lst_1 === null) {
            ...
            stmp = f(lst_1.car, foldr_aux(lst_1.cdr));
          }
          return f(lst.car, stmp);
        }
      };
    if (lst === null) {
      return base;
    } else {
      return f(lst.car, foldr_aux(lst.cdr));
    }
  };
foldl = function(f, base, lst) {
    var base_2;
    var lst_3;
    base_2 = base;
    lst_3 = lst;
    while (!(lst_3 === null)) {
      base_2 = f(base_2, lst_3.car);
      lst_3 = lst_3.cdr;
    }
    return base_2;
  };
BgL_forz00 = function(lo, hi, f) {
    var for_aux;
    for_aux = function(lo) {
        var stmp;
        var lo_4;
        if (lo < hi) {
          lo_4 = lo + 1;
          if (lo_4 < hi) {
            stmp = new sc_Pair(f(lo_4), for_aux(lo_4 + 1));
          } else {
            stmp = null;
          }
          return new sc_Pair(f(lo), stmp);
        } else {
          return null;
        }
      };
    if (lo < hi) {
      return new sc_Pair(f(lo), for_aux(lo + 1));
    } else {
      return null;
    }
  };
concat = function(lists) {
    return foldr(sc_append, null, lists);
  };
BgL_listzd2readzd2 = function(lst, i) {
    if (i === 0) {
      return lst.car;
    } else {
      return BgL_listzd2readzd2(lst.cdr, i - 1);
    }
  };
BgL_listzd2writezd2 = function(lst, i, val) {
    if (i === 0) {
      return new sc_Pair(val, lst.cdr);
    } else {
      return new sc_Pair(lst.car, BgL_listzd2writezd2(lst.cdr, i - 1, val));
    }
  };
BgL_listzd2removezd2posz00 = function(lst, i) {
    if (i === 0) {
      return lst.cdr;
    } else {
      return new sc_Pair(lst.car, BgL_listzd2removezd2posz00(lst.cdr, i - 1));
    }
  };
BgL_duplicateszf3zf3 = function(lst) {
    var tmp1264;
    if (lst === null) {
      return false;
    } else {
      tmp1264 = sc_member(lst.car, lst.cdr);
      if (tmp1264 !== false) {
        return tmp1264;
      } else {
        return BgL_duplicateszf3zf3(lst.cdr);
      }
    }
  };
BgL_makezd2matrixzd2 = function(n, m, init) {
    return BgL_forz00(0, n, function(i) {
              return BgL_forz00(0, m, function(j) {
                        return init(i, j);
                      });
            });
  };
BgL_matrixzd2readzd2 = function(mat, i, j) {
    return BgL_listzd2readzd2(BgL_listzd2readzd2(mat, i), j);
  };
BgL_matrixzd2writezd2 = function(mat, i, j, val) {
    return BgL_listzd2writezd2(mat, i, BgL_listzd2writezd2(BgL_listzd2readzd2(mat, i), j, val));
  };
BgL_matrixzd2siza7ez75 = function(mat) {
    return new sc_Pair(sc_length(mat), sc_length(mat.car));
  };
BgL_matrixzd2mapzd2 = function(f, mat) {
    var stmp;
    var stmp_5;
    var tail1269;
    var L1265;
    ...
    var L1270;
    var falseHead1273;
    falseHead1273 = new sc_Pair(null, null);
    tail1274 = falseHead1273;
    L1270 = mat;
    while (!(L1270 === null)) {
      lst = L1270.car;
      falseHead1268 = new sc_Pair(null, null);
      tail1269 = falseHead1268;
      L1265 = lst;
      while (!(L1265 === null)) {
        tail1269.cdr = new sc_Pair(f(L1265.car), null);
        tail1269 = tail1269.cdr;
        L1265 = L1265.cdr;
      }
      stmp_5 = falseHead1268.cdr;
      stmp = new sc_Pair(stmp_5, null);
      tail1274.cdr = stmp;
      tail1274 = tail1274.cdr;
      L1270 = L1270.cdr;
    }
    return falseHead1273.cdr;
  };
BgL_initialzd2randomzd2 = 0;
BgL_nextzd2randomzd2 = function(current_random) {
    return (current_random * 3581 + 12751) % 131072;
  };
shuffle = function(lst) {
    return BgL_shufflezd2auxzd2(lst, BgL_initialzd2randomzd2);
  };
BgL_shufflezd2auxzd2 = function(lst, current_random) {
    var i;
    var new_random;
    if (lst === null) {
      return null;
    } else {
      new_random = BgL_nextzd2randomzd2(current_random);
      i = sc_modulo(new_random, sc_length(lst));
      return new sc_Pair(BgL_listzd2readzd2(lst, i), BgL_shufflezd2auxzd2(BgL_listzd2removezd2posz00(lst, i), new_random));
    }
  };
BgL_makezd2maza7ez75 = function(n, m) {
    var possible_holes;
    var cave;
    if ((n % 2 === 1 && m % 2 === 1) === false) {
      return "\uEBACerror";
    } else {
      cave = BgL_makezd2matrixzd2(n, m, function(i, j) {
            if (i % 2 === 0 && j % 2 === 0) {
              return new sc_Pair(i, j);
            } else {
              return false;
            }
          });
      possible_holes = concat(BgL_forz00(0, n, function(i) {
              return concat(BgL_forz00(0, m, function(j) {
                          if (sc_isEqual(i % 2 === 0, j % 2 === 0)) {
                            return null;
                          } else {
                            return sc_list(new sc_Pair(i, j));
                          }
                        }));
            }));
      return BgL_cavezd2tozd2maza7eza7(BgL_piercezd2randomlyzd2(shuffle(possible_holes), cave));
    }
  };
BgL_cavezd2tozd2maza7eza7 = function(cave) {
    return BgL_matrixzd2mapzd2(function(x) {
              if (x !== false) {
                return "\uEBAC_";
              } else {
                return "\uEBAC*";
...
pierce = function(pos, cave) {
    var j;
    var i;
    i = pos.car;
    j = pos.cdr;
    return BgL_matrixzd2writezd2(cave, i, j, pos);
  };
BgL_piercezd2randomlyzd2 = function(possible_holes, cave) {
    var hole;
    if (possible_holes === null) {
      return cave;
    } else {
      hole = possible_holes.car;
      return BgL_piercezd2randomlyzd2(possible_holes.cdr, BgL_tryzd2tozd2piercez00(hole, cave));
    }
  };
BgL_tryzd2tozd2piercez00 = function(pos, cave) {
    var stmp;
    var stmp_6;
    var nc;
    var tail1279;
    ...
    pos.car;
    pos.cdr;
    ncs = BgL_neighboringzd2cavitieszd2(pos, cave);
    falseHead1278 = new sc_Pair(null, null);
    tail1279 = falseHead1278;
    L1275 = ncs;
    while (!(L1275 === null)) {
      nc = L1275.car;
      stmp_6 = new sc_Pair(BgL_matrixzd2readzd2(cave, nc.car, nc.cdr), null);
      tail1279.cdr = stmp_6;
      tail1279 = tail1279.cdr;
      L1275 = L1275.cdr;
    }
    stmp = falseHead1278.cdr;
    if (BgL_duplicateszf3zf3(stmp) !== false) {
      return cave;
    } else {
      return pierce(pos, foldl(function(c, nc) {
                  return BgL_changezd2cavityzd2(c, nc, pos);
                }, cave, ncs));
    }
  };
BgL_changezd2cavityzd2 = function(cave, pos, new_cavity_id) {
    var j;
    var i;
    i = pos.car;
    j = pos.cdr;
    return BgL_changezd2cavityzd2auxz00(cave, pos, new_cavity_id, BgL_matrixzd2readzd2(cave, i, j));
  };
BgL_changezd2cavityzd2auxz00 = function(cave, pos, new_cavity_id, old_cavity_id) {
    var cavity_id;
    var j;
    var i;
    i = pos.car;
    j = pos.cdr;
    cavity_id = BgL_matrixzd2readzd2(cave, i, j);
    if (sc_isEqual(cavity_id, old_cavity_id)) {
      return foldl(function(c, nc) {
                return BgL_changezd2cavityzd2auxz00(c, nc, new_cavity_id, old_cavity_id);
              }, BgL_matrixzd2writezd2(cave, i, j, new_cavity_id), BgL_neighboringzd2cavitieszd2(pos, cave));
    } else {
      return cave;
    }
  };
BgL_neighboringzd2cavitieszd2 = function(pos, cave) {
    var j;
    var i;
    var m;
    var n;
    var size;
    size = BgL_matrixzd2siza7ez75(cave);
    n = size.car;
    m = size.cdr;
    i = pos.car;
    j = pos.cdr;
    return sc_append(i > 0 && BgL_matrixzd2readzd2(cave, i - 1, j) !== false? sc_list(new sc_Pair(i - 1, j)): null, i < n - 1 && BgL_matrixzd2readzd2(cave, i + 1, j) !== false? sc_list(new sc_Pair(i + 1, j)): null, j > 0 && BgL_matrixzd2readzd2(cave, i, j - 1) !== false? sc_list(new sc_Pair(i, j - 1)): null, j < m - 1 && BgL_matrixzd2readzd2(cave, i, j + 1) !== false? sc_list(new sc_Pair(i, j + 1)): null);
  };
BgL_expectedzd2resultzd2 = BgL_sc_const_1z00_main;
main = function() {
    var args = null;
    for (var sc_tmp = arguments.length - 1; sc_tmp >= 0; --sc_tmp) {
      args = sc_cons(arguments[sc_tmp], args);
    }
    return BgL_runzd2benchmarkzd2("mazefun", 1000, function(result) {
              return sc_isEqual(result, BgL_expectedzd2resultzd2);
            }, function(n, m) {
              return function() {
                      return BgL_makezd2maza7ez75(n, m);
                    };
            }, 11, 11);
  };
main();
