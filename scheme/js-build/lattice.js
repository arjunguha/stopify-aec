...
var run;
var sum;
var BgL_countzd2mapszd2;
var maps;
var BgL_mapszd2restzd2;
var BgL_mapszd21zd2;
var BgL_mapzd2andzd2;
var BgL_selectzd2mapzd2;
var BgL_reversez12z12;
var BgL_za7uluzd2selectz75;
var BgL_latticezd2ze3cmpz31;
var BgL_latticezd2ze3elementsz31;
...
var BgL_latticezd2iterszd2;
const_main = "*** wrong result ***";
BgL_latticezd2iterszd2 = 1;
...
lexico = function(base) {
    var lex_first;
    lex_first = function(lhs, rhs) {
        var tmp1264;
        var probe;
        var lhs_1;
        var rhs_2;
        ...
        rhs_7 = rhs;
        while (!(lhs_6 === null)) {
          probe_5 = base(lhs_6.car, rhs_7.car);
          switch (probe_5) {
          case "\uEBACless":
          case "\uEBACmore":
            lhs_4 = lhs_6.cdr;
            ...
            rhs_2 = rhs_3;
            while (!(lhs_1 === null)) {
              probe = base(lhs_1.car, rhs_2.car);
              tmp1264 = probe === "\uEBACequal";
              if ((tmp1264 !== false? tmp1264: probe === probe_5) !== false) {
                lhs_1 = lhs_1.cdr;
                rhs_2 = rhs_2.cdr;
              } else {
                return "\uEBACuncomparable";
...
BgL_makezd2latticezd2 = function(elem_list, cmp_func) {
    return new sc_Pair(elem_list, cmp_func);
  };
BgL_latticezd2ze3elementsz31 = sc_car;
BgL_latticezd2ze3cmpz31 = sc_cdr;
BgL_za7uluzd2selectz75 = function(test, lst) {
    var head;
    var ac;
    var lst_8;
    var ac_9;
    ...
    while (!(lst_8 === null)) {
      head = lst_8.car;
      if (test(head) !== false) {
        ac = new sc_Pair(head, ac);
      }
      lst_8 = lst_8.cdr;
    }
    return BgL_reversez12z12(ac);
  };
BgL_reversez12z12 = function(lst) {
    var next;
    var fo;
    var fum;
    var fum_10;
...
BgL_selectzd2mapzd2 = function(test, func, lst) {
    var head;
    var ac;
    var lst_11;
    var ac_12;
    ...
    while (!(lst_11 === null)) {
      head = lst_11.car;
      if (test(head) !== false) {
        ac = new sc_Pair(func(head), ac);
      }
      lst_11 = lst_11.cdr;
    }
    return BgL_reversez12z12(ac);
  };
BgL_mapzd2andzd2 = function(proc, lst) {
    var rest;
    var lst_13;
    if (lst === null) {
      return true;
      ...
      do {
        rest = lst_13.cdr;
        if (rest === null) {
          return proc(lst_13.car);
        } else {
          if (proc(lst_13.car) !== false) {
            lst_13 = rest;
          } else {
            return false;
          }
...
BgL_mapszd21zd2 = function(source, target, pas, new_14) {
    var more;
    var less;
    var tcmp;
    var scmp;
    scmp = BgL_latticezd2ze3cmpz31(source);
    tcmp = BgL_latticezd2ze3cmpz31(target);
    less = BgL_selectzd2mapzd2(function(p) {
          return "\uEBACless" === scmp(p.car, new_14);
        }, sc_cdr, pas);
    more = BgL_selectzd2mapzd2(function(p) {
          return "\uEBACmore" === scmp(p.car, new_14);
        }, sc_cdr, pas);
    return BgL_za7uluzd2selectz75(function(t) {
              if (BgL_mapzd2andzd2(function(t2) {
                      return sc_memq(tcmp(t2, t), new sc_Pair("\uEBACless", new sc_Pair("\uEBACequal", null)));
                    }, less) !== false) {
                return BgL_mapzd2andzd2(function(t2) {
                          return sc_memq(tcmp(t2, t), new sc_Pair("\uEBACmore", new sc_Pair("\uEBACequal", null)));
                        }, more);
              } else {
                return false;
              }
            }, BgL_latticezd2ze3elementsz31(target));
  };
BgL_mapszd2restzd2 = function(source, target, pas, rest, to_1, to_collect) {
    var stmp;
    var stmp_15;
    var x;
    var tail1269;
    ...
    if (rest === null) {
      ...
      L1265_16 = BgL_mapszd21zd2(source, target, pas, next);
      tail1269 = falseHead1268;
      L1265 = L1265_16;
      while (!(L1265 === null)) {
        x = L1265.car;
        stmp_15 = new sc_Pair(BgL_mapszd2restzd2(source, target, new sc_Pair(new sc_Pair(next, x), pas), rest_17, to_1, to_collect), null);
        tail1269.cdr = stmp_15;
        tail1269 = tail1269.cdr;
        L1265 = L1265.cdr;
      }
      stmp = falseHead1268.cdr;
      return to_collect(stmp);
    }
  };
maps = function(source, target) {
    return BgL_makezd2latticezd2(BgL_mapszd2restzd2(source, target, null, BgL_latticezd2ze3elementsz31(source), function(x) {
                var stmp;
                var tail1274;
                var L1270;
                var falseHead1273;
                ...
                L1270 = x;
                while (!(L1270 === null)) {
                  tail1274.cdr = new sc_Pair(L1270.car.cdr, null);
                  tail1274 = tail1274.cdr;
                  L1270 = L1270.cdr;
                }
                stmp = falseHead1273.cdr;
                return sc_list(stmp);
              }, function(x) {
                return sc_apply(sc_append, x);
              }), lexico(BgL_latticezd2ze3cmpz31(target)));
  };
BgL_countzd2mapszd2 = function(source, target) {
    return BgL_mapszd2restzd2(source, target, null, BgL_latticezd2ze3elementsz31(source), function(x) {
              return 1;
            }, sum);
  };
sum = function(lst) {
...
run = function() {
    ...
    var l3;
    var l2;
    l2 = BgL_makezd2latticezd2(new sc_Pair("\uEBAClow", new sc_Pair("\uEBAChigh", null)), function(lhs, rhs) {
          switch (lhs) {
          case "\uEBAClow":
            switch (rhs) {
            case "\uEBAClow":
            ...
            case "\uEBAChigh":
              ...
              break;
            default:
              return BgL_fatalzd2errorzd2("\uEBACmake-lattice", "base", rhs);
              break;
            }
            break;
          case "\uEBAChigh":
            ...
            break;
          default:
            return BgL_fatalzd2errorzd2("\uEBACmake-lattice", "base", lhs);
            break;
          }
        });
    l3 = maps(l2, l2);
    l4 = maps(l3, l3);
    BgL_countzd2mapszd2(l2, l2);
    BgL_countzd2mapszd2(l3, l3);
    BgL_countzd2mapszd2(l2, l3);
    BgL_countzd2mapszd2(l3, l2);
    return BgL_countzd2mapszd2(l4, l4);
  };
main = function() {
    return BgL_runzd2benchmarkzd2("lattice", BgL_latticezd2iterszd2, function(result) {
              return sc_isEqual(result, 120549);
            }, function() {
              return function() {
                      return run();
                    };
