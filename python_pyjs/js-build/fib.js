...
$pyjs['loaded_modules']['main'] = function (__mod_name__) {
	...
	$m['fib'] = function(n) {
		var $or1,$or2,$add2,$add1,$sub3,$sub2,$sub1,$sub4;
		if ($p['bool'](($p['bool']($or1=$p['op_eq'](n, 0))?$or1:$p['op_eq'](n, 1)))) {
			return 1;
		}
		return $p['__op_add']($add1=$m['fib']($p['__op_sub']($sub1=n,$sub2=1)),$add2=$m['fib']($p['__op_sub']($sub3=n,$sub4=2)));
	};
	$m['fib']['__name__'] = 'fib';
	...
	$m['f'] = function(n) {
		var $iter2_nextval,$iter1_nextval,$iter1_type,$iter2_iter,i,k,$iter1_iter,$iter2_idx,$iter1_array,$iter2_type,times,$iter2_array,$iter1_idx;
		times = $p['list']([]);
		$iter1_iter = $p['range'](n);
		$iter1_nextval=$p['__iter_prepare']($iter1_iter,false);
		while (typeof($p['__wrapped_next']($iter1_nextval)['$nextval']) != 'undefined') {
			k = $iter1_nextval['$nextval'];
			$iter2_iter = $p['range'](2000);
			$iter2_nextval=$p['__iter_prepare']($iter2_iter,false);
			while (typeof($p['__wrapped_next']($iter2_nextval)['$nextval']) != 'undefined') {
				i = $iter2_nextval['$nextval'];
				$m['fib'](20);
