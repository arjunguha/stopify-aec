...
exports.union        = union;
exports.vars         = vars;
exports.vars_of_list = vars_of_list;
exports.substitute   = substitute;
exports.replace      = replace;
exports.replace_nth  = replace_nth;
exports.matching     = matching;
exports.compsubst    = compsubst;
exports.occurs       = occurs;
exports.unify        = unify;
exports.infixes      = infixes;
exports.pretty_term  = pretty_term;
exports.pretty_close = pretty_close;
/* No side effect */
...
var Buffer             = __webpack_require__(7);
var Pervasives         = __webpack_require__(2);
var CamlinternalFormat = __webpack_require__(35);
...
var List                    = __webpack_require__(3);
var Block                   = __webpack_require__(5);
var Terms                   = __webpack_require__(18);
var Buffer                  = __webpack_require__(7);
...
function mk_rule(num, m, n) {
  var all_vars = Terms.union(Terms.vars(m), Terms.vars(n));
  var counter = [0];
  ...
  return /* record */[
          /* number */num,
          /* numvars */counter[0],
          /* lhs */Terms.substitute(subst, m),
          /* rhs */Terms.substitute(subst, n)
        ];
}
...
function pretty_rule(b, rule) {
  ...
  Buffer.add_string(b, " : ");
  Terms.pretty_term(b, rule[/* lhs */2]);
  Buffer.add_string(b, " = ");
  Terms.pretty_term(b, rule[/* rhs */3]);
...
function reduce(l, m, r) {
  return Terms.substitute(Terms.matching(l, m), r);
}
...
exports.mk_rule        = mk_rule;
exports.check_rules    = check_rules;
exports.pretty_rule    = pretty_rule;
exports.pretty_rules   = pretty_rules;
exports.reduce         = reduce;
exports.reducible      = reducible;
exports.mreduce        = mreduce;
exports.mrewrite1      = mrewrite1;
exports.mrewrite1_sons = mrewrite1_sons;
exports.mrewrite_all   = mrewrite_all;
/* No side effect */
...
var Fixture                 = __webpack_require__(31);
var Equations               = __webpack_require__(25);
var Orderings               = __webpack_require__(32);
var Caml_array              = __webpack_require__(9);
var Pervasives              = __webpack_require__(2);
var Micro_bench_run         = __webpack_require__(33);
var Micro_bench_types       = __webpack_require__(44);
var Caml_builtin_exceptions = __webpack_require__(0);
...
var group_order = Orderings.rpo(group_precedence, Orderings.lex_ext);
...
function complete(greater, complete_rules, rules) {
  var n = Equations.check_rules(complete_rules);
  ...
  return List.rev(Curry._3(Kb.kb_completion(greater)(n, complete_rules), /* [] */0, /* tuple */[
                  n,
                  n
                ], eqs));
}
...
function critical_pairs(param, param$1) {
  ...
  var mk_pair = function (param) {
    var subst = param[1];
    return /* tuple */[
            Terms.substitute(subst, Terms.replace(l2, param[0], r1)),
            Terms.substitute(subst, r2)
          ];
  };
...
function non_orientable(param) {
  var b = Buffer.create(20);
  Terms.pretty_term(b, param[0]);
  Buffer.add_string(b, " = ");
  Terms.pretty_term(b, param[1]);
  console.log(Buffer.contents(b));
  return /* () */0;
}
    ...
    var $$process = function (_failures, _param, _eqs) {
      while(true) {
        ...
        if (eqs) {
          var eqs$1 = eqs[1];
          var match = eqs[0];
          var m$prime = Equations.mrewrite_all(rules, match[0]);
          var n$prime = Equations.mrewrite_all(rules, match[1]);
          var enter_rule = (function(failures,k,l,eqs$1){
          return function enter_rule(param) {
            var left = param[0];
            var new_rule = Equations.mk_rule(j + 1 | 0, left, param[1]);
            var left_reducible = function (rule) {
              return Equations.reducible(left, rule[/* lhs */2]);
            };
            var match = partition(left_reducible, rules);
            var right_reduce = function (rule) {
              return Equations.mk_rule(rule[/* number */0], rule[/* lhs */2], Equations.mrewrite_all(/* :: */[
                              new_rule,
                              rules
                            ], rule[/* rhs */3]));
            };
...
function kb_complete(b, greater, complete_rules, rules) {
  ...
  return Equations.pretty_rules(b, List.rev(completed_rules));
}

exports.$$super               = $$super;
exports.super_strict          = super_strict;
exports.critical_pairs        = critical_pairs;
exports.strict_critical_pairs = strict_critical_pairs;
exports.mutual_critical_pairs = mutual_critical_pairs;
exports.rename                = rename;
exports.deletion_message      = deletion_message;
exports.non_orientable        = non_orientable;
exports.partition             = partition;
exports.get_rule              = get_rule;
exports.kb_completion         = kb_completion;
exports.kb_complete           = kb_complete;
/* No side effect */
...
exports.ge_ord   = ge_ord;
exports.gt_ord   = gt_ord;
exports.eq_ord   = eq_ord;
exports.rem_eq   = rem_eq;
exports.diff_eq  = diff_eq;
exports.mult_ext = mult_ext;
exports.lex_ext  = lex_ext;
exports.rpo      = rpo;
/* No side effect */
...
var Arg        = __webpack_require__(34);
...
var $$String   = __webpack_require__(13);
var Caml_gc    = __webpack_require__(39);
var Caml_obj   = __webpack_require__(4);
var Caml_sys   = __webpack_require__(15);
var Printexc   = __webpack_require__(40);
var Caml_array = __webpack_require__(9);
var Caml_int32 = __webpack_require__(10);
var Pervasives = __webpack_require__(2);
...
var Caml_io                  = __webpack_require__(14);
var Caml_obj                 = __webpack_require__(4);
var Caml_bytes               = __webpack_require__(36);
var Caml_float               = __webpack_require__(37);
var Caml_int32               = __webpack_require__(10);
var Pervasives               = __webpack_require__(2);
var Caml_format              = __webpack_require__(16);
var Caml_string              = __webpack_require__(6);
...
var Obj                     = __webpack_require__(41);
var $$Array                 = __webpack_require__(26);
var Block                   = __webpack_require__(5);
var Curry                   = __webpack_require__(1);
var Buffer                  = __webpack_require__(7);
...
var Caml_array              = __webpack_require__(9);
var Pervasives              = __webpack_require__(2);
var Caml_backtrace          = __webpack_require__(43);
var Caml_builtin_exceptions = __webpack_require__(0);
...
var Marshal                 = __webpack_require__(42);
var Caml_array              = __webpack_require__(9);
var Caml_missing_polyfill   = __webpack_require__(17);
var Caml_builtin_exceptions = __webpack_require__(0);
